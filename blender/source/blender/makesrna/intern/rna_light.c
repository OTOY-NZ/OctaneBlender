...
static void rna_def_mesh_light(BlenderRNA *brna)
{
  StructRNA *srna;

  srna = RNA_def_struct(brna, "MeshLight", "Light");
  RNA_def_struct_sdna(srna, "Light");
  RNA_def_struct_ui_text(srna, "Mesh Light", "Use Mesh with Octane Emission");
  RNA_def_struct_ui_icon(srna, ICON_LIGHT_AREA);
