...
static blender::bke::bNodeSocketTemplate  sh_node_out[] = {{SOCK_SHADER, N_("OutTex")}, {-1, ""}};

void register_node_type_val_oct_texture_reference(void)
{
  static blender::bke::bNodeType ntype;

  if (ntype.type != SH_NODE_OCT_VALUE_TEXTURE_REFERENCE)
    sh_node_type_base(&ntype,
                   SH_NODE_OCT_VALUE_TEXTURE_REFERENCE,
                   "Texture Reference",
