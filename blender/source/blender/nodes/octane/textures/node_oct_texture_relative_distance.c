...
void register_node_type_tex_oct_relative_distance(void)
{
  ...
  if (ntype.type != SH_NODE_OCT_RELATIVE_DISTANCE)
    sh_node_type_base(&ntype,
                   SH_NODE_OCT_RELATIVE_DISTANCE,
                   "Relative distance Tex",
