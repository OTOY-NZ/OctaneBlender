...
void register_node_type_tex_oct_channel_inverter(void)
{
  ...
  if (ntype.type != SH_NODE_OCT_CHANNEL_INVERTER_TEX)
    node_type_base(&ntype,
                   SH_NODE_OCT_CHANNEL_INVERTER_TEX,
                   "Channel Inverter Tex",
