...
static void node_type_oct_composite_aov_output_init(bNodeTree *ntree, bNode *node)
{
  node->custom1 = 2;
}
...
void register_node_type_composite_aov_output(void)
{
  ...
  if (ntype.type != SH_NODE_OCT_COMPOSITE_AOV_OUTPUT)
    sh_node_type_base(&ntype,
                   SH_NODE_OCT_COMPOSITE_AOV_OUTPUT,
