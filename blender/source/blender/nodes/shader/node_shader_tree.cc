...
static bool shader_tree_poll(const bContext *C, bNodeTreeType * /*treetype*/)
{
  ...
  return (engine_id[0] == '\0' || STREQ(engine_id, RE_engine_id_CYCLES) ||
          STREQ(engine_id, RE_engine_id_OCTANE) || !BKE_scene_use_shading_nodes_custom(scene));
}
...
static void foreach_nodeclass(Scene * /*scene*/, void *calldata, bNodeClassCallback func)
{
  ...
  func(calldata, NODE_CLASS_OCT_LAYER, N_("Octane Layer"));
  ...
  func(calldata, NODE_CLASS_OCT_CAMERA, N_("Octane Camera"));
  func(calldata, NODE_CLASS_OCT_GEOMETRY, N_("Octane Geometry"));
  func(calldata, NODE_CLASS_OCT_ROUNDEDGES, N_("Octane RoundEdges"));
  func(calldata, NODE_CLASS_OCT_ENVIRONMENT, N_("Octane Environment"));
