...
DefNode( ShaderNode,     SH_NODE_OCT_GRADIENT_TEX,          def_colorramp,   "OCT_GRADIENT_TEX",      OctGradientTex,      "Octane Gradient Tex",          ""    )
...
DefNode( ShaderNode,     SH_NODE_OCT_W_TEX,                 0,               "OCT_W_TEX",             OctWTex,             "Octane W Tex",                 ""    )
...
DefNode( ShaderNode,     SH_NODE_OCT_2D_TRN,                0,               "OCT_2D_TRN",            Oct2DTransform,      "Octane 2D Transform",          ""    )
DefNode( ShaderNode,     SH_NODE_OCT_3D_TRN,                0,               "OCT_3D_TRN",            Oct3DTransform,      "Octane 3D Transform",          ""    )
...
DefNode( ShaderNode,     SH_NODE_OCT_VALUE_FLOAT,           0,               "OCT_FLOAT_VAL",         OctFloatValue,         "Octane Float Value",         ""    )
DefNode( ShaderNode,     SH_NODE_OCT_VALUE_INT,             0,               "OCT_INT_VAL",           OctIntValue,           "Octane Int Value",           ""    )
#endif /* WITH_OCTANE */
