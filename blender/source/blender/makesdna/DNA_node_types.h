...
typedef struct bNode {
  ...
  short oct_custom9, oct_custom10, oct_custom11, oct_custom12, oct_custom13, oct_custom14, oct_custom15, oct_custom16;
  short oct_custom_aov, oct_custom_aov_channel;
  short oct_custom_aov_pads[6];
} bNode;
...
/* octane toon light mode */
#define OCT_SHD_TOON_LIGHT_SOURCE 0
#define OCT_SHD_TOON_LIGHT_CAMERA 1

/* octane brdf mode */
#define OCT_SHD_BRDF_MODEL_OCTANE 0
#define OCT_SHD_BRDF_MODEL_BECKMANN 1
#define OCT_SHD_BRDF_MODEL_GGX 2
...
#define OCT_SHD_METALLIC_REFLECTION_MODE_IOR_COLOR 1
#define OCT_SHD_METALLIC_REFLECTION_MODE_RGB_IOR 2

/* octane metallic reflection mode */
#define OCT_SHD_UNIVERSAL_REFLECTION_MODE_DEFAULT 0
#define OCT_SHD_UNIVERSAL_REFLECTION_MODE_IOR_COLOR 1
#define OCT_SHD_UNIVERSAL_REFLECTION_MODE_RGB_IOR 2

/* octane universal material transmission mode */
#define OCT_BXDF_TRANSMISSION_TYPE_SPECULAR 0
#define OCT_BXDF_TRANSMISSION_TYPE_DIFFUSE 1
#define OCT_BXDF_TRANSMISSION_TYPE_THINWALL 2

/* octane hdr texture bit depth mode */
#define OCT_HDR_BIT_DEPTH_16 2
#define OCT_HDR_BIT_DEPTH_32 1
#define OCT_HDR_BIT_DEPTH_AUTOMATIC -1

/* octane noise type */
#define OCT_NOISE_TYPE_PERLIN 0
...
#define OCT_BORDER_MODE_BLACK 1
#define OCT_BORDER_MODE_WHITE 2
#define OCT_BORDER_MODE_CLAMP 3
#define OCT_BORDER_MODE_MIRROR 4

/* octane space addressing for textures */
#define OCT_POSITION_GLOBAL 1
#define OCT_POSITION_OBJECT 3
#define OCT_POSITION_NORMAL 4

/* octane rotation order for textures */
#define OCT_ROT_XYZ 0
#define OCT_ROT_XZY 1
#define OCT_ROT_YXZ 2
#define OCT_ROT_YZX 3
#define OCT_ROT_ZXY 4
#define OCT_ROT_ZYX 5

/* octane various modes we support in the falloff texture */
#define OCT_FALLOFF_NORMAL_VS_EYE_RAY 0
#define OCT_FALLOFF_NORMAL_VS_VECTOR_90DEG 1
#define OCT_FALLOFF_NORMAL_VS_VECTOR_180DEG 2

/* The levels of details we currently support in displacement mapping. */
#define OCT_DISPLACEMENT_LEVEL_256 8
#define OCT_DISPLACEMENT_LEVEL_512 9
#define OCT_DISPLACEMENT_LEVEL_1024 10
#define OCT_DISPLACEMENT_LEVEL_2048 11
#define OCT_DISPLACEMENT_LEVEL_4096 12
#define OCT_DISPLACEMENT_LEVEL_8192 13

/* The direction used to displace the surface */
#define OCT_DISPLACEMENT_VERTEX_NORMAL 1
#define OCT_DISPLACEMENT_GEOMETRIC_NORMAL 2
#define OCT_DISPLACEMENT_SMOOTH_NORMAL 3

/* octane supported filter types */
#define OCT_FILTER_TYPE_NONE 0
#define OCT_FILTER_TYPE_BOX 1
#define OCT_FILTER_TYPE_GAUSSIAN 2

/* The different tonemap types we support. */
#define OCT_LDR_TONEMAP 0
#define OCT_HDR_TONEMAP 1
...
#define OCT_USE_NODE_VALUE_DIRECTION 1
...
/* The method used to distribute instances on surfaces. */
#define OCT_DISTRIBUTION_ON_SURFACE_ONE_INSTANCE_PER_VERTEX 0
#define OCT_DISTRIBUTION_ON_SURFACE_ONE_INSTANCE_PER_EDGE 4
#define OCT_DISTRIBUTION_ON_SURFACE_MULTIPLE_INSTANCES_ON_EDGES 5
#define OCT_DISTRIBUTION_ON_SURFACE_ONE_INSTANCE_PER_POLYGON 1
#define OCT_DISTRIBUTION_ON_SURFACE_MULTIPLE_INSTANCES_BY_AREA 2
#define OCT_DISTRIBUTION_ON_SURFACE_MULTIPLE_INSTANCES_BY_DENSITY 3
#define OCT_DISTRIBUTION_ON_SURFACE_DISABLED 6

/* The method used to distribute instances on particles. */
#define OCT_DISTRIBUTION_ON_PARTICLE_ONE_INSTANCE_PER_PARTICLE 0
#define OCT_DISTRIBUTION_ON_PARTICLE_DISABLED 1

/* The method used to distribute instances on hairs. */
#define OCT_DISTRIBUTION_ON_HAIR_ONE_INSTANCE_PER_HAIR_VERTEX 0
#define OCT_DISTRIBUTION_ON_HAIR_ONE_INSTANCE_PER_HAIR 1
#define OCT_DISTRIBUTION_ON_HAIR_MULTIPLE_INSTANCE_ON_HAIRS 2
#define OCT_DISTRIBUTION_ON_HAIR_DISABLED 3
...
#define OCT_ROUND_EDGES_MODE_OFF 0
/// Fast round edges mode
#define OCT_ROUND_EDGES_MODE_FAST 1
/// Accurate round edges mode, convex and concave edges.
#define OCT_ROUND_EDGES_MODE_ACCURATE 2
/// Accurate round edges mode, convex edges only.
#define OCT_ROUND_EDGES_MODE_ACCURATE_CONVE 3
/// Accurate round edges mode, concave edges only.
#define OCT_ROUND_EDGES_MODE_ACCURATE_CONCAVE 4

/// Vector displacement map
#define OCT_DISPLACEMENT_MAP_TYPE_VECTOR 0
/// Height displacement map
#define OCT_DISPLACEMENT_MAP_TYPE_HEIGHT 1
