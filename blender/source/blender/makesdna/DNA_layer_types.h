...
typedef struct ViewLayer {
  ...
  int oct_passflags[8];  // OCTANE_MAX_PASS_NUM
  short use_octane_render_layers;
  short octane_render_layers_invert;
  short octane_render_layers_mode;
  short oct_short_pad;
  int octane_render_layer_active_id;
  int octane_aov_out_number;
  int oct_pad[4];
} ViewLayer;
