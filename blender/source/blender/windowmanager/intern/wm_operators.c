...
#include "../../blender/editors/space_mat_livedb/mat_livedb_intern.h"
...
static int wm_octane_livedb_exec(bContext *C, wmOperator *op)
{
  get_livedb_material(C, NULL, NULL);
  return OPERATOR_FINISHED;
}

static void WM_OT_octane_livedb(wmOperatorType *ot)
{
  ot->name = "Octane DB";
  ot->idname = "WM_OT_octane_livedb";
  ot->description = "Octane DB";

  ot->exec = wm_octane_livedb_exec;
}
...
void wm_operatortypes_register(void)
{
  ...
  WM_operatortype_append(WM_OT_octane_livedb);
