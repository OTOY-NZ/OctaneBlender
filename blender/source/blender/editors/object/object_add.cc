...
const EnumPropertyItem rna_enum_light_type_items[] = {
    ...
    {LA_MESH, "MESH", ICON_LIGHT_AREA, "Mesh", "Mesh light source"},
    {LA_SPHERE, "SPHERE", ICON_LIGHT_POINT, "Sphere", "Octane sphere light source"},
    {0, nullptr, 0, nullptr, nullptr},
};

const EnumPropertyItem rna_enum_light_type_addon_version_items[] = {
    {LA_LOCAL, "POINT", ICON_LIGHT_POINT, "Point", "Omnidirectional point light source"},
    {LA_SUN, "SUN", ICON_LIGHT_SUN, "Sun", "Constant direction parallel ray light source"},
    {LA_SPOT, "SPOT", ICON_LIGHT_SPOT, "Spot", "Directional cone light source"},
    {LA_AREA, "AREA", ICON_LIGHT_AREA, "Area", "Directional area light source"},
...
void OBJECT_OT_light_add(wmOperatorType *ot)
{
  ...
  ot->prop = RNA_def_enum(
      ot->srna, "type", rna_enum_light_type_addon_version_items, 0, "Type", "");
