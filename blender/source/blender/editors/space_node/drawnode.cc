...
{
  uiTemplateColorRamp(layout, ptr, "color_ramp", false, false);
}
...
{
  uiItemR(layout, ptr, "border_mode_u", 0, "", ICON_NONE);
  uiItemR(layout, ptr, "border_mode_v", 0, "", ICON_NONE);
}

static void node_shader_buts_oct_hdr_tex_bit_depth(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "hdr_tex_bit_depth", 0, "", ICON_NONE);
}

static void node_shader_buts_oct_ies(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "octane_ies_mode", 0, "", ICON_NONE);  
}
...
static void node_shader_buts_tex_baking(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  ...
  uiItemR(layout, ptr, "texture_type", 0, "", ICON_NONE);
}
...
{
  uiItemR(layout, ptr, "brdf_model", 0, "", ICON_NONE);
  node_oct_custom_aov_settings(layout, C, ptr);
}
...
{
  uiItemR(layout, ptr, "brdf_model", 0, "", ICON_NONE);
  uiItemR(layout, ptr, "metallic_reflection_mode", 0, "", ICON_NONE);
  node_oct_custom_aov_settings(layout, C, ptr);
}

static void node_shader_buts_oct_universal_mat(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "transmission_type", 0, "", ICON_NONE);
  uiItemR(layout, ptr, "brdf_model", 0, "", ICON_NONE);
  uiItemR(layout, ptr, "universal_reflection_mode", 0, "", ICON_NONE);
  node_oct_custom_aov_settings(layout, C, ptr);
}
...
static void node_shader_buts_oct_vertex_displacement_tex(uiLayout *layout,
                                                         ...
                                                         PointerRNA *ptr)
{
  uiItemR(layout, ptr, "map_type", 0, "", ICON_NONE);
  uiItemR(layout, ptr, "vertex_space", 0, "", ICON_NONE);
}
...
static void node_shader_buts_oct_vertex_displacement_mixer_tex(uiLayout *layout,
                                                               ...
                                                               PointerRNA *ptr)
{
  uiItemR(layout, ptr, "displacement_number", 0, "", ICON_NONE);
}
...
static void node_shader_buts_oct_daylight_environment(uiLayout *layout,
                                                      ...
                                                      PointerRNA *ptr)
{
  uiItemR(layout, ptr, "daylight_model_type", 0, "", ICON_NONE);
}
...
static void node_shader_buts_oct_toon_direction_light(uiLayout *layout,
                                                      ...
                                                      PointerRNA *ptr)
{
  uiItemR(layout, ptr, "light_direction_type", 0, "", ICON_NONE);
}
...
static void node_shader_buts_oct_info_channels_kernel(uiLayout *layout,
                                                      ...
                                                      PointerRNA *ptr)
{
  uiItemR(layout, ptr, "sampling_model", 0, "", ICON_NONE);
  uiItemR(layout, ptr, "info_channels_type", 0, "", ICON_NONE);
}

static void node_shader_buts_oct_dirt_tex(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "bias_coordinate_space_type", 0, "", ICON_NONE);
  uiItemR(layout, ptr, "include_object_mode", 0, "", ICON_NONE);
}

static void node_shader_buts_oct_medium(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "lock_step_length_mode", 0, "", ICON_NONE);
}
                                                      ...
                                                      PointerRNA *ptr)
{
  ...
  uiItemR(layout, ptr, "distribution_method", 0, NULL, 0);
  uiItemR(layout, ptr, "distribution_on_particles_method", 0, NULL, 0);
  uiItemR(layout, ptr, "distribution_on_hairs_method", 0, NULL, 0);
  uiItemR(layout, ptr, "orientation_priority", 0, NULL, 0);
  uiItemR(layout, ptr, "up_direction_mode", 0, NULL, 0);
  uiItemR(layout, ptr, "front_direction_mode", 0, NULL, 0);
  uiItemR(layout, ptr, "rotation_mode", 0, NULL, 0);
  uiItemR(layout, ptr, "scale_mode", 0, NULL, 0);
  uiItemR(layout, ptr, "translation_mode", 0, NULL, 0);
}
...
{
  uiItemR(layout, ptr, "object_selection_method", 0, NULL, 0);
  uiItemR(layout, ptr, "shape", 0, NULL, 0);
  uiItemR(layout, ptr, "orientation_priority", 0, NULL, 0);
  uiItemR(layout, ptr, "up_direction_mode", 0, NULL, 0);
  uiItemR(layout, ptr, "front_direction_mode", 0, NULL, 0);
  uiItemR(layout, ptr, "rotation_mode", 0, NULL, 0);
                                                     ...
                                                     PointerRNA *ptr)
{
  ...
  uiItemR(layout, ptr, "overlay_mode", 0, NULL, 0);
  uiItemR(layout, ptr, "alpha_operation_mode", 0, NULL, 0);
}
                                                            ...
                                                            PointerRNA *ptr)
{
  ...
  uiItemR(layout, ptr, "blend_mode", 0, NULL, 0);
  uiItemR(layout, ptr, "alpha_operation", 0, NULL, 0);
}
                                                        ...
                                                        PointerRNA *ptr)
{
  ...
  uiItemR(layout, ptr, "repetition_mode", 0, NULL, 0);
}
