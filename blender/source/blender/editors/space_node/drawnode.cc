                                 ...
                                 const bool show_color_management)
{
  ...
  Scene *scene = CTX_data_scene(C);
  const char *engine_id = scene ? scene->r.engine : "";
  
  if (show_color_management && (!STREQ(engine_id, RE_engine_id_OCTANE))) {
...
static void node_shader_buts_oct_image(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  PointerRNA imaptr = RNA_pointer_get(ptr, "image");
  PointerRNA iuserptr = RNA_pointer_get(ptr, "image_user");
  uiTemplateID(layout,
   ...
   * which redefines them in the node struct RNA to get proper updates.
   */
  node_buts_image_user(layout, C, &iuserptr, &imaptr, &iuserptr, false, false);
}

static void node_shader_buts_oct_border_mode(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "border_mode_u", UI_ITEM_NONE, "", ICON_NONE);
  uiItemR(layout, ptr, "border_mode_v", UI_ITEM_NONE, "", ICON_NONE);
}

static void node_shader_buts_oct_hdr_tex_bit_depth(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "hdr_tex_bit_depth", UI_ITEM_NONE, "", ICON_NONE);
}

static void node_shader_buts_oct_ies(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "octane_ies_mode", UI_ITEM_NONE, "", ICON_NONE);  
}

static void node_shader_buts_tex_baking(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  node_shader_buts_oct_border_mode(layout, C, ptr);
  uiItemR(layout, ptr, "texture_type", UI_ITEM_NONE, "", ICON_NONE);
}

static void node_shader_buts_oct_tex_image(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  node_shader_buts_oct_hdr_tex_bit_depth(layout, C, ptr);
  node_shader_buts_oct_ies(layout, C, ptr);
  node_shader_buts_oct_border_mode(layout, C, ptr);
  node_shader_buts_oct_image(layout, C, ptr);
}

static void node_shader_buts_oct_tex_image_tile(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  node_shader_buts_oct_hdr_tex_bit_depth(layout, C, ptr);
  node_shader_buts_oct_ies(layout, C, ptr);
  node_shader_buts_oct_image(layout, C, ptr);
...
static void node_shader_buts_oct_tex_instance_color(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  node_shader_buts_oct_hdr_tex_bit_depth(layout, C, ptr);
  node_shader_buts_oct_ies(layout, C, ptr);
  node_shader_buts_oct_image(layout, C, ptr);
...
static void node_shader_buts_oct_projections(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "coordinate_space_mode", UI_ITEM_NONE, "", ICON_NONE);
}

static void node_shader_buts_oct_transforms(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "rotation_order", UI_ITEM_NONE, "", ICON_NONE);
}

static void node_shader_buts_oct_color_ramp(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiTemplateColorRamp(layout, ptr, "color_ramp", 0);
}

static void node_oct_custom_aov_settings(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "custom_aov", UI_ITEM_NONE, "", ICON_NONE);
  uiItemR(layout, ptr, "custom_aov_channel", UI_ITEM_NONE, "", ICON_NONE);
}

static void node_shader_buts_oct_toon_mat(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "toon_light_mode", UI_ITEM_NONE, "", ICON_NONE);
  node_oct_custom_aov_settings(layout, C, ptr);
}

static void node_shader_buts_oct_diffuse_mat(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  node_oct_custom_aov_settings(layout, C, ptr);
}

static void node_shader_buts_oct_mix_mat(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  node_oct_custom_aov_settings(layout, C, ptr);
}

static void node_shader_buts_oct_shadow_catcher_mat(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  node_oct_custom_aov_settings(layout, C, ptr);
}

static void node_shader_buts_oct_glossy_mat(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "brdf_model", UI_ITEM_NONE, "", ICON_NONE);
  node_oct_custom_aov_settings(layout, C, ptr);
}

static void node_shader_buts_oct_specular_mat(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "brdf_model", UI_ITEM_NONE, "", ICON_NONE);
  node_oct_custom_aov_settings(layout, C, ptr);
}

static void node_shader_buts_oct_metal_mat(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "brdf_model", UI_ITEM_NONE, "", ICON_NONE);
  uiItemR(layout, ptr, "metallic_reflection_mode", UI_ITEM_NONE, "", ICON_NONE);
  node_oct_custom_aov_settings(layout, C, ptr);
}

static void node_shader_buts_oct_universal_mat(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "transmission_type", UI_ITEM_NONE, "", ICON_NONE);
  uiItemR(layout, ptr, "brdf_model", UI_ITEM_NONE, "", ICON_NONE);
  uiItemR(layout, ptr, "universal_reflection_mode", UI_ITEM_NONE, "", ICON_NONE);
  node_oct_custom_aov_settings(layout, C, ptr);
}

static void node_shader_buts_oct_noise_tex(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "noise_type", UI_ITEM_NONE, "", ICON_NONE);
}

static void node_shader_buts_oct_cinema4d_noise_tex(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "c4d_noise_type", UI_ITEM_NONE, "", ICON_NONE);
}

static void node_shader_buts_oct_falloff_tex(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "falloff_map_mode", UI_ITEM_NONE, "", ICON_NONE);
}

static void node_shader_buts_oct_displacement_tex(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "displacement_level", UI_ITEM_NONE, "", ICON_NONE);
  uiItemR(layout, ptr, "displacement_surface", UI_ITEM_NONE, "", ICON_NONE);
  uiItemR(layout, ptr, "displacement_filter", UI_ITEM_NONE, "", ICON_NONE);
}

static void node_shader_buts_oct_round_edges(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "round_edges_mode", UI_ITEM_NONE, "", ICON_NONE);
}

static void node_shader_buts_oct_layered_mat(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "layer_number", UI_ITEM_NONE, "", ICON_NONE);
  node_oct_custom_aov_settings(layout, C, ptr);
}

static void node_shader_buts_oct_composite_mat(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "layer_number", UI_ITEM_NONE, "", ICON_NONE);
  node_oct_custom_aov_settings(layout, C, ptr);
}

static void node_shader_buts_oct_group_layer(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "layer_number", UI_ITEM_NONE, "", ICON_NONE);
}

static void node_shader_buts_oct_diffuse_layer(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "brdf_model", UI_ITEM_NONE, "", ICON_NONE);
}

static void node_shader_buts_oct_metallic_layer(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "brdf_model", UI_ITEM_NONE, "", ICON_NONE);
  uiItemR(layout, ptr, "metallic_reflection_mode", UI_ITEM_NONE, "", ICON_NONE);
}

static void node_shader_buts_oct_specular_layer(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "brdf_model", UI_ITEM_NONE, "", ICON_NONE);
}

static void node_shader_buts_oct_vertex_displacement_tex(uiLayout *layout,
                                                         bContext *C,
                                                         PointerRNA *ptr)
{
  uiItemR(layout, ptr, "map_type", UI_ITEM_NONE, "", ICON_NONE);
  uiItemR(layout, ptr, "vertex_space", UI_ITEM_NONE, "", ICON_NONE);
}

static void node_shader_buts_oct_vertex_displacement_mixer_tex(uiLayout *layout,
                                                               bContext *C,
                                                               PointerRNA *ptr)
{
  uiItemR(layout, ptr, "displacement_number", UI_ITEM_NONE, "", ICON_NONE);
}

static void node_shader_buts_oct_daylight_environment(uiLayout *layout,
                                                      bContext *C,
                                                      PointerRNA *ptr)
{
  uiItemR(layout, ptr, "daylight_model_type", UI_ITEM_NONE, "", ICON_NONE);
}

static void node_shader_buts_oct_toon_direction_light(uiLayout *layout,
                                                      bContext *C,
                                                      PointerRNA *ptr)
{
  uiItemR(layout, ptr, "light_direction_type", UI_ITEM_NONE, "", ICON_NONE);
}
...
static void node_shader_buts_oct_texture_reference(uiLayout *layout,
                                                   ...
                                                   PointerRNA *ptr)
{
  uiItemR(layout, ptr, "texture", UI_ITEM_NONE, NULL, 0);
}

static void node_shader_buts_oct_info_channels_kernel(uiLayout *layout,
                                                      bContext *C,
                                                      PointerRNA *ptr)
{
  uiItemR(layout, ptr, "sampling_model", UI_ITEM_NONE, "", ICON_NONE);
  uiItemR(layout, ptr, "info_channels_type", UI_ITEM_NONE, "", ICON_NONE);
}

static void node_shader_buts_oct_dirt_tex(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "bias_coordinate_space_type", UI_ITEM_NONE, "", ICON_NONE);
  uiItemR(layout, ptr, "include_object_mode", UI_ITEM_NONE, "", ICON_NONE);
}

static void node_shader_buts_oct_medium(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "lock_step_length_mode", UI_ITEM_NONE, "", ICON_NONE);
}

static void node_shader_buts_oct_hair_mat(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
                                             ...
                                             PointerRNA *ptr)
{
  ...
  // uiItemR(layout, ptr, "object", UI_ITEM_NONE, NULL, 0);
}
...
static void node_shader_buts_oct_scatter_tool_surface(uiLayout *layout,
                                                      ...
                                                      PointerRNA *ptr)
{
  uiItemR(layout, ptr, "object_selection_method", UI_ITEM_NONE, NULL, 0);
  uiItemR(layout, ptr, "distribution_method", UI_ITEM_NONE, NULL, 0);
  uiItemR(layout, ptr, "distribution_on_particles_method", UI_ITEM_NONE, NULL, 0);
  uiItemR(layout, ptr, "distribution_on_hairs_method", UI_ITEM_NONE, NULL, 0);
  uiItemR(layout, ptr, "orientation_priority", UI_ITEM_NONE, NULL, 0);
  uiItemR(layout, ptr, "up_direction_mode", UI_ITEM_NONE, NULL, 0);
  uiItemR(layout, ptr, "front_direction_mode", UI_ITEM_NONE, NULL, 0);
  uiItemR(layout, ptr, "rotation_mode", UI_ITEM_NONE, NULL, 0);
  uiItemR(layout, ptr, "scale_mode", UI_ITEM_NONE, NULL, 0);
  uiItemR(layout, ptr, "translation_mode", UI_ITEM_NONE, NULL, 0);
}
...
{
  uiItemR(layout, ptr, "object_selection_method", UI_ITEM_NONE, NULL, 0);
  uiItemR(layout, ptr, "shape", UI_ITEM_NONE, NULL, 0);
  uiItemR(layout, ptr, "orientation_priority", UI_ITEM_NONE, NULL, 0);
  uiItemR(layout, ptr, "up_direction_mode", UI_ITEM_NONE, NULL, 0);
  uiItemR(layout, ptr, "front_direction_mode", UI_ITEM_NONE, NULL, 0);
  uiItemR(layout, ptr, "rotation_mode", UI_ITEM_NONE, NULL, 0);
...
static void node_shader_buts_oct_channel_picker_tex(uiLayout *layout,
                                                    ...
                                                    PointerRNA *ptr)
{
  uiItemR(layout, ptr, "channel", UI_ITEM_NONE, NULL, 0);
}
...
static void node_shader_buts_oct_spotlight_tex(uiLayout *layout,
                                               ...
                                               PointerRNA *ptr)
{
  uiItemR(layout, ptr, "orientation", UI_ITEM_NONE, NULL, 0);
}
...
static void node_shader_buts_oct_composite_layer_tex(uiLayout *layout,
                                                     ...
                                                     PointerRNA *ptr)
{
  uiItemR(layout, ptr, "blend_mode", UI_ITEM_NONE, NULL, 0);
  uiItemR(layout, ptr, "overlay_mode", UI_ITEM_NONE, NULL, 0);
  uiItemR(layout, ptr, "alpha_operation_mode", UI_ITEM_NONE, NULL, 0);
}
...
static void node_shader_buts_oct_composite_tex(uiLayout *layout,
                                               ...
                                               PointerRNA *ptr)
{
  uiItemR(layout, ptr, "layer_number", UI_ITEM_NONE, NULL, 0);
}
...
static void node_shader_buts_oct_aov_output_group(uiLayout *layout,
                                                  ...
                                                  PointerRNA *ptr)
{
  uiItemR(layout, ptr, "group_number", UI_ITEM_NONE, NULL, 0);
}
...
static void node_shader_buts_oct_composite_aov_output_layer(uiLayout *layout,
                                                            ...
                                                            PointerRNA *ptr)
{
  uiItemR(layout, ptr, "mask_channel", UI_ITEM_NONE, NULL, 0);
  uiItemR(layout, ptr, "blend_mode", UI_ITEM_NONE, NULL, 0);
  uiItemR(layout, ptr, "alpha_operation", UI_ITEM_NONE, NULL, 0);
}
...
static void node_shader_buts_oct_render_aov_output(uiLayout *layout,
                                                   ...
                                                   PointerRNA *ptr)
{
  uiItemR(layout, ptr, "input", UI_ITEM_NONE, NULL, 0);
  uiItemR(layout, ptr, "output_channel", UI_ITEM_NONE, NULL, 0);
}

static void node_shader_buts_oct_image_aov_output(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemR(layout, ptr, "color_space", UI_ITEM_NONE, NULL, 0);
  uiItemR(layout, ptr, "output_channel", UI_ITEM_NONE, NULL, 0);
  node_shader_buts_oct_image(layout, C, ptr);
}
...
static void node_shader_buts_oct_raed_vdb_tex(uiLayout *layout,
                                              ...
                                              PointerRNA *ptr)
{
  uiItemR(layout, ptr, "grid_id", UI_ITEM_NONE, NULL, 0);
}
...
static void node_shader_buts_oct_binary_math_operation_tex(uiLayout *layout,
                                                           ...
                                                           PointerRNA *ptr)
{
  uiItemR(layout, ptr, "operation", UI_ITEM_NONE, NULL, 0);
}
...
static void node_shader_buts_oct_gradient_generator_tex(uiLayout *layout,
                                                        ...
                                                        PointerRNA *ptr)
{
  uiItemR(layout, ptr, "gradient_type", UI_ITEM_NONE, NULL, 0);
  uiItemR(layout, ptr, "repetition_mode", UI_ITEM_NONE, NULL, 0);
}
...
static void node_shader_buts_oct_capture_to_custom_aov_tex(uiLayout *layout,
                                                           ...
                                                           PointerRNA *ptr)
{
  uiItemR(layout, ptr, "custom_aov", UI_ITEM_NONE, NULL, 0);
}
...
static void node_shader_buts_oct_position_tex(uiLayout *layout,
                                              ...
                                              PointerRNA *ptr)
{
  uiItemR(layout, ptr, "coordinate_system", UI_ITEM_NONE, NULL, 0);
}
...
static void node_shader_buts_oct_random_map_tex(uiLayout *layout,
                                                ...
                                                PointerRNA *ptr)
{
  uiItemR(layout, ptr, "noise_function", UI_ITEM_NONE, NULL, 0);
}
...
static void node_shader_buts_oct_clamp_aov_output(uiLayout *layout,
                                                   ...
                                                   PointerRNA *ptr)
{
  uiItemR(layout, ptr, "color_channels", UI_ITEM_NONE, NULL, 0);
}
...
static void _node_shader_buts_script_ex(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  uiItemS(layout);

  _node_shader_buts_script(layout, C, ptr);
...
static void node_shader_set_butfunc(bNodeType *ntype)
{
  switch (ntype->type) {
    ...
    case SH_NODE_BSDF_REFRACTION:
      ...
      break;
    case SH_NODE_OCT_OSL_TEX:
    case SH_NODE_OCT_PROJECTION_OSL:
    case SH_NODE_OCT_OSL_CAMERA:
    case SH_NODE_OCT_OSL_BAKING_CAMERA:
    case SH_NODE_OCT_VECTRON:
      ntype->draw_buttons = _node_shader_buts_script;
      ntype->draw_buttons_ex = _node_shader_buts_script_ex;
      break;    case SH_NODE_OUTPUT_MATERIAL:
    ...
    case SH_NODE_OCT_ALPHA_IMAGE_TEX:
      ntype->draw_buttons = node_shader_buts_oct_tex_image;
      ntype->draw_buttons_ex = node_shader_buts_tex_image_ex;
      break;
    case SH_NODE_OCT_IMAGE_TILE_TEX:
      ntype->draw_buttons = node_shader_buts_oct_tex_image_tile;
      break;
    case SH_NODE_OCT_INSTANCE_COLOR_TEX:
      ntype->draw_buttons = node_shader_buts_oct_tex_instance_color;
      break;
    case SH_NODE_OCT_BAKING_TEX:
      ntype->draw_buttons = node_shader_buts_tex_baking;
      break;
    case SH_NODE_OCT_NOISE_TEX:
      ntype->draw_buttons = node_shader_buts_oct_noise_tex;
      break;
    case SH_NODE_OCT_CINEMA4D_NOISE_TEX:
      ntype->draw_buttons = node_shader_buts_oct_cinema4d_noise_tex;
      break;
    case SH_NODE_OCT_FALLOFF_TEX:
      ntype->draw_buttons = node_shader_buts_oct_falloff_tex;
      break;
    case SH_NODE_OCT_DISPLACEMENT_TEX:
      ntype->draw_buttons = node_shader_buts_oct_displacement_tex;
      break;
    case SH_NODE_OCT_VERTEX_DISPLACEMENT_TEX:
      ntype->draw_buttons = node_shader_buts_oct_vertex_displacement_tex;
      break;
    case SH_NODE_OCT_VERTEX_DISPLACEMENT_MIXER_TEX:
      ntype->draw_buttons = node_shader_buts_oct_vertex_displacement_mixer_tex;
      break;
    case SH_NODE_OCT_DIFFUSE_MAT:
      ntype->draw_buttons = node_shader_buts_oct_diffuse_mat;
      break;
    case SH_NODE_OCT_MIX_MAT:
      ntype->draw_buttons = node_shader_buts_oct_mix_mat;
      break;
    case SH_NODE_OCT_SHADOW_CATCHER_MAT:
      ntype->draw_buttons = node_shader_buts_oct_shadow_catcher_mat;
      break;
    case SH_NODE_OCT_TOON_MAT:
      ntype->draw_buttons = node_shader_buts_oct_toon_mat;
      break;
    case SH_NODE_OCT_GLOSSY_MAT:
      ntype->draw_buttons = node_shader_buts_oct_glossy_mat;
      break;
    case SH_NODE_OCT_SPECULAR_MAT:
      ntype->draw_buttons = node_shader_buts_oct_specular_mat;
      break;
    case SH_NODE_OCT_METAL_MAT:
      ntype->draw_buttons = node_shader_buts_oct_metal_mat;
      break;
    case SH_NODE_OCT_UNIVERSAL_MAT:
      ntype->draw_buttons = node_shader_buts_oct_universal_mat;
      break;
    case SH_NODE_OCT_LAYERED_MAT:
      ntype->draw_buttons = node_shader_buts_oct_layered_mat;
      break;
    case SH_NODE_OCT_COMPOSITE_MAT:
      ntype->draw_buttons = node_shader_buts_oct_composite_mat;
      break;
    case SH_NODE_OCT_GROUP_LAYER:
      ntype->draw_buttons = node_shader_buts_oct_group_layer;
      break;
    case SH_NODE_OCT_DIFFUSE_LAYER:
      ntype->draw_buttons = node_shader_buts_oct_diffuse_layer;
      break;
    case SH_NODE_OCT_METALLIC_LAYER:
      ntype->draw_buttons = node_shader_buts_oct_metallic_layer;
      break;
    case SH_NODE_OCT_SPECULAR_LAYER:
      ntype->draw_buttons = node_shader_buts_oct_specular_layer;
      break;
    case SH_NODE_OCT_PROJECTION_BOX:
    case SH_NODE_OCT_PROJECTION_CYL:
    case SH_NODE_OCT_PROJECTION_PERSP:
    case SH_NODE_OCT_PROJECTION_SPHERICAL:
    case SH_NODE_OCT_PROJECTION_XYZ:
      ntype->draw_buttons = node_shader_buts_oct_projections;
      break;
    case SH_NODE_OCT_TRIPLANAR_TEX:
      ntype->draw_buttons = node_shader_buts_oct_projections;
      break;
    case SH_NODE_OCT_GRADIENT_TEX:
    case SH_NODE_OCT_VOLUME_RAMP_TEX:
    case SH_NODE_OCT_TOON_RAMP_TEX:
      ntype->draw_buttons = node_shader_buts_oct_color_ramp;
      break;
    case SH_NODE_OCT_ROTATE_TRN:
    case SH_NODE_OCT_3D_TRN:
    case SH_NODE_OCT_FULL_TRN:
      ntype->draw_buttons = node_shader_buts_oct_transforms;
      break;
    case SH_NODE_OCT_DAYLIGHT_ENVIRONMENT:
      ntype->draw_buttons = node_shader_buts_oct_daylight_environment;
      break;
    case SH_NODE_OCT_TOON_DIRECTION_LIGHT:
      ntype->draw_buttons = node_shader_buts_oct_toon_direction_light;
      break;
    case SH_NODE_OCT_ROUNDEDGES:
      ntype->draw_buttons = node_shader_buts_oct_round_edges;
      break;
    case SH_NODE_OCT_VALUE_TEXTURE_REFERENCE:
      ntype->draw_buttons = node_shader_buts_oct_texture_reference;
      break;
    case SH_NODE_OCT_DIRT_TEX:
      ntype->draw_buttons = node_shader_buts_oct_dirt_tex;
      break;
    case SH_NODE_OCT_ABSORP_MED:
    case SH_NODE_OCT_SCATTER_MED:
    case SH_NODE_OCT_VOLUME_MED:
    case SH_NODE_OCT_RANDOMWALK_MED:
      ntype->draw_buttons = node_shader_buts_oct_medium;
      break;
    case SH_NODE_OCT_HAIR_MAT:
      ntype->draw_buttons = node_shader_buts_oct_hair_mat;
      break;
    case SH_NODE_OCT_OBJECT_DATA:
      ntype->draw_buttons = node_shader_buts_oct_object_data;
      break;
    case SH_NODE_OCT_SCATTER_TOOL_SURFACE:
      ntype->draw_buttons = node_shader_buts_oct_scatter_tool_surface;
      break;
    case SH_NODE_OCT_SCATTER_TOOL_VOLUME:
      ntype->draw_buttons = node_shader_buts_oct_scatter_tool_volume;
      break;
    case SH_NODE_OCT_CHANNEL_PICKER_TEX:
      ntype->draw_buttons = node_shader_buts_oct_channel_picker_tex;
      break;
    case SH_NODE_OCT_SPOTLIGHT_TEX:
      ntype->draw_buttons = node_shader_buts_oct_spotlight_tex;
      break;
    case SH_NODE_OCT_COMPOSITE_LAYER_TEX:
      ntype->draw_buttons = node_shader_buts_oct_composite_layer_tex;
      break;
    case SH_NODE_OCT_COMPOSITE_TEX:
      ntype->draw_buttons = node_shader_buts_oct_composite_tex;
      break;
    case SH_NODE_OCT_AOV_OUTPUT_GROUP:
      ntype->draw_buttons = node_shader_buts_oct_aov_output_group;
      break;
    case SH_NODE_OCT_COMPOSITE_AOV_OUTPUT:
      ntype->draw_buttons = node_shader_buts_oct_composite_aov_output;
      break;
    case SH_NODE_OCT_COMPOSITE_AOV_OUTPUT_LAYER:
      ntype->draw_buttons = node_shader_buts_oct_composite_aov_output_layer;
      break;
    case SH_NODE_OCT_RENDER_AOV_OUTPUT:
      ntype->draw_buttons = node_shader_buts_oct_render_aov_output;
      break;
    case SH_NODE_OCT_IMAGE_AOV_OUTPUT:
      ntype->draw_buttons = node_shader_buts_oct_image_aov_output;
      ntype->draw_buttons_ex = node_shader_buts_tex_image_ex;
      break;
    case SH_NODE_OCT_READ_VDB_TEX:
      ntype->draw_buttons = node_shader_buts_oct_raed_vdb_tex;
      break;
    case SH_NODE_OCT_BINARY_MATH_OPERATION:
      ntype->draw_buttons = node_shader_buts_oct_binary_math_operation_tex;
      break;
    case SH_NODE_OCT_UNARY_MATH_OPERATION:
      ntype->draw_buttons = node_shader_buts_oct_unary_math_operation_tex;
      break;
    case SH_NODE_OCT_GRADIENT_GENERATOR:
      ntype->draw_buttons = node_shader_buts_oct_gradient_generator_tex;
      break;
    case SH_NODE_OCT_CAPTURE_TO_CUSTOM_AOV:
      ntype->draw_buttons = node_shader_buts_oct_capture_to_custom_aov_tex;
      break;
    case SH_NODE_OCT_POSITION:
      ntype->draw_buttons = node_shader_buts_oct_position_tex;
      break;
    case SH_NODE_OCT_RELATIVE_DISTANCE:
      ntype->draw_buttons = node_shader_buts_oct_relative_distance_tex;
      break;
    case SH_NODE_OCT_NORMAL:
      ntype->draw_buttons = node_shader_buts_oct_normal_tex;
      break;
    case SH_NODE_OCT_RANGE:
      ntype->draw_buttons = node_shader_buts_oct_range_tex;
      break;
    case SH_NODE_OCT_RANDOM_MAP:
      ntype->draw_buttons = node_shader_buts_oct_random_map_tex;
      break;
    case SH_NODE_OCT_RAY_DIRECTION:
      ntype->draw_buttons = node_shader_buts_oct_ray_direction_tex;
      break;
    case SH_NODE_OCT_CLAMP_AOV_OUTPUT:
      ntype->draw_buttons = node_shader_buts_oct_clamp_aov_output;
      break;
    case SH_NODE_OCT_MAP_RANGE_AOV_OUTPUT:
      ntype->draw_buttons = node_shader_buts_oct_map_range_aov_output;
      break;
  }
}
