...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
static __forceinline bool object_ray_visibility(BL::Object b_ob) {
...
// 
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
static __forceinline bool object_render_hide_original(BL::Object::dupli_type_enum dupli_type) {
...
// 
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
static __forceinline bool object_render_hide(BL::Object b_ob, bool top_level, bool parent_hide, bool& hide_triangles) {
...
// 
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
static __forceinline bool object_render_hide_duplis(BL::Object b_ob) {
	BL::Object parent = b_ob.parent();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Test if the Blender Object is Curve
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool BlenderSync::object_is_curve(BL::Object b_ob) {
	BL::ID b_ob_data = b_ob.data();

	return (b_ob_data && b_ob_data.is_a(&RNA_Curve));
} //object_is_curve()
...
void BlenderSync::sync_objects(BL::SpaceView3D b_v3d, int motion) {
	...
	progress.set_sync_status("Collecting unused objects");
