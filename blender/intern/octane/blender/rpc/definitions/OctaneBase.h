...
#define HIDDEN_NODE_TYPE(_name, _enum)  _name = _enum,
	enum NodeType {
		...
		HIDDEN_NODE_TYPE(NT_AOV_ACCUMULATED_HIT_DISTANCE, 180)
		HIDDEN_NODE_TYPE(NT_AOV_ACCUMULATED_ROUGHNESS, 181)
		HIDDEN_NODE_TYPE(NT_AOV_ACCUMULATED_SHADING_NORMAL, 182)
		...
		HIDDEN_NODE_TYPE(NT_AOV_NOISE_DIFFUSE_DIRECT, 213)
		HIDDEN_NODE_TYPE(NT_AOV_NOISE_DIFFUSE_INDIRECT, 214)
		HIDDEN_NODE_TYPE(NT_AOV_NOISE_REFLECTION_DIRECT, 215)
		HIDDEN_NODE_TYPE(NT_AOV_NOISE_REFLECTION_INDIRECT, 216)
		...
		HIDDEN_NODE_TYPE(NT_AOV_TRACE_CLOCK, 241)
