...
#    define MSGPACK_PP_SEQ_FOR_EACH_I(macro, data, seq) \
      MSGPACK_PP_SEQ_FOR_EACH_I_DETAIL_CHECK(macro, data, seq)
#  else
#    define MSGPACK_PP_SEQ_FOR_EACH_I(macro, data, seq) \
      MSGPACK_PP_SEQ_FOR_EACH_I_I(macro, data, seq)
#    define MSGPACK_PP_SEQ_FOR_EACH_I_I(macro, data, seq) \
      MSGPACK_PP_SEQ_FOR_EACH_I_DETAIL_CHECK(macro, data, seq)
#  endif
#
...
#  define MSGPACK_PP_SEQ_FOR_EACH_I_O_I_DEC(macro, data, seq, i, sz) \
    (macro, \
     data, \
     MSGPACK_PP_IF(sz, MSGPACK_PP_SEQ_FOR_EACH_I_O_I_TAIL, MSGPACK_PP_SEQ_FOR_EACH_I_O_I_NIL)( \
         seq), \
     MSGPACK_PP_INC(i), \
     sz) /**/
...
#    define MSGPACK_PP_SEQ_FOR_EACH_I_M(r, x) \
      MSGPACK_PP_SEQ_FOR_EACH_I_M_IM(r, MSGPACK_PP_TUPLE_REM_5 x)
...
#  endif
#
#  define MSGPACK_PP_SEQ_FOR_EACH_I_M_I(r, macro, data, seq, i, sz) \
    macro(r, data, i, MSGPACK_PP_SEQ_HEAD(seq))
#
#  /* MSGPACK_PP_SEQ_FOR_EACH_I_R */
#
#  if ~MSGPACK_PP_CONFIG_FLAGS() & MSGPACK_PP_CONFIG_EDG()
#    define MSGPACK_PP_SEQ_FOR_EACH_I_R(r, macro, data, seq) \
      MSGPACK_PP_SEQ_FOR_EACH_I_R_DETAIL_CHECK(r, macro, data, seq)
#  else
#    define MSGPACK_PP_SEQ_FOR_EACH_I_R(r, macro, data, seq) \
      MSGPACK_PP_SEQ_FOR_EACH_I_R_I(r, macro, data, seq)
#    define MSGPACK_PP_SEQ_FOR_EACH_I_R_I(r, macro, data, seq) \
      MSGPACK_PP_SEQ_FOR_EACH_I_R_DETAIL_CHECK(r, macro, data, seq)
#  endif
#
