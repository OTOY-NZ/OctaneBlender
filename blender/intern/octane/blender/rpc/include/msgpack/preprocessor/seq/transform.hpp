...
#    define MSGPACK_PP_SEQ_TRANSFORM(op, data, seq) \
      MSGPACK_PP_SEQ_TAIL(MSGPACK_PP_TUPLE_ELEM( \
          3, 2, MSGPACK_PP_SEQ_FOLD_LEFT(MSGPACK_PP_SEQ_TRANSFORM_O, (op, data, (nil)), seq)))
#  else
...
#    define MSGPACK_PP_SEQ_TRANSFORM_O(s, state, elem) \
      MSGPACK_PP_SEQ_TRANSFORM_O_IM(s, MSGPACK_PP_TUPLE_REM_3 state, elem)
...
#    define MSGPACK_PP_SEQ_TRANSFORM_S(s, op, data, seq) \
      MSGPACK_PP_SEQ_TAIL(MSGPACK_PP_TUPLE_ELEM( \
          3, \
          2, \
          MSGPACK_PP_SEQ_FOLD_LEFT_##s(MSGPACK_PP_SEQ_TRANSFORM_O, (op, data, (nil)), seq)))
#  else
#    define MSGPACK_PP_SEQ_TRANSFORM_S(s, op, data, seq) \
      MSGPACK_PP_SEQ_TRANSFORM_S_I(s, op, data, seq)
