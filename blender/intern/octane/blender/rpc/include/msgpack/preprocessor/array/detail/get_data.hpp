...
#      define MSGPACK_PP_ARRAY_DETAIL_GET_DATA_ANY_VC_DEFAULT(size, data) \
        MSGPACK_PP_TUPLE_REM(size) data
#      define MSGPACK_PP_ARRAY_DETAIL_GET_DATA_ANY_VC_CAT(size, data) \
        MSGPACK_PP_TUPLE_REM_CAT(size) data
...
#  define MSGPACK_PP_ARRAY_DETAIL_GET_DATA(size, data) \
    MSGPACK_PP_IF( \
        size, MSGPACK_PP_ARRAY_DETAIL_GET_DATA_ANY, MSGPACK_PP_ARRAY_DETAIL_GET_DATA_NONE) \
    (size, data) /**/
#
