...
#    define MSGPACK_PP_DIV_BASE(x, y) \
      MSGPACK_PP_WHILE(MSGPACK_PP_DIV_BASE_P, MSGPACK_PP_DIV_BASE_O, (0, x, y))
#  else
...
#    define MSGPACK_PP_DIV_BASE_P(d, rxy) \
      MSGPACK_PP_DIV_BASE_P_I(d, \
                              MSGPACK_PP_TUPLE_ELEM(3, 0, rxy), \
                              MSGPACK_PP_TUPLE_ELEM(3, 1, rxy), \
                              MSGPACK_PP_TUPLE_ELEM(3, 2, rxy))
#  endif
#
...
#    define MSGPACK_PP_DIV_BASE_D(d, x, y) \
      MSGPACK_PP_WHILE_##d(MSGPACK_PP_DIV_BASE_P, MSGPACK_PP_DIV_BASE_O, (0, x, y))
#  else
