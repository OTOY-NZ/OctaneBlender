...
#    if defined __GCCXML__ || defined __CUDACC__ || defined __PATHSCALE__ || defined __DMC__ || \
        defined __CODEGEARC__ || defined __BORLANDC__ || defined __MWERKS__ || \
        (defined __SUNPRO_CC && __SUNPRO_CC < 0x5120) || defined __HP_aCC && !defined __EDG__ || \
        defined __MRC__ || defined __SC__ || defined __IBMCPP__ || defined __PGI
#      define MSGPACK_PP_VARIADICS 0
#      /* VC++ (C/C++) */
#    elif defined _MSC_VER && _MSC_VER >= 1400 && \
        (!defined __EDG__ || defined(__INTELLISENSE__)) && !defined __clang__
...
#    if defined _MSC_VER && _MSC_VER >= 1400 && \
        (defined(__INTELLISENSE__) || \
         !(defined __EDG__ || defined __GCCXML__ || defined __CUDACC__ || \
           defined __PATHSCALE__ || defined __clang__ || defined __DMC__ || \
           defined __CODEGEARC__ || defined __BORLANDC__ || defined __MWERKS__ || \
           defined __SUNPRO_CC || defined __HP_aCC || defined __MRC__ || defined __SC__ || \
           defined __IBMCPP__ || defined __PGI))
#      undef MSGPACK_PP_VARIADICS_MSVC
#      define MSGPACK_PP_VARIADICS_MSVC 1
#    endif
#  else
