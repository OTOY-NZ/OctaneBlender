...
#  define MSGPACK_PP_WHILE \
    MSGPACK_PP_CAT(MSGPACK_PP_WHILE_, MSGPACK_PP_AUTO_REC(MSGPACK_PP_WHILE_P, 256))
#
...
#    define MSGPACK_PP_WHILE_P(n) \
      MSGPACK_PP_BITAND( \
          ...
          MSGPACK_PP_BITAND(MSGPACK_PP_CAT(MSGPACK_PP_LIST_FOLD_LEFT_CHECK_, \
                                           MSGPACK_PP_LIST_FOLD_LEFT_##n( \
                                               MSGPACK_PP_NIL, MSGPACK_PP_NIL, MSGPACK_PP_NIL)), \
                            MSGPACK_PP_CAT(MSGPACK_PP_LIST_FOLD_RIGHT_CHECK_, \
                                           MSGPACK_PP_LIST_FOLD_RIGHT_##n( \
                                               MSGPACK_PP_NIL, MSGPACK_PP_NIL, MSGPACK_PP_NIL))))
#  else
#    define MSGPACK_PP_WHILE_P(n) \
      MSGPACK_PP_BITAND(MSGPACK_PP_CAT(MSGPACK_PP_WHILE_CHECK_, \
                                       MSGPACK_PP_WHILE_##n( \
                                           MSGPACK_PP_WHILE_F, MSGPACK_PP_NIL, MSGPACK_PP_NIL)), \
