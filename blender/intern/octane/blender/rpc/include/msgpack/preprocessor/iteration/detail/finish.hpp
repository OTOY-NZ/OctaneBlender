...
#  define MSGPACK_PP_LOCAL_FE() \
    MSGPACK_PP_SLOT_CC_3( \
        MSGPACK_PP_LOCAL_FE_DIGIT_3, MSGPACK_PP_LOCAL_FE_DIGIT_2, MSGPACK_PP_LOCAL_FE_DIGIT_1)
#elif MSGPACK_PP_LOCAL_FE_DIGIT_2
#  define MSGPACK_PP_LOCAL_FE() \
    MSGPACK_PP_SLOT_CC_2(MSGPACK_PP_LOCAL_FE_DIGIT_2, MSGPACK_PP_LOCAL_FE_DIGIT_1)
#else
