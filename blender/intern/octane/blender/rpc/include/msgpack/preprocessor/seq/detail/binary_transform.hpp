...
#    define MSGPACK_PP_SEQ_BINARY_TRANSFORM_III(seq) \
      MSGPACK_PP_CAT(MSGPACK_PP_SEQ_BINARY_TRANSFORM_A seq, 0)
#  else
...
#    define MSGPACK_PP_SEQ_BINARY_TRANSFORM_A(...) \
      (MSGPACK_PP_SEQ_BINARY_TRANSFORM_GET_REM(__VA_ARGS__), __VA_ARGS__)() \
...
#    define MSGPACK_PP_SEQ_BINARY_TRANSFORM_A(e) \
      (MSGPACK_PP_REM, e)() MSGPACK_PP_SEQ_BINARY_TRANSFORM_B
#    define MSGPACK_PP_SEQ_BINARY_TRANSFORM_B(e) \
      (MSGPACK_PP_REM, e)() MSGPACK_PP_SEQ_BINARY_TRANSFORM_A
#  endif
