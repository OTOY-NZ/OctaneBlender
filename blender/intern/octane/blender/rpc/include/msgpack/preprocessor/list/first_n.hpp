...
#    define MSGPACK_PP_LIST_FIRST_N(count, list) \
      MSGPACK_PP_LIST_REVERSE( \
          MSGPACK_PP_TUPLE_ELEM(3, \
                                2, \
                                MSGPACK_PP_WHILE(MSGPACK_PP_LIST_FIRST_N_P, \
...
#    define MSGPACK_PP_LIST_FIRST_N_O(d, data) \
      MSGPACK_PP_LIST_FIRST_N_O_D(MSGPACK_PP_TUPLE_ELEM(3, 0, data), \
                                  MSGPACK_PP_TUPLE_ELEM(3, 1, data), \
                                  MSGPACK_PP_TUPLE_ELEM(3, 2, data))
#  endif
#
