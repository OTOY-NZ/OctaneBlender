...
#
#  define MSGPACK_PP_ITERATION() \
    MSGPACK_PP_CAT(MSGPACK_PP_ITERATION_, MSGPACK_PP_ITERATION_DEPTH())
#
#  /* MSGPACK_PP_ITERATION_START && MSGPACK_PP_ITERATION_FINISH */
#
#  define MSGPACK_PP_ITERATION_START() \
    MSGPACK_PP_CAT(MSGPACK_PP_ITERATION_START_, MSGPACK_PP_ITERATION_DEPTH())
#  define MSGPACK_PP_ITERATION_FINISH() \
    MSGPACK_PP_CAT(MSGPACK_PP_ITERATION_FINISH_, MSGPACK_PP_ITERATION_DEPTH())
#
#  /* MSGPACK_PP_ITERATION_FLAGS */
#
#  define MSGPACK_PP_ITERATION_FLAGS() \
    (MSGPACK_PP_CAT(MSGPACK_PP_ITERATION_FLAGS_, MSGPACK_PP_ITERATION_DEPTH())())
#
...
#
#  define MSGPACK_PP_RELATIVE_ITERATION(i) \
    MSGPACK_PP_CAT(MSGPACK_PP_RELATIVE_, i)(MSGPACK_PP_ITERATION_)
#
...
#  define MSGPACK_PP_RELATIVE_2(m) \
    MSGPACK_PP_CAT(m, MSGPACK_PP_DEC(MSGPACK_PP_DEC(MSGPACK_PP_ITERATION_DEPTH())))
...
#  define MSGPACK_PP_RELATIVE_4(m) \
    MSGPACK_PP_CAT(m, \
                   MSGPACK_PP_DEC(MSGPACK_PP_DEC( \
                       MSGPACK_PP_DEC(MSGPACK_PP_DEC(MSGPACK_PP_ITERATION_DEPTH())))))
#
#  /* MSGPACK_PP_RELATIVE_START && MSGPACK_PP_RELATIVE_FINISH */
#
#  define MSGPACK_PP_RELATIVE_START(i) \
    MSGPACK_PP_CAT(MSGPACK_PP_RELATIVE_, i)(MSGPACK_PP_ITERATION_START_)
#  define MSGPACK_PP_RELATIVE_FINISH(i) \
    MSGPACK_PP_CAT(MSGPACK_PP_RELATIVE_, i)(MSGPACK_PP_ITERATION_FINISH_)
#
#  /* MSGPACK_PP_RELATIVE_FLAGS */
#
#  define MSGPACK_PP_RELATIVE_FLAGS(i) \
    (MSGPACK_PP_CAT(MSGPACK_PP_RELATIVE_, i)(MSGPACK_PP_ITERATION_FLAGS_)())
#
#  /* MSGPACK_PP_ITERATE */
#
#  define MSGPACK_PP_ITERATE() \
    MSGPACK_PP_CAT(MSGPACK_PP_ITERATE_, MSGPACK_PP_INC(MSGPACK_PP_ITERATION_DEPTH()))
#
