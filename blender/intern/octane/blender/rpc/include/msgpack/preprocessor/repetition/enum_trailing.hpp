...
#  endif
#
#  define MSGPACK_PP_ENUM_TRAILING \
    MSGPACK_PP_CAT(MSGPACK_PP_ENUM_TRAILING_, MSGPACK_PP_AUTO_REC(MSGPACK_PP_REPEAT_P, 4))
#
#  if ~MSGPACK_PP_CONFIG_FLAGS() & MSGPACK_PP_CONFIG_EDG()
#    define MSGPACK_PP_ENUM_TRAILING_1(c, m, d) \
      MSGPACK_PP_REPEAT_1(c, MSGPACK_PP_ENUM_TRAILING_M_1, (m, d))
#    define MSGPACK_PP_ENUM_TRAILING_2(c, m, d) \
      MSGPACK_PP_REPEAT_2(c, MSGPACK_PP_ENUM_TRAILING_M_2, (m, d))
#    define MSGPACK_PP_ENUM_TRAILING_3(c, m, d) \
      MSGPACK_PP_REPEAT_3(c, MSGPACK_PP_ENUM_TRAILING_M_3, (m, d))
#  else
...
#    define MSGPACK_PP_ENUM_TRAILING_1_I(c, m, d) \
      MSGPACK_PP_REPEAT_1(c, MSGPACK_PP_ENUM_TRAILING_M_1, (m, d))
#    define MSGPACK_PP_ENUM_TRAILING_2_I(c, m, d) \
      MSGPACK_PP_REPEAT_2(c, MSGPACK_PP_ENUM_TRAILING_M_2, (m, d))
#    define MSGPACK_PP_ENUM_TRAILING_3_I(c, m, d) \
      MSGPACK_PP_REPEAT_3(c, MSGPACK_PP_ENUM_TRAILING_M_3, (m, d))
#  endif
#
...
#    define MSGPACK_PP_ENUM_TRAILING_M_1(z, n, md) \
      MSGPACK_PP_ENUM_TRAILING_M_1_IM(z, n, MSGPACK_PP_TUPLE_REM_2 md)
#    define MSGPACK_PP_ENUM_TRAILING_M_2(z, n, md) \
      MSGPACK_PP_ENUM_TRAILING_M_2_IM(z, n, MSGPACK_PP_TUPLE_REM_2 md)
#    define MSGPACK_PP_ENUM_TRAILING_M_3(z, n, md) \
      MSGPACK_PP_ENUM_TRAILING_M_3_IM(z, n, MSGPACK_PP_TUPLE_REM_2 md)
