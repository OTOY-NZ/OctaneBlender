...
#      define MSGPACK_PP_TUPLE_TO_ARRAY(...) \
        MSGPACK_PP_TUPLE_TO_ARRAY_I(MSGPACK_PP_OVERLOAD(MSGPACK_PP_TUPLE_TO_ARRAY_, __VA_ARGS__), \
                                    (__VA_ARGS__))
...
#    else
#      define MSGPACK_PP_TUPLE_TO_ARRAY(...) \
        MSGPACK_PP_OVERLOAD(MSGPACK_PP_TUPLE_TO_ARRAY_, __VA_ARGS__)(__VA_ARGS__)
