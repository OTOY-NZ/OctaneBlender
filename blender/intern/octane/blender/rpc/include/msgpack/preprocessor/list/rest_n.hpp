...
#    define MSGPACK_PP_LIST_REST_N(count, list) \
      MSGPACK_PP_TUPLE_ELEM( \
          2, \
          0, \
          MSGPACK_PP_WHILE(MSGPACK_PP_LIST_REST_N_P, MSGPACK_PP_LIST_REST_N_O, (list, count)))
#  else
...
#    define MSGPACK_PP_LIST_REST_N_O(d, lc) \
      (MSGPACK_PP_LIST_REST(MSGPACK_PP_TUPLE_ELEM(2, 0, lc)), \
       MSGPACK_PP_DEC(MSGPACK_PP_TUPLE_ELEM(2, 1, lc)))
#  else
...
#    define MSGPACK_PP_LIST_REST_N_D(d, count, list) \
      MSGPACK_PP_TUPLE_ELEM(2, \
                            0, \
                            MSGPACK_PP_WHILE_##d(MSGPACK_PP_LIST_REST_N_P, \
