...
#    define MSGPACK_PP_SEQ_SIZE_II(seq) \
      MSGPACK_PP_CAT(MSGPACK_PP_SEQ_SIZE_, MSGPACK_PP_SEQ_SIZE_0##seq)
#  elif MSGPACK_PP_CONFIG_FLAGS() & MSGPACK_PP_CONFIG_EDG() || \
      MSGPACK_PP_CONFIG_FLAGS() & MSGPACK_PP_CONFIG_MSVC()
#    define MSGPACK_PP_SEQ_SIZE(seq) MSGPACK_PP_SEQ_SIZE_I(seq)
#    define MSGPACK_PP_SEQ_SIZE_I(seq) \
      MSGPACK_PP_CAT(MSGPACK_PP_SEQ_SIZE_, MSGPACK_PP_SEQ_SIZE_0 seq)
#  elif defined(__IBMC__) || defined(__IBMCPP__)
#    define MSGPACK_PP_SEQ_SIZE(seq) \
      MSGPACK_PP_CAT(MSGPACK_PP_SEQ_SIZE_, MSGPACK_PP_CAT(MSGPACK_PP_SEQ_SIZE_0, seq))
#  else
#    define MSGPACK_PP_SEQ_SIZE(seq) \
      MSGPACK_PP_CAT(MSGPACK_PP_SEQ_SIZE_, MSGPACK_PP_SEQ_SIZE_0 seq)
#  endif
