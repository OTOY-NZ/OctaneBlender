...
#    define MSGPACK_PP_SEQ_FILTER(pred, data, seq) \
      MSGPACK_PP_SEQ_TAIL(MSGPACK_PP_TUPLE_ELEM( \
          3, 2, MSGPACK_PP_SEQ_FOLD_LEFT(MSGPACK_PP_SEQ_FILTER_O, (pred, data, (nil)), seq)))
#  else
...
#    define MSGPACK_PP_SEQ_FILTER_S(s, pred, data, seq) \
      MSGPACK_PP_SEQ_TAIL(MSGPACK_PP_TUPLE_ELEM( \
          3, 2, MSGPACK_PP_SEQ_FOLD_LEFT_##s(MSGPACK_PP_SEQ_FILTER_O, (pred, data, (nil)), seq)))
#  else
#    define MSGPACK_PP_SEQ_FILTER_S(s, pred, data, seq) \
