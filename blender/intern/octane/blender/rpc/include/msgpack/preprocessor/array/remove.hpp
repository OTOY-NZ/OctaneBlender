...
#  define MSGPACK_PP_ARRAY_REMOVE(array, i) \
    MSGPACK_PP_ARRAY_REMOVE_I(MSGPACK_PP_DEDUCE_D(), array, i)
...
#    define MSGPACK_PP_ARRAY_REMOVE_D(d, array, i) \
      MSGPACK_PP_TUPLE_ELEM(4, \
                            2, \
                            MSGPACK_PP_WHILE_##d(MSGPACK_PP_ARRAY_REMOVE_P, \
...
#  define MSGPACK_PP_ARRAY_REMOVE_P(d, st) \
    MSGPACK_PP_NOT_EQUAL(MSGPACK_PP_TUPLE_ELEM(4, 0, st), \
                         MSGPACK_PP_ARRAY_SIZE(MSGPACK_PP_TUPLE_ELEM(4, 3, st)))
#
...
#    define MSGPACK_PP_ARRAY_REMOVE_O_I(n, i, res, arr) \
      (MSGPACK_PP_INC(n), \
       i, \
       MSGPACK_PP_IIF(MSGPACK_PP_NOT_EQUAL(n, i), \
                      MSGPACK_PP_ARRAY_PUSH_BACK, \
                      res MSGPACK_PP_TUPLE_EAT_2)(res, MSGPACK_PP_ARRAY_ELEM(n, arr)), \
       arr)
#  else
#    define MSGPACK_PP_ARRAY_REMOVE_O_I(n, i, res, arr) \
      (MSGPACK_PP_INC(n), \
       ...
       MSGPACK_PP_IIF(MSGPACK_PP_NOT_EQUAL(n, i), \
                      MSGPACK_PP_ARRAY_PUSH_BACK, \
                      MSGPACK_PP_TUPLE_ELEM_2_0)(res, MSGPACK_PP_ARRAY_ELEM(n, arr)), \
       arr)
#  endif
#
#endif
