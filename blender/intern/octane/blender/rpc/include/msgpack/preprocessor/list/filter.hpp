...
#    define MSGPACK_PP_LIST_FILTER(pred, data, list) \
      MSGPACK_PP_TUPLE_ELEM(3, \
                            ...
                            MSGPACK_PP_LIST_FOLD_RIGHT( \
                                MSGPACK_PP_LIST_FILTER_O, (pred, data, MSGPACK_PP_NIL), list))
#  else
...
#    define MSGPACK_PP_LIST_FILTER_O(d, pdr, elem) \
      MSGPACK_PP_LIST_FILTER_O_D(d, \
                                 MSGPACK_PP_TUPLE_ELEM(3, 0, pdr), \
                                 MSGPACK_PP_TUPLE_ELEM(3, 1, pdr), \
                                 MSGPACK_PP_TUPLE_ELEM(3, 2, pdr), \
                                 elem)
#  else
#    define MSGPACK_PP_LIST_FILTER_O(d, pdr, elem) \
      MSGPACK_PP_LIST_FILTER_O_I(d, MSGPACK_PP_TUPLE_REM_3 pdr, elem)
