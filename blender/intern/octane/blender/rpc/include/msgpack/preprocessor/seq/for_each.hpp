...
#    define MSGPACK_PP_SEQ_FOR_EACH(macro, data, seq) \
      MSGPACK_PP_SEQ_FOR_EACH_DETAIL_CHECK(macro, data, seq)
#  else
#    define MSGPACK_PP_SEQ_FOR_EACH(macro, data, seq) MSGPACK_PP_SEQ_FOR_EACH_D(macro, data, seq)
#    define MSGPACK_PP_SEQ_FOR_EACH_D(macro, data, seq) \
      MSGPACK_PP_SEQ_FOR_EACH_DETAIL_CHECK(macro, data, seq)
#  endif
#
...
#  define MSGPACK_PP_SEQ_FOR_EACH_O_I_DEC(macro, data, seq, sz) \
    (macro, \
     data, \
     MSGPACK_PP_IF(sz, MSGPACK_PP_SEQ_FOR_EACH_O_I_TAIL, MSGPACK_PP_SEQ_FOR_EACH_O_I_NIL)(seq), \
     sz) /**/
...
#    define MSGPACK_PP_SEQ_FOR_EACH_M(r, x) \
      MSGPACK_PP_SEQ_FOR_EACH_M_IM(r, MSGPACK_PP_TUPLE_REM_4 x)
...
#  endif
#
#  define MSGPACK_PP_SEQ_FOR_EACH_M_I(r, macro, data, seq, sz) \
    macro(r, data, MSGPACK_PP_SEQ_HEAD(seq))
#
#  /* MSGPACK_PP_SEQ_FOR_EACH_R */
#
#  if ~MSGPACK_PP_CONFIG_FLAGS() & MSGPACK_PP_CONFIG_EDG()
#    define MSGPACK_PP_SEQ_FOR_EACH_R(r, macro, data, seq) \
      MSGPACK_PP_SEQ_FOR_EACH_DETAIL_CHECK_R(r, macro, data, seq)
#  else
#    define MSGPACK_PP_SEQ_FOR_EACH_R(r, macro, data, seq) \
      MSGPACK_PP_SEQ_FOR_EACH_R_I(r, macro, data, seq)
#    define MSGPACK_PP_SEQ_FOR_EACH_R_I(r, macro, data, seq) \
      MSGPACK_PP_SEQ_FOR_EACH_DETAIL_CHECK_R(r, macro, data, seq)
#  endif
#
