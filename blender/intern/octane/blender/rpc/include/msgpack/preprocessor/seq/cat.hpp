...
#  define MSGPACK_PP_SEQ_CAT(seq) \
    MSGPACK_PP_IF( \
        MSGPACK_PP_DEC(MSGPACK_PP_SEQ_SIZE(seq)), MSGPACK_PP_SEQ_CAT_I, MSGPACK_PP_SEQ_HEAD) \
    (seq) /**/
#  define MSGPACK_PP_SEQ_CAT_I(seq) \
    MSGPACK_PP_SEQ_FOLD_LEFT( \
        MSGPACK_PP_SEQ_CAT_O, MSGPACK_PP_SEQ_HEAD(seq), MSGPACK_PP_SEQ_TAIL(seq))
#
