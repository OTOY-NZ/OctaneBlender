...
#    define MSGPACK_PP_LIST_SIZE(list) \
      MSGPACK_PP_TUPLE_ELEM( \
          2, 0, MSGPACK_PP_WHILE(MSGPACK_PP_LIST_SIZE_P, MSGPACK_PP_LIST_SIZE_O, (0, list)))
#  else
...
#    define MSGPACK_PP_LIST_SIZE_O(d, rl) \
      (MSGPACK_PP_INC(MSGPACK_PP_TUPLE_ELEM(2, 0, rl)), \
       MSGPACK_PP_LIST_REST(MSGPACK_PP_TUPLE_ELEM(2, 1, rl)))
#  else
...
#    define MSGPACK_PP_LIST_SIZE_D(d, list) \
      MSGPACK_PP_TUPLE_ELEM( \
          2, 0, MSGPACK_PP_WHILE_##d(MSGPACK_PP_LIST_SIZE_P, MSGPACK_PP_LIST_SIZE_O, (0, list)))
#  else
