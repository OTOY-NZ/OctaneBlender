...
#    define MSGPACK_PP_ARRAY_INSERT_D(d, array, i, elem) \
      MSGPACK_PP_TUPLE_ELEM(5, \
                            3, \
                            MSGPACK_PP_WHILE_##d(MSGPACK_PP_ARRAY_INSERT_P, \
...
#    define MSGPACK_PP_ARRAY_INSERT_P(d, state) \
      MSGPACK_PP_ARRAY_INSERT_P_I( \
          nil, nil, nil, MSGPACK_PP_TUPLE_ELEM(5, 3, state), MSGPACK_PP_TUPLE_ELEM(5, 4, state))
#  endif
#
...
#  define MSGPACK_PP_ARRAY_INSERT_O_I(n, i, elem, res, arr) \
    (MSGPACK_PP_IIF(MSGPACK_PP_NOT_EQUAL(MSGPACK_PP_ARRAY_SIZE(res), i), MSGPACK_PP_INC(n), n), \
     ...
     MSGPACK_PP_ARRAY_PUSH_BACK( \
         res, \
         MSGPACK_PP_IIF(MSGPACK_PP_NOT_EQUAL(MSGPACK_PP_ARRAY_SIZE(res), i), \
                        MSGPACK_PP_ARRAY_ELEM(n, arr), \
                        elem)), \
     arr)
#
#endif
