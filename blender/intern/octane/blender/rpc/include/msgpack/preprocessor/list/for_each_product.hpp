...
#    define MSGPACK_PP_LIST_FOR_EACH_PRODUCT(macro, size, tuple) \
      MSGPACK_PP_LIST_FOR_EACH_PRODUCT_E( \
          MSGPACK_PP_FOR, macro, size, MSGPACK_PP_TUPLE_TO_LIST(size, tuple))
#  else
#    define MSGPACK_PP_LIST_FOR_EACH_PRODUCT(macro, size, tuple) \
      MSGPACK_PP_LIST_FOR_EACH_PRODUCT_Q(macro, size, tuple)
...
#    define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_R(r, macro, size, tuple) \
      MSGPACK_PP_LIST_FOR_EACH_PRODUCT_E( \
          MSGPACK_PP_FOR_##r, macro, size, MSGPACK_PP_TUPLE_TO_LIST(size, tuple))
#  else
#    define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_R(r, macro, size, tuple) \
...
#    define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_E(impl, macro, size, lists) \
      impl((MSGPACK_PP_LIST_FIRST(lists), \
            MSGPACK_PP_LIST_REST(lists), \
            MSGPACK_PP_NIL, \
            macro, \
            size), \
...
#  else
#    define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_P(r, data) \
      MSGPACK_PP_LIST_IS_CONS(MSGPACK_PP_TUPLE_ELEM(5, 0, data))
#  endif
#
...
#    define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_O_I(a, b, res, macro, size) \
      (MSGPACK_PP_LIST_REST(a), b, res, macro, size)
#  else
...
#  else
#    define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_I(r, data) \
      MSGPACK_PP_LIST_FOR_EACH_PRODUCT_I_D(r, MSGPACK_PP_TUPLE_REM_5 data)
#    define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_I_D(r, data_e) \
      MSGPACK_PP_LIST_FOR_EACH_PRODUCT_I_I(r, data_e)
#  endif
#
...
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_I_III(r, macro, args, size) \
    macro(r, MSGPACK_PP_TUPLE_REVERSE(size, args))
#
...
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_H_I(a, b, res, macro, size) \
    (MSGPACK_PP_LIST_FIRST(b), \
     MSGPACK_PP_LIST_REST(b), \
     (MSGPACK_PP_LIST_FIRST(a), res), \
     macro, \
     size)
#
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_0(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 0)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_1(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 1)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_2(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 2)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_3(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 3)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_4(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 4)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_5(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 5)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_6(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 6)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_7(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 7)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_8(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 8)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_9(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 9)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_10(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 10)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_11(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 11)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_12(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 12)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_13(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 13)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_14(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 14)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_15(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 15)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_16(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 16)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_17(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 17)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_18(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 18)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_19(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 19)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_20(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 20)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_21(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 21)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_22(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 22)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_23(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 23)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_24(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 24)(r, data)
#  define MSGPACK_PP_LIST_FOR_EACH_PRODUCT_M_25(r, data) \
    MSGPACK_PP_LIST_FOR_EACH_PRODUCT_C(data, 25)(r, data)
#
