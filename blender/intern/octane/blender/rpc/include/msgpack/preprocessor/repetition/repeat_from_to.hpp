...
#  else
#    define MSGPACK_PP_REPEAT_FROM_TO_D_1(d, f, l, m, dt) \
      MSGPACK_PP_REPEAT_FROM_TO_D_1_I(d, f, l, m, dt)
#    define MSGPACK_PP_REPEAT_FROM_TO_D_2(d, f, l, m, dt) \
      MSGPACK_PP_REPEAT_FROM_TO_D_2_I(d, f, l, m, dt)
#    define MSGPACK_PP_REPEAT_FROM_TO_D_3(d, f, l, m, dt) \
      MSGPACK_PP_REPEAT_FROM_TO_D_3_I(d, f, l, m, dt)
...
#    define MSGPACK_PP_REPEAT_FROM_TO_M_1(z, n, dfmd) \
      MSGPACK_PP_REPEAT_FROM_TO_M_1_IM(z, n, MSGPACK_PP_TUPLE_REM_4 dfmd)
#    define MSGPACK_PP_REPEAT_FROM_TO_M_2(z, n, dfmd) \
      MSGPACK_PP_REPEAT_FROM_TO_M_2_IM(z, n, MSGPACK_PP_TUPLE_REM_4 dfmd)
#    define MSGPACK_PP_REPEAT_FROM_TO_M_3(z, n, dfmd) \
      MSGPACK_PP_REPEAT_FROM_TO_M_3_IM(z, n, MSGPACK_PP_TUPLE_REM_4 dfmd)
