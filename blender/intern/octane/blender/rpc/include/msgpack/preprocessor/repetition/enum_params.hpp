...
#    define MSGPACK_PP_ENUM_PARAMS(count, param) \
      MSGPACK_PP_REPEAT(count, MSGPACK_PP_ENUM_PARAMS_M, param)
#  else
...
#
#  if ~MSGPACK_PP_CONFIG_FLAGS() & MSGPACK_PP_CONFIG_EDG()
#    define MSGPACK_PP_ENUM_PARAMS_Z(z, count, param) \
      MSGPACK_PP_REPEAT_##z(count, MSGPACK_PP_ENUM_PARAMS_M, param)
#  else
