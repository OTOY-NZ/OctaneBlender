...
#  define MSGPACK_PP_ARRAY_REPLACE(array, i, elem) \
    MSGPACK_PP_ARRAY_REPLACE_I(MSGPACK_PP_DEDUCE_D(), array, i, elem)
...
#    define MSGPACK_PP_ARRAY_REPLACE_D(d, array, i, elem) \
      MSGPACK_PP_TUPLE_ELEM(5, \
                            3, \
                            MSGPACK_PP_WHILE_##d(MSGPACK_PP_ARRAY_REPLACE_P, \
...
#  define MSGPACK_PP_ARRAY_REPLACE_P(d, state) \
    MSGPACK_PP_NOT_EQUAL(MSGPACK_PP_TUPLE_ELEM(5, 0, state), \
                         MSGPACK_PP_ARRAY_SIZE(MSGPACK_PP_TUPLE_ELEM(5, 4, state)))
#
...
#  define MSGPACK_PP_ARRAY_REPLACE_O_I(n, i, elem, res, arr) \
    (MSGPACK_PP_INC(n), \
     ...
     MSGPACK_PP_ARRAY_PUSH_BACK( \
         res, MSGPACK_PP_IIF(MSGPACK_PP_NOT_EQUAL(n, i), MSGPACK_PP_ARRAY_ELEM(n, arr), elem)), \
     arr)
#
#endif
