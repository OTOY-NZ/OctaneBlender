...
#  define MSGPACK_PP_ARRAY_POP_FRONT(array) \
    MSGPACK_PP_ARRAY_POP_FRONT_Z(MSGPACK_PP_DEDUCE_Z(), array)
#
#  /* MSGPACK_PP_ARRAY_POP_FRONT_Z */
#
#  if ~MSGPACK_PP_CONFIG_FLAGS() & MSGPACK_PP_CONFIG_EDG()
#    define MSGPACK_PP_ARRAY_POP_FRONT_Z(z, array) \
      MSGPACK_PP_ARRAY_POP_FRONT_I(z, MSGPACK_PP_ARRAY_SIZE(array), array)
#  else
...
#  define MSGPACK_PP_ARRAY_POP_FRONT_I(z, size, array) \
    (MSGPACK_PP_DEC(size), \
     (MSGPACK_PP_ENUM_##z(MSGPACK_PP_DEC(size), MSGPACK_PP_ARRAY_POP_FRONT_M, array)))
