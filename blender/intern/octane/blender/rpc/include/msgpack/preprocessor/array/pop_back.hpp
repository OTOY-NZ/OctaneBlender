...
#
#  define MSGPACK_PP_ARRAY_POP_BACK(array) \
    MSGPACK_PP_ARRAY_POP_BACK_Z(MSGPACK_PP_DEDUCE_Z(), array)
#
#  /* MSGPACK_PP_ARRAY_POP_BACK_Z */
#
#  if ~MSGPACK_PP_CONFIG_FLAGS() & MSGPACK_PP_CONFIG_EDG()
#    define MSGPACK_PP_ARRAY_POP_BACK_Z(z, array) \
      MSGPACK_PP_ARRAY_POP_BACK_I(z, MSGPACK_PP_ARRAY_SIZE(array), array)
#  else
#    define MSGPACK_PP_ARRAY_POP_BACK_Z(z, array) MSGPACK_PP_ARRAY_POP_BACK_Z_D(z, array)
#    define MSGPACK_PP_ARRAY_POP_BACK_Z_D(z, array) \
      MSGPACK_PP_ARRAY_POP_BACK_I(z, MSGPACK_PP_ARRAY_SIZE(array), array)
#  endif
#
#  define MSGPACK_PP_ARRAY_POP_BACK_I(z, size, array) \
    (MSGPACK_PP_DEC(size), \
     (MSGPACK_PP_ENUM_##z(MSGPACK_PP_DEC(size), MSGPACK_PP_ARRAY_POP_BACK_M, array)))
