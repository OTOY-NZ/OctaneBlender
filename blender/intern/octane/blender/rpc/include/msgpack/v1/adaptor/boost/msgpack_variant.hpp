...
#  endif  // (BOOST_VERSION / 100000) >= 1 && ((BOOST_VERSION / 100) % 1000) >= 53
            ...
            boost::recursive_wrapper<
                std::map<basic_variant<STR, BIN, EXT>, basic_variant<STR, BIN, EXT>>>,  // MAP
            boost::recursive_wrapper<
                std::multimap<basic_variant<STR, BIN, EXT>, basic_variant<STR, BIN, EXT>>>  // MAP
            >,
...
#  endif  // (BOOST_VERSION / 100000) >= 1 && ((BOOST_VERSION / 100) % 1000) >= 53
    ...
    template<typename T> basic_variant(T const &t) : base(t)
    {
    }
...
#  endif  // (BOOST_VERSION / 100000) >= 1 && ((BOOST_VERSION / 100) % 1000) >= 53
    ...
    bool is_map() const
    {
      return boost::get<std::map<basic_variant<STR, BIN, EXT>, basic_variant<STR, BIN, EXT>>>(
                 this) != MSGPACK_NULLPTR;
    }
    bool is_multimap() const
    {
      return boost::get<std::multimap<basic_variant<STR, BIN, EXT>, basic_variant<STR, BIN, EXT>>>(
                 this) != MSGPACK_NULLPTR;
    }
...
#  endif  // (BOOST_VERSION / 100000) >= 1 && ((BOOST_VERSION / 100) % 1000) >= 53
    ...
    std::multimap<basic_variant<STR, BIN, EXT>, basic_variant<STR, BIN, EXT>> const &as_multimap()
        const
    {
      return boost::get<std::multimap<basic_variant<STR, BIN, EXT>, basic_variant<STR, BIN, EXT>>>(
          *this);
  ...
  template<typename STR, typename BIN, typename EXT>
  inline bool operator<(basic_variant<STR, BIN, EXT> const &lhs,
  ...
  struct as<type::basic_variant<STR, BIN, EXT>> {
    type::basic_variant<STR, BIN, EXT> operator()(msgpack::object const &o) const
    {
      switch (o.type) {
        ...
        case type::MAP:
          return o.as<std::multimap<type::basic_variant<STR, BIN, EXT>,
                                    type::basic_variant<STR, BIN, EXT>>>();
        default:
          break;
      }
                                      ...
                                      type::basic_variant<STR, BIN, EXT> &v) const
    {
      switch (o.type) {
        ...
        case type::ARRAY:
          ...
          break;
        case type::MAP:
          v = o.as<std::multimap<type::basic_variant<STR, BIN, EXT>,
                                 type::basic_variant<STR, BIN, EXT>>>();
          break;
        default:
          break;
