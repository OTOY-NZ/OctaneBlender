...
MSGPACK_API_VERSION_NAMESPACE(v1)
{
  ...
  template<> struct object_char_sign<true> {
    template<typename T>
    static typename msgpack::enable_if<msgpack::is_same<T, char>::value>::type make(
        msgpack::object &o, T v)
    {
      if (v < 0) {
  ...
  template<> struct object_char_sign<false> {
