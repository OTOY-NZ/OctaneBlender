...
MSGPACK_API_VERSION_NAMESPACE(v1)
{
  ...
  class object_handle {
   public:
    ...
    object_handle(object_handle &other) : m_obj(other.m_obj), m_zone(msgpack::move(other.m_zone))
    {
    }
  ...
  template<std::size_t N> inline std::size_t add_ext_type_size(std::size_t size)
  {
    return size + 1;
  }
  ...
  inline std::size_t aligned_zone_size(msgpack::object const &obj)
  {
    ...
    switch (obj.type) {
      case msgpack::type::ARRAY:
        s += msgpack::aligned_size(sizeof(msgpack::object) * obj.via.array.size,
      ...
      case msgpack::type::MAP:
        s += msgpack::aligned_size(sizeof(msgpack::object_kv) * obj.via.map.size,
  ...
  template<typename T> inline object::implicit_type::operator T()
  {
    return obj.as<T>();
  }
  ...
  inline msgpack::object const &adaptor::convert<T, Enabler>::operator()(msgpack::object const &o,
                                                                         T &v) const
  {
  ...
  inline msgpack::packer<Stream> &adaptor::pack<T, Enabler>::operator()(msgpack::packer<Stream> &o,
                                                                        T const &v) const
  {
  ...
  template<typename T, typename Enabler>
  inline void adaptor::object_with_zone<T, Enabler>::operator()(msgpack::object::with_zone &o,
                                                                T const &v) const
  {
    ...
    msgpack::packer<Stream> &operator()(msgpack::packer<Stream> &o, msgpack::object const &v) const
    {
      switch (v.type) {
        ...
        case msgpack::type::MAP:
          ...
          for (msgpack::object_kv *p(v.via.map.ptr), *const pend(v.via.map.ptr + v.via.map.size);
               p < pend;
               ++p) {
      ...
      switch (v.type) {
        ...
        case msgpack::type::STR: {
          char *ptr = static_cast<char *>(
              o.zone.allocate_align(v.via.str.size, MSGPACK_ZONE_ALIGNOF(char)));
          o.via.str.ptr = ptr;
        ...
        case msgpack::type::BIN: {
          char *ptr = static_cast<char *>(
              o.zone.allocate_align(v.via.bin.size, MSGPACK_ZONE_ALIGNOF(char)));
          o.via.bin.ptr = ptr;
        ...
        case msgpack::type::EXT: {
          char *ptr = static_cast<char *>(
              o.zone.allocate_align(v.via.ext.size + 1, MSGPACK_ZONE_ALIGNOF(char)));
          o.via.ext.ptr = ptr;
        ...
        case msgpack::type::ARRAY:
          o.via.array.ptr = static_cast<msgpack::object *>(o.zone.allocate_align(
              sizeof(msgpack::object) * v.via.array.size, MSGPACK_ZONE_ALIGNOF(msgpack::object)));
          o.via.array.size = v.via.array.size;
          for (msgpack::object *po(o.via.array.ptr),
               *pv(v.via.array.ptr),
        ...
        case msgpack::type::MAP:
          ...
          for (msgpack::object_kv *po(o.via.map.ptr),
               *pv(v.via.map.ptr),
  ...
  template<typename T> inline bool operator==(const T &y, const msgpack::object &x)
  {
    return x == y;
  }
  ...
  inline
      typename msgpack::enable_if<!msgpack::is_array<T>::value && !msgpack::is_pointer<T>::value,
                                  T &>::type object::convert(T & v) const
  {
    msgpack::operator>>(*this, v);
    return v;
  }
  ...
  template<typename T>
  inline typename msgpack::enable_if<msgpack::is_pointer<T>::value, T>::type object::convert(T v)
      const
  {
    convert(*v);
    return v;
  ...
  // obsolete
  template<typename T> inline void convert(T & v, msgpack::object const &o)
  {
    o.convert(v);
  }

  // obsolete
  template<typename Stream, typename T> inline void pack(msgpack::packer<Stream> & o, const T &v)
  {
    o.pack(v);
  }

  // obsolete
  template<typename Stream, typename T> inline void pack_copy(msgpack::packer<Stream> & o, T v)
  {
    pack(o, v);
  }
  ...
  inline msgpack::packer<Stream> &operator<<(msgpack::packer<Stream> &o, const msgpack::object &v)
  {
    switch (v.type) {
      ...
      case msgpack::type::ARRAY:
        o.pack_array(v.via.array.size);
        for (msgpack::object *p(v.via.array.ptr), *const pend(v.via.array.ptr + v.via.array.size);
             p < pend;
             ++p) {
          msgpack::operator<<(o, *p);
        }
    ...
    switch (o.type) {
      ...
      case msgpack::type::ARRAY:
        ...
        if (o.via.array.size != 0) {
          ...
          s << *p;
          ++p;
          for (msgpack::object *const pend(o.via.array.ptr + o.via.array.size); p < pend; ++p) {
            s << ", " << *p;
          }
        }
        s << "]";
      ...
      case msgpack::type::MAP:
        ...
        if (o.via.map.size != 0) {
          ...
          s << p->key << ':' << p->val;
          ++p;
          for (msgpack::object_kv *const pend(o.via.map.ptr + o.via.map.size); p < pend; ++p) {
            s << ", " << p->key << ':' << p->val;
          }
        }
        s << "}";
