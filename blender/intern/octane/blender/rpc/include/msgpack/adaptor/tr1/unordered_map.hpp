...
MSGPACK_API_VERSION_NAMESPACE(v1)
{
  ...
  struct convert<MSGPACK_STD_TR1::unordered_map<K, V, Hash, Pred, Alloc>> {
    msgpack::object const &operator()(
        msgpack::object const &o, MSGPACK_STD_TR1::unordered_map<K, V, Hash, Pred, Alloc> &v) const
    {
  ...
  struct pack<MSGPACK_STD_TR1::unordered_map<K, V, Hash, Pred, Alloc>> {
        ...
        const MSGPACK_STD_TR1::unordered_map<K, V, Hash, Pred, Alloc> &v) const
    {
      ...
      o.pack_map(size);
      for (typename MSGPACK_STD_TR1::unordered_map<K, V, Hash, Pred, Alloc>::const_iterator
               it(v.begin()),
           it_end(v.end());
           it != it_end;
           ++it) {
  ...
  struct pack<MSGPACK_STD_TR1::unordered_multimap<K, V, Hash, Pred, Alloc>> {
        ...
        const MSGPACK_STD_TR1::unordered_multimap<K, V, Hash, Pred, Alloc> &v) const
    {
      uint32_t size = checked_get_container_size(v.size());
      o.pack_map(size);
      for (typename MSGPACK_STD_TR1::unordered_multimap<K, V, Hash, Pred, Alloc>::const_iterator
               it(v.begin()),
           it_end(v.end());
           it != it_end;
           ++it) {
