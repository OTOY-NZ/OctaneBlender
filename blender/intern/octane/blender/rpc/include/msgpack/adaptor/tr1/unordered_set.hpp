...
MSGPACK_API_VERSION_NAMESPACE(v1)
{
  ...
  struct convert<MSGPACK_STD_TR1::unordered_set<T, Hash, Compare, Alloc>> {
    msgpack::object const &operator()(
        msgpack::object const &o, MSGPACK_STD_TR1::unordered_set<T, Hash, Compare, Alloc> &v) const
    {
  ...
  struct pack<MSGPACK_STD_TR1::unordered_set<T, Hash, Compare, Alloc>> {
        ...
        const MSGPACK_STD_TR1::unordered_set<T, Hash, Compare, Alloc> &v) const
    {
      ...
      o.pack_array(size);
      for (typename MSGPACK_STD_TR1::unordered_set<T, Hash, Compare, Alloc>::const_iterator
               it(v.begin()),
           it_end(v.end());
           it != it_end;
           ++it) {
  ...
  struct pack<MSGPACK_STD_TR1::unordered_multiset<T, Hash, Compare, Alloc>> {
        ...
        const MSGPACK_STD_TR1::unordered_multiset<T, Hash, Compare, Alloc> &v) const
    {
      uint32_t size = checked_get_container_size(v.size());
      o.pack_array(size);
      for (typename MSGPACK_STD_TR1::unordered_multiset<T, Hash, Compare, Alloc>::const_iterator
               it(v.begin()),
           it_end(v.end());
           it != it_end;
           ++it) {
