...
#  define MSGPACK_PREDEF_MAKE_0X_VRRPPPP(V) \
    MSGPACK_VERSION_NUMBER((V & 0xF000000) >> 24, (V & 0xFF0000) >> 16, (V & 0xFFFF))
...
#  define MSGPACK_PREDEF_MAKE_0X_VRRPP000(V) \
    MSGPACK_VERSION_NUMBER((V & 0xF0000000) >> 28, (V & 0xFF00000) >> 20, (V & 0xFF000) >> 12)
...
#  define MSGPACK_PREDEF_MAKE_10_VRP000(V) \
    MSGPACK_VERSION_NUMBER(((V) / 100000) % 10, ((V) / 10000) % 10, ((V) / 1000) % 10)
...
#  define MSGPACK_PREDEF_MAKE_10_VVRR0PP00(V) \
    MSGPACK_VERSION_NUMBER(((V) / 10000000) % 100, ((V) / 100000) % 100, ((V) / 100) % 100)
/*` `MSGPACK_PREDEF_MAKE_10_VVRR0PPPP(V)` */
#  define MSGPACK_PREDEF_MAKE_10_VVRR0PPPP(V) \
    MSGPACK_VERSION_NUMBER(((V) / 10000000) % 100, ((V) / 100000) % 100, (V) % 10000)
/*` `MSGPACK_PREDEF_MAKE_10_VVRR00PP00(V)` */
#  define MSGPACK_PREDEF_MAKE_10_VVRR00PP00(V) \
    MSGPACK_VERSION_NUMBER(((V) / 100000000) % 100, ((V) / 1000000) % 100, ((V) / 100) % 100)
/*`
