 ...
 */
#  if !MSGPACK_ENDIAN_BIG_BYTE && !MSGPACK_ENDIAN_BIG_WORD && !MSGPACK_ENDIAN_LITTLE_BYTE && \
...
#    if MSGPACK_ARCH_M68K || MSGPACK_ARCH_PARISC || MSGPACK_ARCH_SPARC || MSGPACK_ARCH_SYS370 || \
        MSGPACK_ARCH_SYS390 || MSGPACK_ARCH_Z
#      undef MSGPACK_ENDIAN_BIG_BYTE
#      define MSGPACK_ENDIAN_BIG_BYTE MSGPACK_VERSION_NUMBER_AVAILABLE
#    endif
#    if MSGPACK_ARCH_AMD64 || MSGPACK_ARCH_IA64 || MSGPACK_ARCH_X86 || MSGPACK_ARCH_BLACKFIN
#      undef MSGPACK_ENDIAN_LITTLE_BYTE
#      define MSGPACK_ENDIAN_LITTLE_BYTE MSGPACK_VERSION_NUMBER_AVAILABLE
#    endif
#  endif
