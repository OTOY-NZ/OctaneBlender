...
#define GET_LDB_MAT_NEW 2
#define GET_LDB_MAT_END 3
...
#define MAT_LIVEDB_ELEM_OPEN(telm, sv) \
  ((*telm->flag & TE_CLOSED) == 0 || (SEARCHING_MAT_LIVEDB(sv) && (*telm->flag & TE_CHILDSEARCH)))
...
/* ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 */
int get_material(struct Main *bmain,
                 struct bContext *C,
                 Scene *scene,
                 struct bNodeTree *ntree,
                 const char *address,
                 int32_t mat_id);
int get_livedb_material(struct bContext *C, void *arg1, void *arg2);
