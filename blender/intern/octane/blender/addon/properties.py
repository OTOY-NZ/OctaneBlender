...
def update_octane_localdb_path():
    ...
    octane_localdb_path = ""
    try:
        octane_localdb_path = format_octane_path(
            str(bpy.context.preferences.addons[__package__].preferences.octane_localdb_path))
    except Exception as e:
        logger.exception(e)
...
def update_octane_texture_cache_path():
    ...
    try:
        octane_texture_cache_path = format_octane_path(
            str(bpy.context.preferences.addons[__package__].preferences.octane_texture_cache_path))
    except Exception as e:
        logger.exception(e)
...
def update_octane_server_address():
    ...
    try:
        ...
        enable_release_octane_license_when_exiting = bool(
            bpy.context.preferences.addons[__package__].preferences.enable_relese_octane_license_when_exiting)
    except Exception as e:
        logger.exception(e)
