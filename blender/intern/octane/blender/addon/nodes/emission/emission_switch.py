...
class OctaneEmissionSwitchIndex(OctaneBaseSocket):
    bl_idname="OctaneEmissionSwitchIndex"
    bl_label="Input"
...
class OctaneEmissionSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname="OctaneEmissionSwitch"
    bl_label="Emission switch"
    ...
    octane_socket_class_list=[OctaneEmissionSwitchIndex,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_SWITCH_EMISSION
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctaneEmissionSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctaneEmissionSwitchIndex", OctaneEmissionSwitchIndex.bl_label).init()
...
_CLASSES=[
    OctaneEmissionSwitchIndex,
    OctaneEmissionSwitch,
]
