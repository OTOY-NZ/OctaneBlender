...
class OctaneOCIOLookSwitchIndex(OctaneBaseSocket):
    bl_idname = "OctaneOCIOLookSwitchIndex"
    bl_label = "Input"
...
class OctaneOCIOLookSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname = "OctaneOCIOLookSwitch"
    bl_label = "OCIO look switch"
    ...
    octane_socket_class_list = [OctaneOCIOLookSwitchIndex, ]
    octane_min_version = 13000000
    octane_node_type = consts.NodeType.NT_SWITCH_OCIO_LOOK
    ...
    INPUT_SOCKET_CLASS = base_switch_input_socket.OctaneOCIOLookSwitchInputSocket
    ...
    def init(self, context):  # noqa
        self.inputs.new("OctaneOCIOLookSwitchIndex", OctaneOCIOLookSwitchIndex.bl_label).init()
...
_CLASSES = [
    OctaneOCIOLookSwitchIndex,
    OctaneOCIOLookSwitch,
]
