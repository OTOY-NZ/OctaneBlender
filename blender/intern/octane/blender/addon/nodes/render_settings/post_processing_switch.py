...
class OctanePostProcessingSwitchIndex(OctaneBaseSocket):
    bl_idname="OctanePostProcessingSwitchIndex"
    bl_label="Input"
...
class OctanePostProcessingSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname="OctanePostProcessingSwitch"
    bl_label="Post processing switch"
    ...
    octane_socket_class_list=[OctanePostProcessingSwitchIndex,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_SWITCH_POSTPROCESSING
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctanePostProcessingSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctanePostProcessingSwitchIndex", OctanePostProcessingSwitchIndex.bl_label).init()
...
_CLASSES=[
    OctanePostProcessingSwitchIndex,
    OctanePostProcessingSwitch,
]
