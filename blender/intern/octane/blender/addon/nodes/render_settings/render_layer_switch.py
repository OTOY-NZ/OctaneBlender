...
class OctaneRenderLayerSwitchIndex(OctaneBaseSocket):
    bl_idname = "OctaneRenderLayerSwitchIndex"
    bl_label = "Input"
...
class OctaneRenderLayerSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname = "OctaneRenderLayerSwitch"
    bl_label = "Render layer switch"
    ...
    octane_socket_class_list = [OctaneRenderLayerSwitchIndex, ]
    octane_min_version = 13000000
    octane_node_type = consts.NodeType.NT_SWITCH_RENDER_LAYER
    ...
    INPUT_SOCKET_CLASS = base_switch_input_socket.OctaneRenderLayerSwitchInputSocket
    ...
    def init(self, context):  # noqa
        self.inputs.new("OctaneRenderLayerSwitchIndex", OctaneRenderLayerSwitchIndex.bl_label).init()
...
_CLASSES = [
    OctaneRenderLayerSwitchIndex,
    OctaneRenderLayerSwitch,
]
