...
class OctaneRenderPassesOpacity(OctaneBaseSocket):
    ...
    default_value: FloatProperty(default=1.000000, update=OctaneBaseSocket.update_node_tree, description="Geometry with opacity higher or equal to this value is treated as totally opaque", min=0.000000, max=1.000000, soft_min=0.000000, soft_max=1.000000, step=1.000000, precision=2, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 3000000
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneRenderPassesZDepthMax(OctaneBaseSocket):
    ...
    octane_pin_index = 86
    octane_socket_type = consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=5.000000, update=OctaneBaseSocket.update_node_tree, description="The maximum Z-depth value. Background pixels will get this value and and any foreground depths will be clamped at this value. This applies with or without tone mapping, but tone mapping will map the maximum Z-depth to white (0 is mapped to black)", min=0.001000, max=100000.000000, soft_min=0.001000, soft_max=100000.000000, step=1.000000, precision=3, subtype="NONE")
    octane_hide_value = False
    octane_min_version = 2100000
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneRenderPassesAodist(OctaneBaseSocket):
    ...
    octane_socket_type = consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=3.000000, update=OctaneBaseSocket.update_node_tree, description="Ambient occlusion distance", min=0.010000, max=1024.000000, soft_min=0.010000, soft_max=1024.000000, step=1.000000, precision=2, subtype="NONE")
    octane_hide_value = False
    octane_min_version = 2100000
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneRenderPassesRenderPassInfoStartSamples(OctaneBaseSocket):
    ...
    octane_socket_type = consts.SocketType.ST_INT
    default_value: IntProperty(default=0, update=OctaneBaseSocket.update_node_tree, description="(deprecated)", min=0, max=256000, soft_min=0, soft_max=256000, step=1, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 2100000
...
class OctaneRenderPassesRenderPassEnvironmentMaxSamples(OctaneBaseSocket):
    ...
    octane_socket_type = consts.SocketType.ST_INT
    default_value: IntProperty(default=256, update=OctaneBaseSocket.update_node_tree, description="(deprecated)", min=1, max=256000, soft_min=1, soft_max=256000, step=1, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 2200000
...
class OctaneRenderPassesFiltersize(OctaneBaseSocket):
    ...
    octane_socket_type = consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=1.000000, update=OctaneBaseSocket.update_node_tree, description="(deprecated)", min=1.000000, max=8.000000, soft_min=1.000000, soft_max=8.000000, step=1.000000, precision=2, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 2110000
...
class OctaneRenderPassesRenderPassAOMaxSamples(OctaneBaseSocket):
    ...
    octane_socket_type = consts.SocketType.ST_INT
    default_value: IntProperty(default=1024, update=OctaneBaseSocket.update_node_tree, description="(deprecated)", min=1, max=256000, soft_min=1, soft_max=256000, step=1, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 2100000
    octane_end_version = 3000000
    octane_deprecated = True
...
class OctaneRenderPassesGroupCryptomatteAOVs(OctaneGroupTitleSocket):
    ...
    octane_group_sockets: StringProperty(name="Group Sockets", default="Cryptomatte bins;Crypto instance ID;Crypto material node name;Crypto material node;Crypto material pin name;Crypto object node name;Crypto object node;Crypto object pin name;Cryptomatte seed factor;")
