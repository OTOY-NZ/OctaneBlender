...
class OctaneOCIOViewSwitchIndex(OctaneBaseSocket):
    bl_idname="OctaneOCIOViewSwitchIndex"
    bl_label="Input"
...
class OctaneOCIOViewSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname="OctaneOCIOViewSwitch"
    bl_label="OCIO view switch"
    ...
    octane_socket_class_list=[OctaneOCIOViewSwitchIndex,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_SWITCH_OCIO_VIEW
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctaneOCIOViewSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctaneOCIOViewSwitchIndex", OctaneOCIOViewSwitchIndex.bl_label).init()
...
_CLASSES=[
    OctaneOCIOViewSwitchIndex,
    OctaneOCIOViewSwitch,
]
