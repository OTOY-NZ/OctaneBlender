...
class OctanePostVolumeSwitchIndex(OctaneBaseSocket):
    bl_idname="OctanePostVolumeSwitchIndex"
    bl_label="Input"
...
class OctanePostVolumeSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname="OctanePostVolumeSwitch"
    bl_label="Post volume switch"
    ...
    octane_socket_class_list=[OctanePostVolumeSwitchIndex,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_SWITCH_POST_VOLUME
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctanePostVolumeSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctanePostVolumeSwitchIndex", OctanePostVolumeSwitchIndex.bl_label).init()
...
_CLASSES=[
    OctanePostVolumeSwitchIndex,
    OctanePostVolumeSwitch,
]
