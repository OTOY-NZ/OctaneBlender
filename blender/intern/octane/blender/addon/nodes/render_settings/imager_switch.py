...
class OctaneImagerSwitchIndex(OctaneBaseSocket):
    bl_idname="OctaneImagerSwitchIndex"
    bl_label="Input"
...
class OctaneImagerSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname="OctaneImagerSwitch"
    bl_label="Imager switch"
    ...
    octane_socket_class_list=[OctaneImagerSwitchIndex,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_SWITCH_IMAGER
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctaneImagerSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctaneImagerSwitchIndex", OctaneImagerSwitchIndex.bl_label).init()
