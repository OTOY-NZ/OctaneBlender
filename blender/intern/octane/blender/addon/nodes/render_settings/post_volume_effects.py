...
class OctanePostVolumeEffectsPostFxFogExtinctionDistance(OctaneBaseSocket):
    ...
    octane_pin_index=3
    octane_socket_type=consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=1000.000000, update=OctaneBaseSocket.update_node_tree, description="The distance where the primary ray's transmittance becomes 0 due to fog's density accumulation", min=0.000100, max=10000.000000, soft_min=0.000100, soft_max=10000.000000, step=1, precision=2, subtype="NONE")
    octane_hide_value=False
...
class OctanePostVolumeEffectsPostFxFogBaseLevel(OctaneBaseSocket):
    ...
    octane_pin_index=4
    octane_socket_type=consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=0.000000, update=OctaneBaseSocket.update_node_tree, description="Base height in world space for post fog effects", min=-10000.000000, max=10000.000000, soft_min=-10000.000000, soft_max=10000.000000, step=1, precision=2, subtype="NONE")
    octane_hide_value=False
    octane_min_version=13000007
    octane_end_version=4294967295
    octane_deprecated=False
...
class OctanePostVolumeEffectsPostFxFogHalfDensityHeight(OctaneBaseSocket):
    ...
    octane_pin_index=5
    octane_socket_type=consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=1.000000, update=OctaneBaseSocket.update_node_tree, description="The height from the base level where post fog density halves", min=0.000000, max=10000.000000, soft_min=0.000000, soft_max=10000.000000, step=1, precision=2, subtype="NONE")
    octane_hide_value=False
    octane_min_version=13000007
    octane_end_version=4294967295
    octane_deprecated=False
...
class OctanePostVolumeEffectsPostFxFogEnvContribution(OctaneBaseSocket):
    ...
    octane_pin_index=6
    octane_socket_type=consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=1.000000, update=OctaneBaseSocket.update_node_tree, description="Controls how strong fog color is contributed from environment with a base of user selected color", min=0.000000, max=1.000000, soft_min=0.000000, soft_max=1.000000, step=1, precision=2, subtype=consts.factor_property_subtype())
    octane_hide_value=False
    octane_min_version=13000000
    octane_end_version=4294967295
    octane_deprecated=False
...
class OctanePostVolumeEffectsMediumRadius(OctaneBaseSocket):
    ...
    octane_pin_index=8
    octane_socket_type=consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=100.000000, update=OctaneBaseSocket.update_node_tree, description="Radius of the post volume. The post volume acts as a sphere around the camera position with the specified radius", min=0.000100, max=100000.000000, soft_min=0.000100, soft_max=100000.000000, step=1, precision=2, subtype="NONE")
    octane_hide_value=False
...
class OctanePostVolumeEffectsPostFxFogStrength(OctaneBaseSocket):
    ...
    octane_pin_index=9
    octane_socket_type=consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=0.100000, update=OctaneBaseSocket.update_node_tree, description="(deprecated) Fog strength. Only effective when postfx media option is true", min=0.000100, max=10000.000000, soft_min=0.000100, soft_max=10000.000000, step=1, precision=2, subtype="NONE")
    octane_hide_value=False
    octane_min_version=13000000
...
class OctanePostVolumeEffectsPostFxFogExponent(OctaneBaseSocket):
    ...
    octane_pin_index=10
    octane_socket_type=consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=0.050000, update=OctaneBaseSocket.update_node_tree, description="(deprecated) Fog height descending factor. Only effective when postfx media option is true", min=0.010000, max=10.000000, soft_min=0.010000, soft_max=10.000000, step=1, precision=2, subtype="NONE")
    octane_hide_value=False
    octane_min_version=13000000
    octane_end_version=13000007
    octane_deprecated=True
