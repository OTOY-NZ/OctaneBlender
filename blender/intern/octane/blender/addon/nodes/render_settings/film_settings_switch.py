...
class OctaneFilmSettingsSwitchIndex(OctaneBaseSocket):
    bl_idname="OctaneFilmSettingsSwitchIndex"
    bl_label="Input"
...
class OctaneFilmSettingsSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname="OctaneFilmSettingsSwitch"
    bl_label="Film settings switch"
    ...
    octane_socket_class_list=[OctaneFilmSettingsSwitchIndex,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_SWITCH_FILM_SETTINGS
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctaneFilmSettingsSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctaneFilmSettingsSwitchIndex", OctaneFilmSettingsSwitchIndex.bl_label).init()
...
_CLASSES=[
    OctaneFilmSettingsSwitchIndex,
    OctaneFilmSettingsSwitch,
]
