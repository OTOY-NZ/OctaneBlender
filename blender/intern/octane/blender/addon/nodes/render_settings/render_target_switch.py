...
class OctaneRenderTargetSwitchIndex(OctaneBaseSocket):
    bl_idname = "OctaneRenderTargetSwitchIndex"
    bl_label = "Input"
...
class OctaneRenderTargetSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname = "OctaneRenderTargetSwitch"
    bl_label = "Render target switch"
    ...
    octane_socket_class_list = [OctaneRenderTargetSwitchIndex, ]
    octane_min_version = 13000000
    octane_node_type = consts.NodeType.NT_SWITCH_RENDERTARGET
    ...
    INPUT_SOCKET_CLASS = base_switch_input_socket.OctaneRenderTargetSwitchInputSocket
    ...
    def init(self, context):  # noqa
        self.inputs.new("OctaneRenderTargetSwitchIndex", OctaneRenderTargetSwitchIndex.bl_label).init()
...
_CLASSES = [
    OctaneRenderTargetSwitchIndex,
    OctaneRenderTargetSwitch,
]
