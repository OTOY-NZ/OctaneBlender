...
class OctaneAnimationSettingsSwitchIndex(OctaneBaseSocket):
    bl_idname = "OctaneAnimationSettingsSwitchIndex"
    bl_label = "Input"
...
class OctaneAnimationSettingsSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname = "OctaneAnimationSettingsSwitch"
    bl_label = "Animation settings switch"
    ...
    octane_socket_class_list = [OctaneAnimationSettingsSwitchIndex, ]
    octane_min_version = 13000000
    octane_node_type = consts.NodeType.NT_SWITCH_ANIMATION_SETTINGS
    ...
    INPUT_SOCKET_CLASS = base_switch_input_socket.OctaneAnimationSettingsSwitchInputSocket
    ...
    def init(self, context):  # noqa
        self.inputs.new("OctaneAnimationSettingsSwitchIndex", OctaneAnimationSettingsSwitchIndex.bl_label).init()
...
_CLASSES = [
    OctaneAnimationSettingsSwitchIndex,
    OctaneAnimationSettingsSwitch,
]
