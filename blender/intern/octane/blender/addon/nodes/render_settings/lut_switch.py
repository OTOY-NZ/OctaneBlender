...
class OctaneLUTSwitchIndex(OctaneBaseSocket):
    bl_idname="OctaneLUTSwitchIndex"
    bl_label="Input"
...
class OctaneLUTSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname="OctaneLUTSwitch"
    bl_label="LUT switch"
    ...
    octane_socket_class_list=[OctaneLUTSwitchIndex,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_SWITCH_LUT
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctaneLUTSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctaneLUTSwitchIndex", OctaneLUTSwitchIndex.bl_label).init()
