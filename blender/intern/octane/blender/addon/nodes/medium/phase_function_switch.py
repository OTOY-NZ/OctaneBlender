...
class OctanePhaseFunctionSwitchIndex(OctaneBaseSocket):
    bl_idname = "OctanePhaseFunctionSwitchIndex"
    bl_label = "Input"
...
class OctanePhaseFunctionSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname = "OctanePhaseFunctionSwitch"
    bl_label = "Phase function switch"
    ...
    octane_socket_class_list = [OctanePhaseFunctionSwitchIndex, ]
    octane_min_version = 13000000
    octane_node_type = consts.NodeType.NT_SWITCH_PHASEFUNCTION
    ...
    INPUT_SOCKET_CLASS = base_switch_input_socket.OctanePhaseFunctionSwitchInputSocket
    ...
    def init(self, context):  # noqa
        self.inputs.new("OctanePhaseFunctionSwitchIndex", OctanePhaseFunctionSwitchIndex.bl_label).init()
...
_CLASSES = [
    OctanePhaseFunctionSwitchIndex,
    OctanePhaseFunctionSwitch,
]
