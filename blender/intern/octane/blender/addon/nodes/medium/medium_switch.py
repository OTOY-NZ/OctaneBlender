...
class OctaneMediumSwitchIndex(OctaneBaseSocket):
    bl_idname="OctaneMediumSwitchIndex"
    bl_label="Input"
...
class OctaneMediumSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname="OctaneMediumSwitch"
    bl_label="Medium switch"
    ...
    octane_socket_class_list=[OctaneMediumSwitchIndex,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_SWITCH_MEDIUM
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctaneMediumSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctaneMediumSwitchIndex", OctaneMediumSwitchIndex.bl_label).init()
