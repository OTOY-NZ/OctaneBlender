...
class OctaneStandardVolumeMediumShadowRayMarchStepLength(OctaneBaseSocket):
    ...
    bl_label="Shadow ray step length"
    color=consts.OctanePinColor.Float
    octane_default_node_type=consts.NodeType.NT_FLOAT
    octane_default_node_name="OctaneFloatValue"
...
class OctaneStandardVolumeMediumGroupVolume(OctaneGroupTitleSocket):
    ...
    octane_group_sockets: StringProperty(name="Group Sockets", default="Density;Density channel;Interpolation;Volume step length;Shadow ray step length;Use 'Volume step length' for shadow rays;Single scatter amount;Displacement;")
