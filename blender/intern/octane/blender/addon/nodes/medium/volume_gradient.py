...
class OctaneVolumeGradientMin(OctaneBaseSocket):
    ...
    default_value: FloatVectorProperty(default=(0.000000, 0.000000, 0.000000), update=None, description="Output value at 0", min=0.000000, max=1.000000, soft_min=0.000000, soft_max=1.000000, step=1, subtype="COLOR", size=3)
    octane_hide_value=False
...
class OctaneVolumeGradientMaxGridValue(OctaneBaseSocket):
    ...
    default_value: FloatProperty(default=100.000000, update=None, description="Max grid Value", min=0.001000, max=1000000.000000, soft_min=0.001000, soft_max=1000000.000000, step=1, precision=2, subtype="NONE")
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False
