...
class OctaneVolumeRampSwitchIndex(OctaneBaseSocket):
    bl_idname = "OctaneVolumeRampSwitchIndex"
    bl_label = "Input"
...
class OctaneVolumeRampSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname = "OctaneVolumeRampSwitch"
    bl_label = "Volume ramp switch"
    ...
    octane_socket_class_list = [OctaneVolumeRampSwitchIndex, ]
    octane_min_version = 13000000
    octane_node_type = consts.NodeType.NT_SWITCH_VOLUME_RAMP
    ...
    INPUT_SOCKET_CLASS = base_switch_input_socket.OctaneVolumeRampSwitchInputSocket
    ...
    def init(self, context):  # noqa
        self.inputs.new("OctaneVolumeRampSwitchIndex", OctaneVolumeRampSwitchIndex.bl_label).init()
...
_CLASSES = [
    OctaneVolumeRampSwitchIndex,
    OctaneVolumeRampSwitch,
]
