...
class OctaneRandomWalkRayMarchStepPercent(OctaneBaseSocket):
    bl_idname="OctaneRandomWalkRayMarchStepPercent"
...
class OctaneRandomWalkShadowRayMarchStepPercent(OctaneBaseSocket):
    bl_idname="OctaneRandomWalkShadowRayMarchStepPercent"
...
class OctaneRandomWalkVolumePadding(OctaneBaseSocket):
    bl_idname="OctaneRandomWalkVolumePadding"
...
class OctaneRandomWalk(bpy.types.Node, OctaneBaseNode):
    ...
    octane_socket_class_list=[OctaneRandomWalkScale,OctaneRandomWalkRayMarchStepPercent,OctaneRandomWalkShadowRayMarchStepPercent,OctaneRandomWalkUseRayStepLengthForShadowRays,OctaneRandomWalkSingleScatterFactor,OctaneRandomWalkDisplacement,OctaneRandomWalkVolumePadding,OctaneRandomWalkAlbedo,OctaneRandomWalkRadius,OctaneRandomWalkBias,OctaneRandomWalkLockStepLength,OctaneRandomWalkRayMarchStepLength,OctaneRandomWalkShadowRayMarchStepLength,]
    octane_min_version=0
    octane_node_type=consts.NodeType.NT_MED_RANDOMWALK
    octane_socket_list=["Density", "Volume step %", "Vol. shadow ray step %", "Use Vol. step for Vol. shadow ray step", "Single scatter amount", "Sample position displacement", "Volume padding", "Albedo", "Radius", "Bias", "[Deprecated]Lock step length pins", "[Deprecated]Volume step length", "[Deprecated]Vol. shadow ray step length", ]
    ...
    def init(self, context):
        ...
        self.inputs.new("OctaneRandomWalkRayMarchStepPercent", OctaneRandomWalkRayMarchStepPercent.bl_label).init()
        self.inputs.new("OctaneRandomWalkShadowRayMarchStepPercent", OctaneRandomWalkShadowRayMarchStepPercent.bl_label).init()
        ...
        self.inputs.new("OctaneRandomWalkVolumePadding", OctaneRandomWalkVolumePadding.bl_label).init()
