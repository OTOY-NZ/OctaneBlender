...
class OctaneIntSwitchIndex(OctaneBaseSocket):
    bl_idname="OctaneIntSwitchIndex"
    bl_label="Input"
...
class OctaneIntSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname="OctaneIntSwitch"
    bl_label="Int switch"
    ...
    octane_socket_class_list=[OctaneIntSwitchIndex,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_SWITCH_INT
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctaneIntSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctaneIntSwitchIndex", OctaneIntSwitchIndex.bl_label).init()
