...
class OctaneStringSwitchIndex(OctaneBaseSocket):
    bl_idname = "OctaneStringSwitchIndex"
    bl_label = "Input"
...
class OctaneStringSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname = "OctaneStringSwitch"
    bl_label = "String switch"
    ...
    octane_socket_class_list = [OctaneStringSwitchIndex, ]
    octane_min_version = 13000000
    octane_node_type = consts.NodeType.NT_SWITCH_STRING
    ...
    INPUT_SOCKET_CLASS = base_switch_input_socket.OctaneStringSwitchInputSocket
    ...
    def init(self, context):  # noqa
        self.inputs.new("OctaneStringSwitchIndex", OctaneStringSwitchIndex.bl_label).init()
