...
class OctaneBoolSwitchIndex(OctaneBaseSocket):
    bl_idname = "OctaneBoolSwitchIndex"
    bl_label = "Input"
...
class OctaneBoolSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname = "OctaneBoolSwitch"
    bl_label = "Bool switch"
    ...
    octane_socket_class_list = [OctaneBoolSwitchIndex, ]
    octane_min_version = 13000000
    octane_node_type = consts.NodeType.NT_SWITCH_BOOL
    ...
    INPUT_SOCKET_CLASS = base_switch_input_socket.OctaneBoolSwitchInputSocket
    ...
    def init(self, context):  # noqa
        self.inputs.new("OctaneBoolSwitchIndex", OctaneBoolSwitchIndex.bl_label).init()
