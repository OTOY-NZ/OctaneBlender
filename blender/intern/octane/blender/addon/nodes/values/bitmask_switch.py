...
class OctaneBitMaskSwitchIndex(OctaneBaseSocket):
    bl_idname="OctaneBitMaskSwitchIndex"
    bl_label="Input"
...
class OctaneBitMaskSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname="OctaneBitMaskSwitch"
    bl_label="BitMask switch"
    ...
    octane_socket_class_list=[OctaneBitMaskSwitchIndex,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_SWITCH_BIT_MASK
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctaneBitMaskSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctaneBitMaskSwitchIndex", OctaneBitMaskSwitchIndex.bl_label).init()
