...
class OctaneFloatSwitchIndex(OctaneBaseSocket):
    bl_idname="OctaneFloatSwitchIndex"
    bl_label="Input"
...
class OctaneFloatSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname="OctaneFloatSwitch"
    ...
    octane_socket_class_list=[OctaneFloatSwitchIndex,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_SWITCH_FLOAT
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctaneFloatSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctaneFloatSwitchIndex", OctaneFloatSwitchIndex.bl_label).init()
