...
class OctaneDirectoryName(bpy.types.Node, OctaneBaseNode):
    bl_idname = "OctaneDirectoryName"
    bl_label = "Directory name"
    ...
    octane_node_type = consts.NodeType.NT_DIRECTORY
    octane_socket_list = []
    octane_attribute_list = ["a_value", ]
    octane_attribute_config = {"a_value": [consts.AttributeID.A_VALUE, "value", consts.AttributeType.AT_FILENAME], }
