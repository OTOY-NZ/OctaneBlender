...
class OctaneEnumSwitchIndex(OctaneBaseSocket):
    bl_idname="OctaneEnumSwitchIndex"
    bl_label="Input"
...
class OctaneEnumSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname="OctaneEnumSwitch"
    bl_label="Enum switch"
    ...
    octane_socket_class_list=[OctaneEnumSwitchIndex,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_SWITCH_ENUM
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctaneEnumSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctaneEnumSwitchIndex", OctaneEnumSwitchIndex.bl_label).init()
