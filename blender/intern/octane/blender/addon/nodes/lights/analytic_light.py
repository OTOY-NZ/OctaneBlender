...
class OctaneAnalyticLightAnalyticLightSpreadAngle(OctaneBaseSocket):
    ...
    default_value: FloatProperty(default=60.000000, update=OctaneBaseSocket.update_node_tree, description="Spread angle in degrees for quad and disc lights", min=0.000000, max=180.000000, soft_min=0.000000, soft_max=180.000000, step=10.000000, precision=2, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneAnalyticLightAnalyticLightSpreadCutoffHardness(OctaneBaseSocket):
    ...
    octane_pin_index = 2
    octane_socket_type = consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=0.500000, update=OctaneBaseSocket.update_node_tree, description="Spread cutoff hardness for quad and disc lights", min=0.000000, max=1.000000, soft_min=0.000000, soft_max=1.000000, step=1.000000, precision=2, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneAnalyticLightAnalyticLightFalloffRadius(OctaneBaseSocket):
    ...
    octane_pin_index = 4
    octane_socket_type = consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=100000.000000, update=OctaneBaseSocket.update_node_tree, description="Falloff radius for quad, disc, tube and sphere lights", min=0.000100, max=100000.000000, soft_min=0.000100, soft_max=100000.000000, step=1.000000, precision=4, subtype="NONE")
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneAnalyticLightDiskAnalyticLightSize(OctaneBaseSocket):
    ...
    octane_pin_index = 10
    octane_socket_type = consts.SocketType.ST_FLOAT2
    default_value: FloatVectorProperty(default=(1.000000, 1.000000), update=OctaneBaseSocket.update_node_tree, description="Major and minor lengths of the disc. The disc light is always centered around the origin in the XY plane with the +Z axis as normal", min=0.000000, max=1000000.000000, soft_min=0.000000, soft_max=1000000.000000, step=1.000000, subtype="NONE", precision=2, size=2)
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneAnalyticLightSphereAnalyticLightRadius(OctaneBaseSocket):
    ...
    octane_pin_index = 11
    octane_socket_type = consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=1.000000, update=OctaneBaseSocket.update_node_tree, description="Sphere light's radius", min=0.000000, max=1000000.000000, soft_min=0.000000, soft_max=1000000.000000, step=1.000000, precision=2, subtype="NONE")
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneAnalyticLightTubeAnalyticLightCapRadius(OctaneBaseSocket):
    ...
    octane_pin_index = 12
    octane_socket_type = consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=0.100000, update=OctaneBaseSocket.update_node_tree, description="Tube light's cap radius", min=0.000000, max=1000000.000000, soft_min=0.000000, soft_max=1000000.000000, step=1.000000, precision=2, subtype="NONE")
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneAnalyticLightGroupDisc(OctaneGroupTitleSocket):
    bl_idname = "OctaneAnalyticLightGroupDisc"
    bl_label = "[OctaneGroupTitle]Disc"
    octane_group_sockets: StringProperty(name="Group Sockets", default="Disc size;")
...
class OctaneAnalyticLight(bpy.types.Node, OctaneBaseNode):
    ...
    octane_socket_class_list = [OctaneAnalyticLightAnalyticLightType, OctaneAnalyticLightAnalyticLightSpreadAngle, OctaneAnalyticLightAnalyticLightSpreadCutoffHardness, OctaneAnalyticLightNormalize, OctaneAnalyticLightAnalyticLightFalloffRadius, OctaneAnalyticLightUseInPostVolume, OctaneAnalyticLightEmission, OctaneAnalyticLightTransform, OctaneAnalyticLightObjectLayer, OctaneAnalyticLightGroupQuad, OctaneAnalyticLightQuadAnalyticLightSize, OctaneAnalyticLightGroupDisc, OctaneAnalyticLightDiskAnalyticLightSize, OctaneAnalyticLightGroupSphere, OctaneAnalyticLightSphereAnalyticLightRadius, OctaneAnalyticLightGroupTube, OctaneAnalyticLightTubeAnalyticLightCapRadius, OctaneAnalyticLightTubeAnalyticLightLength, ]
    octane_min_version = 13000000
    octane_node_type = consts.NodeType.NT_LIGHT_ANALYTIC
    octane_socket_list = ["Type", "Spread angle", "Spread cutoff hardness", "Normalize power", "Falloff radius", "Use in post volume", "Emission", "Transform", "Object layer", "Quad size", "Disc size", "Sphere radius", "Tube cap radius", "Tube length", ]
    ...
    def init(self, context):  # noqa
        ...
        self.inputs.new("OctaneAnalyticLightGroupDisc", OctaneAnalyticLightGroupDisc.bl_label).init()
