...
class OctaneAnalyticLightAnalyticLightSpreadAngle(OctaneBaseSocket):
    ...
    default_value: FloatProperty(default=60.000000, update=OctaneBaseSocket.update_node_tree, description="Spread angle in degrees for quad and disk lights", min=0.000000, max=180.000000, soft_min=0.000000, soft_max=180.000000, step=10, precision=2, subtype=consts.factor_property_subtype())
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False
...
class OctaneAnalyticLightAnalyticLightSpreadCutoffHardness(OctaneBaseSocket):
    ...
    octane_pin_index=2
    octane_socket_type=consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=0.500000, update=OctaneBaseSocket.update_node_tree, description="Spread cutoff hardness for quad and disk lights", min=0.000000, max=1.000000, soft_min=0.000000, soft_max=1.000000, step=1, precision=2, subtype=consts.factor_property_subtype())
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False
