...
class OctaneBlendingSettingsSwitchIndex(OctaneBaseSocket):
    bl_idname="OctaneBlendingSettingsSwitchIndex"
    bl_label="Input"
...
class OctaneBlendingSettingsSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname="OctaneBlendingSettingsSwitch"
    bl_label="Blending settings switch"
    ...
    octane_socket_class_list=[OctaneBlendingSettingsSwitchIndex,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_SWITCH_BLENDING_SETTINGS
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctaneBlendingSettingsSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctaneBlendingSettingsSwitchIndex", OctaneBlendingSettingsSwitchIndex.bl_label).init()
...
_CLASSES=[
    OctaneBlendingSettingsSwitchIndex,
    OctaneBlendingSettingsSwitch,
]
