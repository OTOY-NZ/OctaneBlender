...
class OctaneOutputAOVsAddGlareGlarePower(OctaneBaseSocket):
    ...
    default_value: FloatProperty(default=10.000000, update=OctaneBaseSocket.update_node_tree, description="The amount of glare to apply. 0% means no glare. 100% means the maximum glare possible given the spread start and spread end values", min=0.000000, max=100.000000, soft_min=0.000000, soft_max=100.000000, step=1, precision=2, subtype="PERCENTAGE")
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False
...
class OctaneOutputAOVsAddGlareGlareRayAmount(OctaneBaseSocket):
    ...
    default_value: IntProperty(default=1, update=OctaneBaseSocket.update_node_tree, description="The number of glare rays to add. The angles of the rays are evenly spaced around a half circle", min=1, max=8, soft_min=1, soft_max=8, step=1, subtype=consts.factor_property_subtype())
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False
...
class OctaneOutputAOVsAddGlareGlareAngle(OctaneBaseSocket):
    ...
    octane_pin_index=3
    octane_socket_type=consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=0.000000, update=OctaneBaseSocket.update_node_tree, description="The angle of the first glare ray in degrees clockwise from horizontal", min=-90.000000, max=90.000000, soft_min=-90.000000, soft_max=90.000000, step=1, precision=2, subtype=consts.factor_property_subtype())
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False
...
class OctaneOutputAOVsAddGlareGlareBlur(OctaneBaseSocket):
    ...
    octane_pin_index=4
    octane_socket_type=consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=0.100000, update=OctaneBaseSocket.update_node_tree, description="The width of the range of angles covered by each glare ray, in degrees", min=0.100000, max=90.000000, soft_min=0.100000, soft_max=10.000000, step=1, precision=2, subtype=consts.factor_property_subtype())
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False
...
class OctaneOutputAOVsAddGlareSpreadEnd(OctaneBaseSocket):
    ...
    octane_pin_index=6
    octane_socket_type=consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=100.000000, update=OctaneBaseSocket.update_node_tree, description="The maximum blur radius, as a proportion of image width or height (whichever is larger)", min=0.100000, max=200.000000, soft_min=0.100000, soft_max=100.000000, step=1, precision=3, subtype="PERCENTAGE")
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False
