...
class OctaneOutputAOVsApplyLUTSDROnly(bpy.types.Node, OctaneBaseNode):
    ...
    def init(self, context):
        self.inputs.new("OctaneOutputAOVsApplyLUTSDROnlyEnabled", OctaneOutputAOVsApplyLUTSDROnlyEnabled.bl_label).init()
        self.inputs.new("OctaneOutputAOVsApplyLUTSDROnlyStrength", OctaneOutputAOVsApplyLUTSDROnlyStrength.bl_label).init()
        self.inputs.new("OctaneOutputAOVsApplyLUTSDROnlyInputColorSpace", OctaneOutputAOVsApplyLUTSDROnlyInputColorSpace.bl_label).init()
        self.inputs.new("OctaneOutputAOVsApplyLUTSDROnlyOutputColorSpace", OctaneOutputAOVsApplyLUTSDROnlyOutputColorSpace.bl_label).init()
...
_CLASSES=[
    OctaneOutputAOVsApplyLUTSDROnlyEnabled,
    OctaneOutputAOVsApplyLUTSDROnlyStrength,
    OctaneOutputAOVsApplyLUTSDROnlyInputColorSpace,
    OctaneOutputAOVsApplyLUTSDROnlyOutputColorSpace,
    OctaneOutputAOVsApplyLUTSDROnly,
]
