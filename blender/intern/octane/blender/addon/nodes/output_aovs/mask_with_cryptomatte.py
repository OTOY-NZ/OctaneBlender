...
class OctaneOutputAOVsMaskWithCryptomatte(bpy.types.Node, OctaneBaseNode):
    ...
    octane_socket_class_list=[OctaneOutputAOVsMaskWithCryptomatteEnabled,OctaneOutputAOVsMaskWithCryptomatteCryptomatteType,OctaneOutputAOVsMaskWithCryptomatteCryptomatteMattes,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_OUTPUT_AOV_LAYER_MASK_WITH_CRYPTOMATTE
    octane_socket_list=["Enabled", "Type", "Mattes", ]
