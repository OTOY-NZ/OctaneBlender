...
class OctaneOutputAOVSwitchIndex(OctaneBaseSocket):
    bl_idname = "OctaneOutputAOVSwitchIndex"
    bl_label = "Input"
...
class OctaneOutputAOVSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname = "OctaneOutputAOVSwitch"
    bl_label = "Output AOV switch"
    ...
    octane_socket_class_list = [OctaneOutputAOVSwitchIndex, ]
    octane_min_version = 13000000
    octane_node_type = consts.NodeType.NT_SWITCH_OUTPUT_AOV
    ...
    INPUT_SOCKET_CLASS = base_switch_input_socket.OctaneOutputAOVSwitchInputSocket
    ...
    def init(self, context):  # noqa
        self.inputs.new("OctaneOutputAOVSwitchIndex", OctaneOutputAOVSwitchIndex.bl_label).init()
...
_CLASSES = [
    OctaneOutputAOVSwitchIndex,
    OctaneOutputAOVSwitch,
]
