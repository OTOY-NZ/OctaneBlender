...
class OctaneOutputAOVsAdjustOpacityOpacity(OctaneBaseSocket):
    ...
    default_value: FloatProperty(default=100.000000, update=OctaneBaseSocket.update_node_tree, description="Factor by which to multiply all alpha values", min=0.000000, max=340282346638528859811704183484516925440.000000, soft_min=0.000000, soft_max=100.000000, step=1, precision=2, subtype="PERCENTAGE")
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False
...
class OctaneOutputAOVsAdjustOpacity(bpy.types.Node, OctaneBaseNode):
    ...
    octane_socket_class_list=[OctaneOutputAOVsAdjustOpacityEnabled,OctaneOutputAOVsAdjustOpacityOpacity,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_OUTPUT_AOV_LAYER_ADJUST_OPACITY
    octane_socket_list=["Enabled", "Opacity", ]
