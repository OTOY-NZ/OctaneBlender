...
class OctaneOutputAOVLayerSwitchIndex(OctaneBaseSocket):
    bl_idname = "OctaneOutputAOVLayerSwitchIndex"
    bl_label = "Input"
...
class OctaneOutputAOVLayerSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname = "OctaneOutputAOVLayerSwitch"
    bl_label = "Output AOV layer switch"
    ...
    octane_socket_class_list = [OctaneOutputAOVLayerSwitchIndex, ]
    octane_min_version = 13000000
    octane_node_type = consts.NodeType.NT_SWITCH_OUTPUT_AOV_LAYER
    ...
    INPUT_SOCKET_CLASS = base_switch_input_socket.OctaneOutputAOVLayerSwitchInputSocket
    ...
    def init(self, context):  # noqa
        self.inputs.new("OctaneOutputAOVLayerSwitchIndex", OctaneOutputAOVLayerSwitchIndex.bl_label).init()
...
_CLASSES = [
    OctaneOutputAOVLayerSwitchIndex,
    OctaneOutputAOVLayerSwitch,
]
