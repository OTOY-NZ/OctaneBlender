...
class OctaneDiffuseLayerRoughness(OctaneBaseSocket):
    ...
    default_value: FloatProperty(default=0.000000, update=OctaneBaseSocket.update_node_tree, description="Roughness of the diffuse layer", min=0.000000, max=1.000000, soft_min=0.000000, soft_max=1.000000, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneDiffuseLayer(bpy.types.Node, OctaneBaseNode):
    ...
    compatibility_mode_infos = [
        ...
        ("2022.1 compatibility mode", "2022.1 compatibility mode", """The "Octane" and "Lambertian" BRDF models are swapped. Legacy behaviour for bump map strength is active and bump map height is ignored. This applies in addition to 2023.1 compatibility mode behavior.""", 0),
    ]
