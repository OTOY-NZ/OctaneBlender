...
class OctaneDiffuseLayer(bpy.types.Node, OctaneBaseNode):
    ...
    compatibility_mode_infos=[
        ...
        ("2022.1 compatibility mode", "2022.1 compatibility mode", """The "Octane" and "Lambertian" BRDF models are swapped. Legacy behaviour for bump map strength is active and bump map height is ignored. This applies in addition to 2023.1 compatibility behavior.""", 0),
    ]
