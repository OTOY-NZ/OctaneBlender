...
class OctaneMaterialSwitchIndex(OctaneBaseSocket):
    bl_idname = "OctaneMaterialSwitchIndex"
    bl_label = "Input"
...
class OctaneMaterialSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname = "OctaneMaterialSwitch"
    ...
    octane_socket_class_list = [OctaneMaterialSwitchIndex, ]
    octane_min_version = 13000000
    octane_node_type = consts.NodeType.NT_SWITCH_MATERIAL
    ...
    INPUT_SOCKET_CLASS = base_switch_input_socket.OctaneMaterialSwitchInputSocket
    ...
    def init(self, context):  # noqa
        self.inputs.new("OctaneMaterialSwitchIndex", OctaneMaterialSwitchIndex.bl_label).init()
...
_CLASSES = [
    OctaneMaterialSwitchIndex,
    OctaneMaterialSwitch,
]
