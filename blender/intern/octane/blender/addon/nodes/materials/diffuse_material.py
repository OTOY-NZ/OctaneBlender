...
class OctaneDiffuseMaterialRoughness(OctaneBaseSocket):
    ...
    default_value: FloatProperty(default=0.000000, update=None, description="Diffuse roughness to allow simulation of very rough surfaces like sand or clay", min=0.000000, max=1.000000, soft_min=0.000000, soft_max=1.000000, subtype="FACTOR")
    octane_hide_value=False
