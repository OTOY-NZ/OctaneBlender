...
def camera_imager_poll(context):
        return context.scene.render.engine == consts.ENGINE_NAME and \
            (not hasattr(context.space_data, "tree_type") or context.space_data.tree_type == consts.OctaneNodeTreeIDName.CAMERA_IMAGER)

def kernel_poll(context):
        return context.scene.render.engine == consts.ENGINE_NAME and \
            (not hasattr(context.space_data, "tree_type") or context.space_data.tree_type == consts.OctaneNodeTreeIDName.KERNEL)            
...
def texture_poll(context):
        return context.scene.render.engine == consts.ENGINE_NAME and \
            (not hasattr(context.space_data, "tree_type") or context.space_data.tree_type == consts.OctaneNodeTreeIDName.BLENDER_TEXTURE)
...
class OctaneTextureNodeCategory(OctaneNodeCategory):
    NODE_TREE_ID_LIST = [consts.OctaneNodeTreeIDName.BLENDER_SHADER, consts.OctaneNodeTreeIDName.BLENDER_TEXTURE, consts.OctaneNodeTreeIDName.RENDER_AOV, consts.OctaneNodeTreeIDName.COMPOSITE, consts.OctaneNodeTreeIDName.CAMERA_IMAGER, consts.OctaneNodeTreeIDName.KERNEL, ]
...
def register_octane_node_categories(identifier, cat_list):
    ...
    def register_submenu(menu_types, sub_cat_list, cat, octane_pin_type):
        if isinstance(cat, OctaneNodeItem):
            ...
            return
        if isinstance(cat, OctaneNodeItemSeperator):
            return
...
_octane_node_items = {
    ...
    "OCTANE_RENDER_SETTINGS": [
        OctaneGeneralNodeCategory("OCTANE_RENDER_SETTINGS", "Octane Render Settings", 
            octane_pin_type=consts.PinType.PT_BLENDER_VALUES,
            items=[
                # OctaneNodeItem("OctaneImager", octane_pin_type=consts.PinType.PT_IMAGER),
                OctaneNodeItem("OctaneOCIOColorSpace", octane_pin_type=consts.PinType.PT_OCIO_COLOR_SPACE),
            ]
        ),
    ],
    "OCTANE_VALUE": [
        OctaneGeneralNodeCategory("OCTANE_VALUE", "Octane Values", 
            octane_pin_type=consts.PinType.PT_BLENDER_VALUES,
            items=[
                # OctaneNodeItem("OctaneBitValue", octane_pin_type=consts.PinType.PT_INT),
                ...
                OctaneNodeItem("OctaneConverterFloatToInt", octane_pin_type=consts.PinType.PT_INT),
                OctaneNodeItem("OctaneConverterIntToFloat", octane_pin_type=consts.PinType.PT_FLOAT),
                OctaneNodeItemSeperator("Operators"),
                OctaneNodeItem("OctaneOperatorBinaryMathOperation", octane_pin_type=consts.PinType.PT_FLOAT),
                OctaneNodeItem("OctaneOperatorBooleanLogicOperator", octane_pin_type=consts.PinType.PT_BOOL),
                OctaneNodeItem("OctaneOperatorFloatRelationalOperator", octane_pin_type=consts.PinType.PT_FLOAT),
                ...
                OctaneNodeItem("OctaneBitMaskSwitch", octane_pin_type=consts.PinType.PT_INT),
                ...
                OctaneNodeItem("OctaneUtilityIntComponentPicker", octane_pin_type=consts.PinType.PT_INT),
    ...
    "OCTANE_DISPLACEMENT": [
        OctaneShaderNodeCategory("OCTANE_DISPLACEMENT", "Octane Displacement", 
    ...
    "OCTANE_KERNEL": [
        OctaneKernelNodeCategory("OCTANE_KERNEL", "Octane Kernel", 
    ...
    "OCTANE_COMPOSITE": [
        OctaneCompositeNodeCategory("OCTANE_COMPOSITE", "Octane Compositor", 
            items=[
                ...
                OctaneCompositeNodeCategory("OCTANE_COMPOSITE_CHECKPOINTS", "Checkpoints",
                    octane_pin_type=consts.PinType.PT_OUTPUT_AOV_LAYER,
                    items=[
                ...
                OctaneCompositeNodeCategory("OCTANE_COMPOSITE_LEGACY", "Legacy",
                    octane_pin_type=consts.PinType.PT_OUTPUT_AOV_LAYER,
                    items=[
                        OctaneNodeItem("OctaneLegacyOutputAOV", octane_pin_type=consts.PinType.PT_OUTPUT_AOV),
                    ]
                ),
    ...
    "OCTANE_TEXTURE": [
        OctaneTextureNodeCategory("OCTANE_TEXTURE", "Octane Texture", 
            ...
            items=[
                ...
                OctaneTextureNodeCategory("OCTANE_TEXTURE_FIELDS", "Fields", 
                    octane_pin_type=consts.PinType.PT_TEXTURE,
                    items=[
