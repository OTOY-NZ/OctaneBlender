        ...
        if is_input:            
            for _input in self.inputs:
                ...
                if not is_duplicated_input_name:
                    ...
                    report({"WARNING"}, "The input scoekt '%s' cannot be created as one or more inputs with the same name are detected! Please rename the input to fix this problem." % name)
                    return None
        else:
