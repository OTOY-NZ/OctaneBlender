...
class OctaneTexLayerApplyGradientMapEnabled(OctaneBaseSocket):
    bl_idname="OctaneTexLayerApplyGradientMapEnabled"
    bl_label="Enabled"
...
class OctaneTexLayerApplyGradientMapAttachToLayer(OctaneBaseSocket):
    bl_idname="OctaneTexLayerApplyGradientMapAttachToLayer"
...
class OctaneTexLayerApplyGradientMapGradientInterpolationType(OctaneBaseSocket):
    bl_idname="OctaneTexLayerApplyGradientMapGradientInterpolationType"
...
class OctaneTexLayerApplyGradientMapGradientInterpolationColorSpace(OctaneBaseSocket):
    bl_idname="OctaneTexLayerApplyGradientMapGradientInterpolationColorSpace"
...
class OctaneTexLayerApplyGradientMapMin(OctaneBaseSocket):
    bl_idname="OctaneTexLayerApplyGradientMapMin"
...
class OctaneTexLayerApplyGradientMapMax(OctaneBaseSocket):
    bl_idname="OctaneTexLayerApplyGradientMapMax"
    bl_label="End value"
    color=consts.OctanePinColor.Texture
    octane_default_node_type=consts.NodeType.NT_TEX_RGB
    octane_default_node_name="OctaneRGBColor"
...
class OctaneTexLayerApplyGradientMapOpacity(OctaneBaseSocket):
    bl_idname="OctaneTexLayerApplyGradientMapOpacity"
    bl_label="Opacity"
    color=consts.OctanePinColor.Texture
...
class OctaneTexLayerApplyGradientMapBlendMode(OctaneBaseSocket):
    bl_idname="OctaneTexLayerApplyGradientMapBlendMode"
    bl_label="Blend mode"
    color=consts.OctanePinColor.Enum
    octane_default_node_type=consts.NodeType.NT_ENUM
    octane_default_node_name="OctaneEnumValue"
...
class OctaneTexLayerApplyGradientMap(bpy.types.Node, OctaneBaseNode):
    bl_idname="OctaneTexLayerApplyGradientMap"
    bl_label="Apply gradient map"
    ...
    octane_socket_class_list=[OctaneTexLayerApplyGradientMapEnabled,OctaneTexLayerApplyGradientMapAttachToLayer,OctaneTexLayerApplyGradientMapGradientInterpolationType,OctaneTexLayerApplyGradientMapGradientInterpolationColorSpace,OctaneTexLayerApplyGradientMapMin,OctaneTexLayerApplyGradientMapMax,OctaneTexLayerApplyGradientMapOpacity,OctaneTexLayerApplyGradientMapBlendMode,]
    octane_min_version=13000003
    octane_node_type=consts.NodeType.NT_TEX_COMPOSITE_LAYER_APPLY_GRADIENT_MAP
    octane_socket_list=["Enabled", "Attach to layer", "Interpolation type", "Interpolation color space", "Start value", "End value", "Opacity", "Blend mode", ]
    ...
    def init(self, context):
        self.inputs.new("OctaneTexLayerApplyGradientMapEnabled", OctaneTexLayerApplyGradientMapEnabled.bl_label).init()
        self.inputs.new("OctaneTexLayerApplyGradientMapAttachToLayer", OctaneTexLayerApplyGradientMapAttachToLayer.bl_label).init()
        self.inputs.new("OctaneTexLayerApplyGradientMapGradientInterpolationType", OctaneTexLayerApplyGradientMapGradientInterpolationType.bl_label).init()
        self.inputs.new("OctaneTexLayerApplyGradientMapGradientInterpolationColorSpace", OctaneTexLayerApplyGradientMapGradientInterpolationColorSpace.bl_label).init()
        self.inputs.new("OctaneTexLayerApplyGradientMapMin", OctaneTexLayerApplyGradientMapMin.bl_label).init()
...
_CLASSES=[
    OctaneTexLayerApplyGradientMapEnabled,
    OctaneTexLayerApplyGradientMapAttachToLayer,
    OctaneTexLayerApplyGradientMapGradientInterpolationType,
    OctaneTexLayerApplyGradientMapGradientInterpolationColorSpace,
    OctaneTexLayerApplyGradientMapMin,
    OctaneTexLayerApplyGradientMapMax,
    OctaneTexLayerApplyGradientMapOpacity,
    OctaneTexLayerApplyGradientMapBlendMode,
    OctaneTexLayerApplyGradientMap,
]
