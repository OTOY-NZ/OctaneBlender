...
class OctaneTexLayerAdjustBrightnessEnabled(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustBrightnessEnabled"
    bl_label = "Enabled"
...
class OctaneTexLayerAdjustBrightnessAttachToLayer(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustBrightnessAttachToLayer"
...
class OctaneTexLayerAdjustBrightnessLuminance(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustBrightnessLuminance"
    bl_label = "Luminance"
    color = consts.OctanePinColor.Texture
    octane_default_node_type = consts.NodeType.NT_TEX_FLOAT
    octane_default_node_name = "OctaneGreyscaleColor"
    octane_pin_id = consts.PinID.P_LUMINANCE
    octane_pin_name = "luminance"
    octane_pin_type = consts.PinType.PT_TEXTURE
    octane_pin_index = 2
    octane_socket_type = consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=1.000000, update=OctaneBaseSocket.update_node_tree, description="Factor by which to multiply all RGB values", min=0.000000, max=340282346638528859811704183484516925440.000000, soft_min=0.000000, soft_max=100.000000, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneTexLayerAdjustBrightnessOpacity(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustBrightnessOpacity"
    bl_label = "Opacity"
    color = consts.OctanePinColor.Texture
    octane_default_node_type = consts.NodeType.NT_TEX_FLOAT
    octane_default_node_name = "OctaneGreyscaleColor"
...
class OctaneTexLayerAdjustBrightnessBlendMode(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustBrightnessBlendMode"
    bl_label = "Blend mode"
...
class OctaneTexLayerAdjustBrightness(bpy.types.Node, OctaneBaseNode):
    bl_idname = "OctaneTexLayerAdjustBrightness"
    ...
    octane_socket_class_list = [OctaneTexLayerAdjustBrightnessEnabled, OctaneTexLayerAdjustBrightnessAttachToLayer, OctaneTexLayerAdjustBrightnessLuminance, OctaneTexLayerAdjustBrightnessOpacity, OctaneTexLayerAdjustBrightnessBlendMode, ]
    octane_min_version = 13000002
    octane_node_type = consts.NodeType.NT_TEX_COMPOSITE_LAYER_ADJUST_BRIGHTNESS
    octane_socket_list = ["Enabled", "Attach to layer", "Luminance", "Opacity", "Blend mode", ]
    octane_attribute_list = []
    octane_attribute_config = {}
    octane_static_pin_count = 5

    def init(self, context):  # noqa
        self.inputs.new("OctaneTexLayerAdjustBrightnessEnabled", OctaneTexLayerAdjustBrightnessEnabled.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustBrightnessAttachToLayer", OctaneTexLayerAdjustBrightnessAttachToLayer.bl_label).init()
...
_CLASSES = [
    OctaneTexLayerAdjustBrightnessEnabled,
    OctaneTexLayerAdjustBrightnessAttachToLayer,
    OctaneTexLayerAdjustBrightnessLuminance,
    OctaneTexLayerAdjustBrightnessOpacity,
    OctaneTexLayerAdjustBrightnessBlendMode,
    OctaneTexLayerAdjustBrightness,
]
