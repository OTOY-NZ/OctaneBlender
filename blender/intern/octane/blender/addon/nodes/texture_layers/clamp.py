...
class OctaneTexLayerClampEnabled(OctaneBaseSocket):
    bl_idname="OctaneTexLayerClampEnabled"
    bl_label="Enabled"
...
class OctaneTexLayerClampAttachToLayer(OctaneBaseSocket):
    bl_idname="OctaneTexLayerClampAttachToLayer"
...
class OctaneTexLayerClampMin(OctaneBaseSocket):
    bl_idname="OctaneTexLayerClampMin"
    bl_label="Minimum"
...
class OctaneTexLayerClampMax(OctaneBaseSocket):
    bl_idname="OctaneTexLayerClampMax"
    bl_label="Maximum"
    color=consts.OctanePinColor.Texture
    octane_default_node_type=consts.NodeType.NT_TEX_FLOAT
    octane_default_node_name="OctaneGreyscaleColor"
...
class OctaneTexLayerClampColorChannelGroup(OctaneBaseSocket):
    bl_idname="OctaneTexLayerClampColorChannelGroup"
    bl_label="Channels"
...
class OctaneTexLayerClampOpacity(OctaneBaseSocket):
    bl_idname="OctaneTexLayerClampOpacity"
    bl_label="Opacity"
    color=consts.OctanePinColor.Texture
    octane_default_node_type=consts.NodeType.NT_TEX_FLOAT
    octane_default_node_name="OctaneGreyscaleColor"
...
class OctaneTexLayerClampBlendMode(OctaneBaseSocket):
    bl_idname="OctaneTexLayerClampBlendMode"
    bl_label="Blend mode"
    color=consts.OctanePinColor.Enum
    octane_default_node_type=consts.NodeType.NT_ENUM
    octane_default_node_name="OctaneEnumValue"
...
class OctaneTexLayerClamp(bpy.types.Node, OctaneBaseNode):
    bl_idname="OctaneTexLayerClamp"
    bl_label="Clamp"
    ...
    octane_socket_class_list=[OctaneTexLayerClampEnabled,OctaneTexLayerClampAttachToLayer,OctaneTexLayerClampMin,OctaneTexLayerClampMax,OctaneTexLayerClampColorChannelGroup,OctaneTexLayerClampOpacity,OctaneTexLayerClampBlendMode,]
    octane_min_version=13000002
    octane_node_type=consts.NodeType.NT_TEX_COMPOSITE_LAYER_CLAMP
    octane_socket_list=["Enabled", "Attach to layer", "Minimum", "Maximum", "Channels", "Opacity", "Blend mode", ]
    octane_attribute_list=[]
    octane_attribute_config={}
    octane_static_pin_count=7

    def init(self, context):
        self.inputs.new("OctaneTexLayerClampEnabled", OctaneTexLayerClampEnabled.bl_label).init()
        self.inputs.new("OctaneTexLayerClampAttachToLayer", OctaneTexLayerClampAttachToLayer.bl_label).init()
        self.inputs.new("OctaneTexLayerClampMin", OctaneTexLayerClampMin.bl_label).init()
        self.inputs.new("OctaneTexLayerClampMax", OctaneTexLayerClampMax.bl_label).init()
...
_CLASSES=[
    OctaneTexLayerClampEnabled,
    OctaneTexLayerClampAttachToLayer,
    OctaneTexLayerClampMin,
    OctaneTexLayerClampMax,
    OctaneTexLayerClampColorChannelGroup,
    OctaneTexLayerClampOpacity,
    OctaneTexLayerClampBlendMode,
    OctaneTexLayerClamp,
]
