...
class OctaneTexLayerThresholdEnabled(OctaneBaseSocket):
    bl_idname="OctaneTexLayerThresholdEnabled"
    bl_label="Enabled"
...
class OctaneTexLayerThresholdAttachToLayer(OctaneBaseSocket):
    bl_idname="OctaneTexLayerThresholdAttachToLayer"
...
class OctaneTexLayerThresholdThreshold(OctaneBaseSocket):
    bl_idname="OctaneTexLayerThresholdThreshold"
    bl_label="Threshold level"
    ...
    default_value: FloatProperty(default=0.500000, update=OctaneBaseSocket.update_node_tree, description="The output is black if the luminance of the input is below this threshold, and white if it is greater than or equal to this value", min=-340282346638528859811704183484516925440.000000, max=340282346638528859811704183484516925440.000000, soft_min=0.000000, soft_max=1.000000, subtype=consts.factor_property_subtype())
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False

class OctaneTexLayerThresholdOpacity(OctaneBaseSocket):
    bl_idname="OctaneTexLayerThresholdOpacity"
    bl_label="Opacity"
    color=consts.OctanePinColor.Texture
    octane_default_node_type=consts.NodeType.NT_TEX_FLOAT
    octane_default_node_name="OctaneGreyscaleColor"
...
class OctaneTexLayerThresholdBlendMode(OctaneBaseSocket):
    bl_idname="OctaneTexLayerThresholdBlendMode"
    bl_label="Blend mode"
...
class OctaneTexLayerThreshold(bpy.types.Node, OctaneBaseNode):
    bl_idname="OctaneTexLayerThreshold"
    bl_label="Threshold"
    ...
    octane_socket_class_list=[OctaneTexLayerThresholdEnabled,OctaneTexLayerThresholdAttachToLayer,OctaneTexLayerThresholdThreshold,OctaneTexLayerThresholdOpacity,OctaneTexLayerThresholdBlendMode,]
    octane_min_version=13000002
    octane_node_type=consts.NodeType.NT_TEX_COMPOSITE_LAYER_THRESHOLD
    octane_socket_list=["Enabled", "Attach to layer", "Threshold level", "Opacity", "Blend mode", ]
    octane_attribute_list=[]
    octane_attribute_config={}
    octane_static_pin_count=5

    def init(self, context):
        self.inputs.new("OctaneTexLayerThresholdEnabled", OctaneTexLayerThresholdEnabled.bl_label).init()
        self.inputs.new("OctaneTexLayerThresholdAttachToLayer", OctaneTexLayerThresholdAttachToLayer.bl_label).init()
...
_CLASSES=[
    OctaneTexLayerThresholdEnabled,
    OctaneTexLayerThresholdAttachToLayer,
    OctaneTexLayerThresholdThreshold,
    OctaneTexLayerThresholdOpacity,
    OctaneTexLayerThresholdBlendMode,
