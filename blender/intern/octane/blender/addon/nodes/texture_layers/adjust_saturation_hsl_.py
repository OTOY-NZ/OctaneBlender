...
class OctaneTexLayerAdjustSaturationHSLEnabled(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustSaturationHSLEnabled"
    bl_label = "Enabled"
...
class OctaneTexLayerAdjustSaturationHSLAttachToLayer(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustSaturationHSLAttachToLayer"
...
class OctaneTexLayerAdjustSaturationHSLSaturationShift(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustSaturationHSLSaturationShift"
    bl_label = "Saturation shift"
    color = consts.OctanePinColor.Texture
    octane_default_node_type = consts.NodeType.NT_TEX_FLOAT
    octane_default_node_name = "OctaneGreyscaleColor"
    octane_pin_id = consts.PinID.P_SATURATION_SHIFT
    octane_pin_name = "saturationShift"
    octane_pin_type = consts.PinType.PT_TEXTURE
    octane_pin_index = 2
    octane_socket_type = consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=0.000000, update=OctaneBaseSocket.update_node_tree, description="Saturation shift in the HSL representation", min=-1.000000, max=1.000000, soft_min=-1.000000, soft_max=1.000000, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneTexLayerAdjustSaturationHSLOpacity(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustSaturationHSLOpacity"
    bl_label = "Opacity"
    color = consts.OctanePinColor.Texture
    octane_default_node_type = consts.NodeType.NT_TEX_FLOAT
    octane_default_node_name = "OctaneGreyscaleColor"
...
class OctaneTexLayerAdjustSaturationHSLBlendMode(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustSaturationHSLBlendMode"
    bl_label = "Blend mode"
...
class OctaneTexLayerAdjustSaturationHSL(bpy.types.Node, OctaneBaseNode):
    bl_idname = "OctaneTexLayerAdjustSaturationHSL"
    bl_label = "Adjust saturation (HSL)"
    ...
    octane_socket_class_list = [OctaneTexLayerAdjustSaturationHSLEnabled, OctaneTexLayerAdjustSaturationHSLAttachToLayer, OctaneTexLayerAdjustSaturationHSLSaturationShift, OctaneTexLayerAdjustSaturationHSLOpacity, OctaneTexLayerAdjustSaturationHSLBlendMode, ]
    octane_min_version = 13000002
    octane_node_type = consts.NodeType.NT_TEX_COMPOSITE_LAYER_ADJUST_SATURATION_HSL
    octane_socket_list = ["Enabled", "Attach to layer", "Saturation shift", "Opacity", "Blend mode", ]
    octane_attribute_list = []
    octane_attribute_config = {}
    octane_static_pin_count = 5

    def init(self, context):  # noqa
        self.inputs.new("OctaneTexLayerAdjustSaturationHSLEnabled", OctaneTexLayerAdjustSaturationHSLEnabled.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustSaturationHSLAttachToLayer", OctaneTexLayerAdjustSaturationHSLAttachToLayer.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustSaturationHSLSaturationShift", OctaneTexLayerAdjustSaturationHSLSaturationShift.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustSaturationHSLOpacity", OctaneTexLayerAdjustSaturationHSLOpacity.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustSaturationHSLBlendMode", OctaneTexLayerAdjustSaturationHSLBlendMode.bl_label).init()
...
_CLASSES = [
    OctaneTexLayerAdjustSaturationHSLEnabled,
    OctaneTexLayerAdjustSaturationHSLAttachToLayer,
    OctaneTexLayerAdjustSaturationHSLSaturationShift,
    OctaneTexLayerAdjustSaturationHSLOpacity,
    OctaneTexLayerAdjustSaturationHSLBlendMode,
    OctaneTexLayerAdjustSaturationHSL,
]
