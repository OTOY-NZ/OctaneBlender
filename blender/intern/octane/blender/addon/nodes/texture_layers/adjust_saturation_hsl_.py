...
class OctaneTexLayerAdjustSaturationHSLSaturationShift(OctaneBaseSocket):
    ...
    default_value: FloatProperty(default=0.000000, update=OctaneBaseSocket.update_node_tree, description="Saturation shift in the HSL representation", min=-1.000000, max=1.000000, soft_min=-1.000000, soft_max=1.000000, subtype="FACTOR")
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False
