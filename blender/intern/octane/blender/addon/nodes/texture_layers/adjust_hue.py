...
class OctaneTexLayerAdjustHueEnabled(OctaneBaseSocket):
    bl_idname="OctaneTexLayerAdjustHueEnabled"
    bl_label="Enabled"
...
class OctaneTexLayerAdjustHueAttachToLayer(OctaneBaseSocket):
    bl_idname="OctaneTexLayerAdjustHueAttachToLayer"
...
class OctaneTexLayerAdjustHueHue(OctaneBaseSocket):
    bl_idname="OctaneTexLayerAdjustHueHue"
    bl_label="Hue shift"
    ...
    default_value: FloatProperty(default=0.000000, update=OctaneBaseSocket.update_node_tree, description="Hue shift in degrees", min=-340282346638528859811704183484516925440.000000, max=340282346638528859811704183484516925440.000000, soft_min=-180.000000, soft_max=180.000000, subtype=consts.factor_property_subtype())
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False

class OctaneTexLayerAdjustHueOpacity(OctaneBaseSocket):
    bl_idname="OctaneTexLayerAdjustHueOpacity"
    bl_label="Opacity"
    color=consts.OctanePinColor.Texture
    octane_default_node_type=consts.NodeType.NT_TEX_FLOAT
    octane_default_node_name="OctaneGreyscaleColor"
...
class OctaneTexLayerAdjustHueBlendMode(OctaneBaseSocket):
    bl_idname="OctaneTexLayerAdjustHueBlendMode"
    bl_label="Blend mode"
...
class OctaneTexLayerAdjustHue(bpy.types.Node, OctaneBaseNode):
    bl_idname="OctaneTexLayerAdjustHue"
    bl_label="Adjust hue"
    ...
    octane_socket_class_list=[OctaneTexLayerAdjustHueEnabled,OctaneTexLayerAdjustHueAttachToLayer,OctaneTexLayerAdjustHueHue,OctaneTexLayerAdjustHueOpacity,OctaneTexLayerAdjustHueBlendMode,]
    octane_min_version=13000002
    octane_node_type=consts.NodeType.NT_TEX_COMPOSITE_LAYER_ADJUST_HUE
    octane_socket_list=["Enabled", "Attach to layer", "Hue shift", "Opacity", "Blend mode", ]
    octane_attribute_list=[]
    octane_attribute_config={}
    octane_static_pin_count=5

    def init(self, context):
        self.inputs.new("OctaneTexLayerAdjustHueEnabled", OctaneTexLayerAdjustHueEnabled.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustHueAttachToLayer", OctaneTexLayerAdjustHueAttachToLayer.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustHueHue", OctaneTexLayerAdjustHueHue.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustHueOpacity", OctaneTexLayerAdjustHueOpacity.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustHueBlendMode", OctaneTexLayerAdjustHueBlendMode.bl_label).init()
...
_CLASSES=[
    OctaneTexLayerAdjustHueEnabled,
    OctaneTexLayerAdjustHueAttachToLayer,
    OctaneTexLayerAdjustHueHue,
    OctaneTexLayerAdjustHueOpacity,
    OctaneTexLayerAdjustHueBlendMode,
    OctaneTexLayerAdjustHue,
]
