...
class OctaneTexLayerApplyGammaCurveGamma(OctaneBaseSocket):
    ...
    default_value: FloatProperty(default=1.000000, update=OctaneBaseSocket.update_node_tree, description="The gamma value used. The equation applied is: output = pow(input, 1/gamma)", min=0.010000, max=100.000000, soft_min=0.010000, soft_max=100.000000, subtype=consts.factor_property_subtype())
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False
