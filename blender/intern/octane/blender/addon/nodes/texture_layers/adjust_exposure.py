...
class OctaneTexLayerAdjustExposureExposure(OctaneBaseSocket):
    ...
    default_value: FloatProperty(default=0.000000, update=OctaneBaseSocket.update_node_tree, description="Amount of exposure adjustment in stops", min=-20.000000, max=20.000000, soft_min=-10.000000, soft_max=10.000000, subtype=consts.factor_property_subtype())
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False
