...
class OctaneTexLayerAdjustExposureEnabled(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustExposureEnabled"
    bl_label = "Enabled"
...
class OctaneTexLayerAdjustExposureAttachToLayer(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustExposureAttachToLayer"
...
class OctaneTexLayerAdjustExposureExposure(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustExposureExposure"
    bl_label = "Exposure"
    ...
    default_value: FloatProperty(default=0.000000, update=OctaneBaseSocket.update_node_tree, description="Amount of exposure adjustment in stops", min=-20.000000, max=20.000000, soft_min=-10.000000, soft_max=10.000000, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneTexLayerAdjustExposureOpacity(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustExposureOpacity"
    bl_label = "Opacity"
    color = consts.OctanePinColor.Texture
    octane_default_node_type = consts.NodeType.NT_TEX_FLOAT
    octane_default_node_name = "OctaneGreyscaleColor"
...
class OctaneTexLayerAdjustExposureBlendMode(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustExposureBlendMode"
    bl_label = "Blend mode"
...
class OctaneTexLayerAdjustExposure(bpy.types.Node, OctaneBaseNode):
    bl_idname = "OctaneTexLayerAdjustExposure"
    ...
    octane_socket_class_list = [OctaneTexLayerAdjustExposureEnabled, OctaneTexLayerAdjustExposureAttachToLayer, OctaneTexLayerAdjustExposureExposure, OctaneTexLayerAdjustExposureOpacity, OctaneTexLayerAdjustExposureBlendMode, ]
    octane_min_version = 13000002
    octane_node_type = consts.NodeType.NT_TEX_COMPOSITE_LAYER_ADJUST_EXPOSURE
    octane_socket_list = ["Enabled", "Attach to layer", "Exposure", "Opacity", "Blend mode", ]
    octane_attribute_list = []
    octane_attribute_config = {}
    octane_static_pin_count = 5

    def init(self, context):  # noqa
        self.inputs.new("OctaneTexLayerAdjustExposureEnabled", OctaneTexLayerAdjustExposureEnabled.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustExposureAttachToLayer", OctaneTexLayerAdjustExposureAttachToLayer.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustExposureExposure", OctaneTexLayerAdjustExposureExposure.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustExposureOpacity", OctaneTexLayerAdjustExposureOpacity.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustExposureBlendMode", OctaneTexLayerAdjustExposureBlendMode.bl_label).init()
...
_CLASSES = [
    OctaneTexLayerAdjustExposureEnabled,
    OctaneTexLayerAdjustExposureAttachToLayer,
    OctaneTexLayerAdjustExposureExposure,
    OctaneTexLayerAdjustExposureOpacity,
    OctaneTexLayerAdjustExposureBlendMode,
    OctaneTexLayerAdjustExposure,
]
