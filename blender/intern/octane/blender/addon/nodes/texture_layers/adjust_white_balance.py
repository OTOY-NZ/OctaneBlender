...
class OctaneTexLayerAdjustWhiteBalanceEnabled(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustWhiteBalanceEnabled"
    bl_label = "Enabled"
...
class OctaneTexLayerAdjustWhiteBalanceAttachToLayer(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustWhiteBalanceAttachToLayer"
...
class OctaneTexLayerAdjustWhiteBalanceWhiteBalance(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustWhiteBalanceWhiteBalance"
...
class OctaneTexLayerAdjustWhiteBalanceOpacity(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustWhiteBalanceOpacity"
    bl_label = "Opacity"
...
class OctaneTexLayerAdjustWhiteBalanceBlendMode(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustWhiteBalanceBlendMode"
    bl_label = "Blend mode"
...
class OctaneTexLayerAdjustWhiteBalance(bpy.types.Node, OctaneBaseNode):
    bl_idname = "OctaneTexLayerAdjustWhiteBalance"
    ...
    octane_socket_class_list = [OctaneTexLayerAdjustWhiteBalanceEnabled, OctaneTexLayerAdjustWhiteBalanceAttachToLayer, OctaneTexLayerAdjustWhiteBalanceWhiteBalance, OctaneTexLayerAdjustWhiteBalanceOpacity, OctaneTexLayerAdjustWhiteBalanceBlendMode, ]
    octane_min_version = 13000003
    octane_node_type = consts.NodeType.NT_TEX_COMPOSITE_LAYER_ADJUST_WHITE_BALANCE
    octane_socket_list = ["Enabled", "Attach to layer", "White point", "Opacity", "Blend mode", ]
    octane_attribute_list = []
    octane_attribute_config = {}
    octane_static_pin_count = 5

    def init(self, context):  # noqa
        self.inputs.new("OctaneTexLayerAdjustWhiteBalanceEnabled", OctaneTexLayerAdjustWhiteBalanceEnabled.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustWhiteBalanceAttachToLayer", OctaneTexLayerAdjustWhiteBalanceAttachToLayer.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustWhiteBalanceWhiteBalance", OctaneTexLayerAdjustWhiteBalanceWhiteBalance.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustWhiteBalanceOpacity", OctaneTexLayerAdjustWhiteBalanceOpacity.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustWhiteBalanceBlendMode", OctaneTexLayerAdjustWhiteBalanceBlendMode.bl_label).init()
...
_CLASSES = [
    OctaneTexLayerAdjustWhiteBalanceEnabled,
    OctaneTexLayerAdjustWhiteBalanceAttachToLayer,
    OctaneTexLayerAdjustWhiteBalanceWhiteBalance,
    OctaneTexLayerAdjustWhiteBalanceOpacity,
    OctaneTexLayerAdjustWhiteBalanceBlendMode,
    OctaneTexLayerAdjustWhiteBalance,
]
