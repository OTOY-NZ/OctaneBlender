...
class OctaneTexLayerAdjustContrastEnabled(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustContrastEnabled"
    bl_label = "Enabled"
...
class OctaneTexLayerAdjustContrastAttachToLayer(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustContrastAttachToLayer"
...
class OctaneTexLayerAdjustContrastContrast(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustContrastContrast"
    bl_label = "Contrast"
    ...
    default_value: FloatProperty(default=0.000000, update=OctaneBaseSocket.update_node_tree, description="Amount of additional contrast to apply", min=0.000000, max=1000.000000, soft_min=0.000000, soft_max=1000.000000, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneTexLayerAdjustContrastOpacity(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustContrastOpacity"
    bl_label = "Opacity"
    color = consts.OctanePinColor.Texture
    octane_default_node_type = consts.NodeType.NT_TEX_FLOAT
    octane_default_node_name = "OctaneGreyscaleColor"
...
class OctaneTexLayerAdjustContrastBlendMode(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustContrastBlendMode"
    bl_label = "Blend mode"
...
class OctaneTexLayerAdjustContrast(bpy.types.Node, OctaneBaseNode):
    bl_idname = "OctaneTexLayerAdjustContrast"
    bl_label = "Adjust contrast"
    ...
    octane_socket_class_list = [OctaneTexLayerAdjustContrastEnabled, OctaneTexLayerAdjustContrastAttachToLayer, OctaneTexLayerAdjustContrastContrast, OctaneTexLayerAdjustContrastOpacity, OctaneTexLayerAdjustContrastBlendMode, ]
    octane_min_version = 13000002
    octane_node_type = consts.NodeType.NT_TEX_COMPOSITE_LAYER_ADJUST_CONTRAST
    octane_socket_list = ["Enabled", "Attach to layer", "Contrast", "Opacity", "Blend mode", ]
    octane_attribute_list = []
    octane_attribute_config = {}
    octane_static_pin_count = 5

    def init(self, context):  # noqa
        self.inputs.new("OctaneTexLayerAdjustContrastEnabled", OctaneTexLayerAdjustContrastEnabled.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustContrastAttachToLayer", OctaneTexLayerAdjustContrastAttachToLayer.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustContrastContrast", OctaneTexLayerAdjustContrastContrast.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustContrastOpacity", OctaneTexLayerAdjustContrastOpacity.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustContrastBlendMode", OctaneTexLayerAdjustContrastBlendMode.bl_label).init()
...
_CLASSES = [
    OctaneTexLayerAdjustContrastEnabled,
    OctaneTexLayerAdjustContrastAttachToLayer,
    OctaneTexLayerAdjustContrastContrast,
    OctaneTexLayerAdjustContrastOpacity,
    OctaneTexLayerAdjustContrastBlendMode,
    OctaneTexLayerAdjustContrast,
]
