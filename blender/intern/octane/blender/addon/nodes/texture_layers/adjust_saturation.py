...
class OctaneTexLayerAdjustSaturationEnabled(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustSaturationEnabled"
    bl_label = "Enabled"
...
class OctaneTexLayerAdjustSaturationAttachToLayer(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustSaturationAttachToLayer"
...
class OctaneTexLayerAdjustSaturationSaturation(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustSaturationSaturation"
    bl_label = "Saturation"
    ...
    default_value: FloatProperty(default=1.000000, update=OctaneBaseSocket.update_node_tree, description="Factor by which to multiply the saturation", min=0.000000, max=340282346638528859811704183484516925440.000000, soft_min=0.000000, soft_max=2.000000, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneTexLayerAdjustSaturationOpacity(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustSaturationOpacity"
    bl_label = "Opacity"
    color = consts.OctanePinColor.Texture
    octane_default_node_type = consts.NodeType.NT_TEX_FLOAT
    octane_default_node_name = "OctaneGreyscaleColor"
...
class OctaneTexLayerAdjustSaturationBlendMode(OctaneBaseSocket):
    bl_idname = "OctaneTexLayerAdjustSaturationBlendMode"
    bl_label = "Blend mode"
...
class OctaneTexLayerAdjustSaturation(bpy.types.Node, OctaneBaseNode):
    bl_idname = "OctaneTexLayerAdjustSaturation"
    bl_label = "Adjust saturation"
    ...
    octane_socket_class_list = [OctaneTexLayerAdjustSaturationEnabled, OctaneTexLayerAdjustSaturationAttachToLayer, OctaneTexLayerAdjustSaturationSaturation, OctaneTexLayerAdjustSaturationOpacity, OctaneTexLayerAdjustSaturationBlendMode, ]
    octane_min_version = 13000002
    octane_node_type = consts.NodeType.NT_TEX_COMPOSITE_LAYER_ADJUST_SATURATION
    octane_socket_list = ["Enabled", "Attach to layer", "Saturation", "Opacity", "Blend mode", ]
    octane_attribute_list = []
    octane_attribute_config = {}
    octane_static_pin_count = 5

    def init(self, context):  # noqa
        self.inputs.new("OctaneTexLayerAdjustSaturationEnabled", OctaneTexLayerAdjustSaturationEnabled.bl_label).init()
        self.inputs.new("OctaneTexLayerAdjustSaturationAttachToLayer", OctaneTexLayerAdjustSaturationAttachToLayer.bl_label).init()
...
_CLASSES = [
    OctaneTexLayerAdjustSaturationEnabled,
    OctaneTexLayerAdjustSaturationAttachToLayer,
    OctaneTexLayerAdjustSaturationSaturation,
    OctaneTexLayerAdjustSaturationOpacity,
    OctaneTexLayerAdjustSaturationBlendMode,
    OctaneTexLayerAdjustSaturation,
]
