...
class OctaneTexLayerAdjustSaturationSaturation(OctaneBaseSocket):
    ...
    default_value: FloatProperty(default=100.000000, update=OctaneBaseSocket.update_node_tree, description="Factor by which to multiply the saturation", min=0.000000, max=34028234663852885981170418348451692544000.000000, soft_min=0.000000, soft_max=200.000000, subtype="PERCENTAGE")
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
