...
class OctaneTextureLayerSwitchIndex(OctaneBaseSocket):
    bl_idname="OctaneTextureLayerSwitchIndex"
    bl_label="Input"
...
class OctaneTextureLayerSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname="OctaneTextureLayerSwitch"
    bl_label="Texture layer switch"
    ...
    octane_socket_class_list=[OctaneTextureLayerSwitchIndex,]
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctaneTextureLayerSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctaneTextureLayerSwitchIndex", OctaneTextureLayerSwitchIndex.bl_label).init()
...
_CLASSES=[
    OctaneTextureLayerSwitchIndex,
    OctaneTextureLayerSwitch,
]
