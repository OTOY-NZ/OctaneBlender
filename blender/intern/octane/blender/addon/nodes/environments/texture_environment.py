...
class OctaneTextureEnvironmentRotation(OctaneBaseSocket):
    ...
    default_value: FloatVectorProperty(default=(0.000000, 0.000000), update=None, description="(deprecated) Rotation", min=-1.000000, max=1.000000, soft_min=-1.000000, soft_max=1.000000, step=1, subtype="NONE", size=2)
    octane_hide_value=False
    octane_min_version=0
