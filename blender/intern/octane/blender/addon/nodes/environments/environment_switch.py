...
class OctaneEnvironmentSwitchIndex(OctaneBaseSocket):
    bl_idname = "OctaneEnvironmentSwitchIndex"
    bl_label = "Input"
...
class OctaneEnvironmentSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname = "OctaneEnvironmentSwitch"
    bl_label = "Environment switch"
    ...
    octane_socket_class_list = [OctaneEnvironmentSwitchIndex, ]
    octane_min_version = 13000000
    octane_node_type = consts.NodeType.NT_SWITCH_ENVIRONMENT
    ...
    INPUT_SOCKET_CLASS = base_switch_input_socket.OctaneEnvironmentSwitchInputSocket
    ...
    def init(self, context):  # noqa
        self.inputs.new("OctaneEnvironmentSwitchIndex", OctaneEnvironmentSwitchIndex.bl_label).init()
...
_CLASSES = [
    OctaneEnvironmentSwitchIndex,
    OctaneEnvironmentSwitch,
]
