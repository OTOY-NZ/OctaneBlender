...
class OctaneDirectLightingKernelGIMode(OctaneBaseSocket):
    ...
    octane_pin_id=consts.PinID.P_GI_MODE
    octane_pin_name="GI_mode"
...
class OctaneDirectLightingKernelSpeculardepth(OctaneBaseSocket):
    ...
    octane_default_node_type=consts.NodeType.NT_INT
    octane_default_node_name="OctaneIntValue"
    octane_pin_id=consts.PinID.P_SPECULAR_DEPTH
    octane_pin_name="speculardepth"
    octane_pin_type=consts.PinType.PT_INT
    octane_pin_index=2
    octane_socket_type=consts.SocketType.ST_INT
    default_value: IntProperty(default=5, update=OctaneBaseSocket.update_node_tree, description="The maximum path depth for which specular reflections/refractions are allowed", min=1, max=1024, soft_min=1, soft_max=1024, step=1, subtype=consts.factor_property_subtype())
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False
...
class OctaneDirectLightingKernelGlossydepth(OctaneBaseSocket):
    ...
    octane_default_node_type=consts.NodeType.NT_INT
    octane_default_node_name="OctaneIntValue"
    octane_pin_id=consts.PinID.P_GLOSSY_DEPTH
    octane_pin_name="glossydepth"
    octane_pin_type=consts.PinType.PT_INT
    octane_pin_index=3
    octane_socket_type=consts.SocketType.ST_INT
    default_value: IntProperty(default=2, update=OctaneBaseSocket.update_node_tree, description="The maximum path depth for which glossy reflections are allowed", min=1, max=1024, soft_min=1, soft_max=1024, step=1, subtype=consts.factor_property_subtype())
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False
...
class OctaneDirectLightingKernelDiffusedepth(OctaneBaseSocket):
    ...
    octane_default_node_type=consts.NodeType.NT_INT
    octane_default_node_name="OctaneIntValue"
    octane_pin_id=consts.PinID.P_DIFFUSE_DEPTH
    octane_pin_name="diffusedepth"
    octane_pin_type=consts.PinType.PT_INT
    octane_pin_index=4
    octane_socket_type=consts.SocketType.ST_INT
    default_value: IntProperty(default=2, update=OctaneBaseSocket.update_node_tree, description="The maximum path depth for which diffuse reflections are allowed", min=1, max=8, soft_min=1, soft_max=8, step=1, subtype=consts.factor_property_subtype())
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False
...
class OctaneDirectLightingKernelAoTexture(OctaneBaseSocket):
    ...
    octane_pin_id=consts.PinID.P_AO_TEXTURE
    octane_pin_name="aoTexture"
...
class OctaneDirectLightingKernelAffectRoughness(OctaneBaseSocket):
    ...
    octane_pin_index=38
    octane_socket_type=consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=0.000000, update=OctaneBaseSocket.update_node_tree, description="The percentage of roughness affecting subsequent layers' roughness", min=0.000000, max=1.000000, soft_min=0.000000, soft_max=1.000000, step=1, precision=2, subtype=consts.factor_property_subtype())
    octane_hide_value=False
...
class OctaneDirectLightingKernelAiLightUpdateStrength(OctaneBaseSocket):
    ...
    octane_pin_index=39
    octane_socket_type=consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=0.800000, update=OctaneBaseSocket.update_node_tree, description="The strength for dynamic AI light update", min=0.000000, max=1.000000, soft_min=0.000000, soft_max=1.000000, step=1, precision=2, subtype=consts.factor_property_subtype())
    octane_hide_value=False
    octane_min_version=4000000
...
class OctaneDirectLightingKernelRrprob(OctaneBaseSocket):
    ...
    octane_pin_index=41
    octane_socket_type=consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=0.000000, update=OctaneBaseSocket.update_node_tree, description="(deprecated) Russian roulette termination probability (0=auto)", min=0.000000, max=1.000000, soft_min=0.000000, soft_max=1.000000, step=1, precision=2, subtype=consts.factor_property_subtype())
    octane_hide_value=False
    octane_min_version=0
...
class OctaneDirectLightingKernelAdaptiveStrength(OctaneBaseSocket):
    ...
    octane_pin_index=42
    octane_socket_type=consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=1.000000, update=OctaneBaseSocket.update_node_tree, description="(deprecated) The strength with which the adaptive sampling is applied. Lower the values will increase render time. Only valid if adaptive sampling is enabled", min=0.000000, max=1.000000, soft_min=0.000000, soft_max=1.000000, step=1, precision=2, subtype=consts.factor_property_subtype())
    octane_hide_value=False
    octane_min_version=3060000
...
class OctaneDirectLightingKernelAnalyticLight(OctaneBaseSocket):
    bl_idname="OctaneDirectLightingKernelAnalyticLight"
...
class OctaneDirectLightingKernel(bpy.types.Node, OctaneBaseKernelNode):
    ...
    octane_socket_class_list=[OctaneDirectLightingKernelGroupQuality,OctaneDirectLightingKernelMaxsamples,OctaneDirectLightingKernelGIMode,OctaneDirectLightingKernelSpeculardepth,OctaneDirectLightingKernelGlossydepth,OctaneDirectLightingKernelDiffusedepth,OctaneDirectLightingKernelMaxOverlappingVolumes,OctaneDirectLightingKernelRayepsilon,OctaneDirectLightingKernelFiltersize,OctaneDirectLightingKernelAodist,OctaneDirectLightingKernelAoTexture,OctaneDirectLightingKernelAlphashadows,OctaneDirectLightingKernelNestedDielectrics,OctaneDirectLightingKernelIrradiance,OctaneDirectLightingKernelMaxsubdLevel,OctaneDirectLightingKernelAffectRoughness,OctaneDirectLightingKernelGroupAlphaChannel,OctaneDirectLightingKernelAlphachannel,OctaneDirectLightingKernelKeepEnvironment,OctaneDirectLightingKernelGroupLight,OctaneDirectLightingKernelAiLight,OctaneDirectLightingKernelAiLightUpdate,OctaneDirectLightingKernelGlobalLightIdMaskAction,OctaneDirectLightingKernelGlobalLightIdMask,OctaneDirectLightingKernelLightPassMask,OctaneDirectLightingKernelAiLightUpdateStrength,OctaneDirectLightingKernelAnalyticLight,OctaneDirectLightingKernelGroupSampling,OctaneDirectLightingKernelPathTermPower,OctaneDirectLightingKernelCoherentRatio,OctaneDirectLightingKernelStaticNoise,OctaneDirectLightingKernelParallelSamples,OctaneDirectLightingKernelMaxTileSamples,OctaneDirectLightingKernelMinimizeNetTraffic,OctaneDirectLightingKernelGroupAdaptiveSampling,OctaneDirectLightingKernelAdaptiveSampling,OctaneDirectLightingKernelNoiseThreshold,OctaneDirectLightingKernelMinAdaptiveSamples,OctaneDirectLightingKernelAdaptiveSamplingPixelGroup,OctaneDirectLightingKernelAdaptiveSamplingExposure,OctaneDirectLightingKernelAdaptiveStrength,OctaneDirectLightingKernelGroupColor,OctaneDirectLightingKernelWhiteLightSpectrum,OctaneDirectLightingKernelUseOldColorPipeline,OctaneDirectLightingKernelGroupDeepImage,OctaneDirectLightingKernelDeepEnable,OctaneDirectLightingKernelDeepEnablePasses,OctaneDirectLightingKernelMaxDepthSamples,OctaneDirectLightingKernelDepthTolerance,OctaneDirectLightingKernelGroupToonShading,OctaneDirectLightingKernelToonShadowAmbient,OctaneDirectLightingKernelCoherentMode,OctaneDirectLightingKernelRrprob,OctaneDirectLightingKernelGroupCompatibilitySettings,OctaneDirectLightingKernelOldVolumeBehavior,]
    octane_min_version=0
    octane_node_type=consts.NodeType.NT_KERN_DIRECTLIGHTING
    octane_socket_list=["Max. samples", "Global illumination mode", "Specular depth", "Glossy depth", "Diffuse depth", "Maximal overlapping volumes", "Ray epsilon", "Filter size", "AO distance", "AO ambient texture", "Alpha shadows", "Nested dielectrics", "Irradiance mode", "Max subdivision level", "Alpha channel", "Keep environment", "AI light", "AI light update", "Light IDs action", "Light IDs", "Light linking invert", "Path term. power", "Coherent ratio", "Static noise", "Parallel samples", "Max. tile samples", "Minimize net traffic", "Adaptive sampling", "Noise threshold", "Min. adaptive samples", "Pixel grouping", "Expected exposure", "White light spectrum", "Deep image", "Deep render AOVs", "Max. depth samples", "Depth tolerance", "Toon shadow ambient", "[Deprecated]Affect roughness", "[Deprecated]AI light strength", "[Deprecated]Coherent mode", "[Deprecated]RR probability", "[Deprecated]Adaptive strength", "[Deprecated]Emulate old volume behavior", "[Deprecated]Use old color pipeline", "[Deprecated]Analytic light", ]
    ...
    compatibility_mode_infos=[
        ...
        ("2021.1 compatibility mode", "2021.1 compatibility mode", """Volume tracing behavior from versions 2018.1 to 2021.1 is used.""", 11000099),
        ("2021.1 compatibility mode (with 4.0 volumes)", "2021.1 compatibility mode (with 4.0 volumes)", """Volume tracing behavior from version 4.0 and earlier is used.""", 11000098),
        ("2018.1 compatibility mode", "2018.1 compatibility mode", """Volume tracing behavior from versions 2018.1 to 2021.1 is used. Original pipeline for converting colors to and from spectra and for applying white balance is used (textures with colors outside the sRGB gamut will be rendered inaccurately).""", 5000000),
        ("4.0 compatibility mode", "4.0 compatibility mode", """Volume tracing behavior from version 4.0 and earlier is used. Original pipeline for converting colors to and from spectra and for applying white balance is used (textures with colors outside the sRGB gamut will be rendered inaccurately).""", 0),
    ]
    ...
    def init(self, context):
        ...
        self.inputs.new("OctaneDirectLightingKernelAnalyticLight", OctaneDirectLightingKernelAnalyticLight.bl_label).init()
...
OctaneDirectLightingKernelGroupCompatibilitySettings.octane_deprecated = True
OctaneDirectLightingKernel_Override.update_node_definition()
