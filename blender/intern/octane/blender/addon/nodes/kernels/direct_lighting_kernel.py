...
class OctaneDirectLightingKernelSpeculardepth(OctaneBaseSocket):
    ...
    octane_pin_index = 2
    octane_socket_type = consts.SocketType.ST_INT
    default_value: IntProperty(default=5, update=OctaneBaseSocket.update_node_tree, description="The maximum path depth for which specular reflections/refractions are allowed", min=1, max=1024, soft_min=1, soft_max=1024, step=1, subtype="NONE")
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneDirectLightingKernelGlossydepth(OctaneBaseSocket):
    ...
    octane_pin_index = 3
    octane_socket_type = consts.SocketType.ST_INT
    default_value: IntProperty(default=2, update=OctaneBaseSocket.update_node_tree, description="The maximum path depth for which glossy reflections are allowed", min=1, max=1024, soft_min=1, soft_max=1024, step=1, subtype="NONE")
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneDirectLightingKernelDiffusedepth(OctaneBaseSocket):
    ...
    octane_pin_index = 4
    octane_socket_type = consts.SocketType.ST_INT
    default_value: IntProperty(default=2, update=OctaneBaseSocket.update_node_tree, description="The maximum path depth for which diffuse reflections are allowed", min=1, max=8, soft_min=1, soft_max=8, step=1, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneDirectLightingKernelAodist(OctaneBaseSocket):
    ...
    octane_pin_index = 8
    octane_socket_type = consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=3.000000, update=OctaneBaseSocket.update_node_tree, description="Maximum distance for environment ambient occlusion", min=0.000000, max=340282346638528859811704183484516925440.000000, soft_min=0.010000, soft_max=1024.000000, step=1.000000, precision=2, subtype="NONE")
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneDirectLightingKernelDirectLightRayCount(OctaneBaseSocket):
    bl_idname = "OctaneDirectLightingKernelDirectLightRayCount"
...
class OctaneDirectLightingKernelAdaptiveStrength(OctaneBaseSocket):
    ...
    octane_pin_index = 43
    octane_socket_type = consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=1.000000, update=OctaneBaseSocket.update_node_tree, description="(deprecated) The strength with which the adaptive sampling is applied. Lower the values will increase render time. Only valid if adaptive sampling is enabled", min=0.000000, max=1.000000, soft_min=0.000000, soft_max=1.000000, step=1.000000, precision=2, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 3060000
...
class OctaneDirectLightingKernel(bpy.types.Node, OctaneBaseKernelNode):
    ...
    def init(self, context):  # noqa
        ...
        self.inputs.new("OctaneDirectLightingKernelDirectLightRayCount", OctaneDirectLightingKernelDirectLightRayCount.bl_label).init()
...
_CLASSES = [
    ...
    OctaneDirectLightingKernelDirectLightRayCount,
