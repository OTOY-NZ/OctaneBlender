...
class OctaneKernelSwitchIndex(OctaneBaseSocket):
    bl_idname = "OctaneKernelSwitchIndex"
    bl_label = "Input"
...
class OctaneKernelSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname = "OctaneKernelSwitch"
    bl_label = "Kernel switch"
    ...
    octane_socket_class_list = [OctaneKernelSwitchIndex, ]
    octane_min_version = 13000000
    octane_node_type = consts.NodeType.NT_SWITCH_KERNEL
    ...
    INPUT_SOCKET_CLASS = base_switch_input_socket.OctaneKernelSwitchInputSocket
    ...
    def init(self, context):  # noqa
        self.inputs.new("OctaneKernelSwitchIndex", OctaneKernelSwitchIndex.bl_label).init()
