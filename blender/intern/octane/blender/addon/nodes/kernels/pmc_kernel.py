...
class OctanePMCKernelDirectLightRayCount(OctaneBaseSocket):
    bl_idname = "OctanePMCKernelDirectLightRayCount"
...
class OctanePMCKernel(bpy.types.Node, OctaneBaseKernelNode):
    ...
    def init(self, context):  # noqa
        ...
        self.inputs.new("OctanePMCKernelDirectLightRayCount", OctanePMCKernelDirectLightRayCount.bl_label).init()
...
_CLASSES = [
    ...
    OctanePMCKernelDirectLightRayCount,
