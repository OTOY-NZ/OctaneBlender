...
class OctaneRenderAOVSwitchIndex(OctaneBaseSocket):
    bl_idname = "OctaneRenderAOVSwitchIndex"
    bl_label = "Input"
...
class OctaneRenderAOVSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname = "OctaneRenderAOVSwitch"
    bl_label = "Render AOV switch"
    ...
    octane_socket_class_list = [OctaneRenderAOVSwitchIndex, ]
    octane_min_version = 13000000
    octane_node_type = consts.NodeType.NT_SWITCH_RENDER_PASSES
    ...
    INPUT_SOCKET_CLASS = base_switch_input_socket.OctaneRenderAOVSwitchInputSocket
    ...
    def init(self, context):  # noqa
        self.inputs.new("OctaneRenderAOVSwitchIndex", OctaneRenderAOVSwitchIndex.bl_label).init()
...
_CLASSES = [
    OctaneRenderAOVSwitchIndex,
    OctaneRenderAOVSwitch,
]
