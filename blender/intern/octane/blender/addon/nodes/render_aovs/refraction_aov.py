...
class OctaneRefractionAOV(bpy.types.Node, OctaneBaseNode):
    ...
    def init(self, context):
        self.inputs.new("OctaneRefractionAOVEnabled", OctaneRefractionAOVEnabled.bl_label)
        self.outputs.new("OctaneRenderAOVsOutSocket", "Render AOVs out")


def register():
    register_class(OctaneRefractionAOVEnabled)
    register_class(OctaneRefractionAOV)

def unregister():
    unregister_class(OctaneRefractionAOV)
    unregister_class(OctaneRefractionAOVEnabled)
