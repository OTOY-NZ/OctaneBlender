...
class OctaneVolumeZDepthFrontAOV(bpy.types.Node, OctaneBaseNode):
    ...
    def init(self, context):
        self.inputs.new("OctaneVolumeZDepthFrontAOVEnabled", OctaneVolumeZDepthFrontAOVEnabled.bl_label)
        self.outputs.new("OctaneRenderAOVsOutSocket", "Render AOVs out")


def register():
    register_class(OctaneVolumeZDepthFrontAOVEnabled)
    register_class(OctaneVolumeZDepthFrontAOV)

def unregister():
    unregister_class(OctaneVolumeZDepthFrontAOV)
    unregister_class(OctaneVolumeZDepthFrontAOVEnabled)
