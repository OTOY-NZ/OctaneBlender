...
class OctaneLightPassIDAOV(bpy.types.Node, OctaneBaseNode):
    ...
    def init(self, context):
        self.inputs.new("OctaneLightPassIDAOVEnabled", OctaneLightPassIDAOVEnabled.bl_label)
        self.outputs.new("OctaneRenderAOVsOutSocket", "Render AOVs out")


def register():
    register_class(OctaneLightPassIDAOVEnabled)
    register_class(OctaneLightPassIDAOV)

def unregister():
    unregister_class(OctaneLightPassIDAOV)
    unregister_class(OctaneLightPassIDAOVEnabled)
