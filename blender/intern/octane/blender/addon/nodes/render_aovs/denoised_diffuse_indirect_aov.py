...
class OctaneDenoisedDiffuseIndirectAOV(bpy.types.Node, OctaneBaseNode):
    ...
    def init(self, context):
        self.inputs.new("OctaneDenoisedDiffuseIndirectAOVEnabled", OctaneDenoisedDiffuseIndirectAOVEnabled.bl_label)
        self.outputs.new("OctaneRenderAOVsOutSocket", "Render AOVs out")


def register():
    register_class(OctaneDenoisedDiffuseIndirectAOVEnabled)
    register_class(OctaneDenoisedDiffuseIndirectAOV)

def unregister():
    unregister_class(OctaneDenoisedDiffuseIndirectAOV)
    unregister_class(OctaneDenoisedDiffuseIndirectAOVEnabled)
