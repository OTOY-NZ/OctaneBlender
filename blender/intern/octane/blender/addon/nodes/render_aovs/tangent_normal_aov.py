...
class OctaneTangentNormalAOV(bpy.types.Node, OctaneBaseNode):
    ...
    def init(self, context):
        self.inputs.new("OctaneTangentNormalAOVEnabled", OctaneTangentNormalAOVEnabled.bl_label)
        self.outputs.new("OctaneRenderAOVsOutSocket", "Render AOVs out")


def register():
    register_class(OctaneTangentNormalAOVEnabled)
    register_class(OctaneTangentNormalAOV)

def unregister():
    unregister_class(OctaneTangentNormalAOV)
    unregister_class(OctaneTangentNormalAOVEnabled)
