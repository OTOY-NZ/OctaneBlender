...
class OctaneDenoisedDiffuseDirectAOV(bpy.types.Node, OctaneBaseNode):
    ...
    def init(self, context):
        self.inputs.new("OctaneDenoisedDiffuseDirectAOVEnabled", OctaneDenoisedDiffuseDirectAOVEnabled.bl_label)
        self.outputs.new("OctaneRenderAOVsOutSocket", "Render AOVs out")


def register():
    register_class(OctaneDenoisedDiffuseDirectAOVEnabled)
    register_class(OctaneDenoisedDiffuseDirectAOV)

def unregister():
    unregister_class(OctaneDenoisedDiffuseDirectAOV)
    unregister_class(OctaneDenoisedDiffuseDirectAOVEnabled)
