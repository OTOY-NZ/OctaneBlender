...
class OctaneLayerReflectionsAOV(bpy.types.Node, OctaneBaseNode):
    ...
    octane_render_pass_id=20
    octane_render_pass_name="Layer reflections"
    octane_render_pass_short_name="LRef"
    octane_render_pass_description="Contains light reflected by the objects in the active layer on the objects in all the other layers"
    octane_render_pass_sub_type_name=""
    octane_socket_class_list=[OctaneLayerReflectionsAOVEnabled,]
    octane_min_version=0
    octane_node_type=consts.NodeType.NT_AOV_LAYER_REFLECTIONS
