...
class OctanePositionAOV(bpy.types.Node, OctaneBaseNode):
    ...
    def init(self, context):
        self.inputs.new("OctanePositionAOVEnabled", OctanePositionAOVEnabled.bl_label)
        self.outputs.new("OctaneRenderAOVsOutSocket", "Render AOVs out")


def register():
    register_class(OctanePositionAOVEnabled)
    register_class(OctanePositionAOV)

def unregister():
    unregister_class(OctanePositionAOV)
    unregister_class(OctanePositionAOVEnabled)
