...
class OctaneReflectionAOV(bpy.types.Node, OctaneBaseNode):
    ...
    def init(self, context):
        self.inputs.new("OctaneReflectionAOVEnabled", OctaneReflectionAOVEnabled.bl_label)
        self.outputs.new("OctaneRenderAOVsOutSocket", "Render AOVs out")


def register():
    register_class(OctaneReflectionAOVEnabled)
    register_class(OctaneReflectionAOV)

def unregister():
    unregister_class(OctaneReflectionAOV)
    unregister_class(OctaneReflectionAOVEnabled)
