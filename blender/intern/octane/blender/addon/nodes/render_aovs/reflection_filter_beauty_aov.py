...
class OctaneReflectionFilterBeautyAOV(bpy.types.Node, OctaneBaseNode):
    ...
    def init(self, context):
        self.inputs.new("OctaneReflectionFilterBeautyAOVEnabled", OctaneReflectionFilterBeautyAOVEnabled.bl_label)
        self.outputs.new("OctaneRenderAOVsOutSocket", "Render AOVs out")


def register():
    register_class(OctaneReflectionFilterBeautyAOVEnabled)
    register_class(OctaneReflectionFilterBeautyAOV)

def unregister():
    unregister_class(OctaneReflectionFilterBeautyAOV)
    unregister_class(OctaneReflectionFilterBeautyAOVEnabled)
