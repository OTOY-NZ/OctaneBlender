...
class OctaneDiffuseFilterBeautyAOV(bpy.types.Node, OctaneBaseNode):
    ...
    def init(self, context):
        self.inputs.new("OctaneDiffuseFilterBeautyAOVEnabled", OctaneDiffuseFilterBeautyAOVEnabled.bl_label)
        self.outputs.new("OctaneRenderAOVsOutSocket", "Render AOVs out")


def register():
    register_class(OctaneDiffuseFilterBeautyAOVEnabled)
    register_class(OctaneDiffuseFilterBeautyAOV)

def unregister():
    unregister_class(OctaneDiffuseFilterBeautyAOV)
    unregister_class(OctaneDiffuseFilterBeautyAOVEnabled)
