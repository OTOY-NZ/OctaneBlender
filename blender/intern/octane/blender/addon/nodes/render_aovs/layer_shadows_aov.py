...
class OctaneLayerShadowsAOV(bpy.types.Node, OctaneBaseNode):
    ...
    def init(self, context):
        self.inputs.new("OctaneLayerShadowsAOVEnabled", OctaneLayerShadowsAOVEnabled.bl_label)
        self.outputs.new("OctaneRenderAOVsOutSocket", "Render AOVs out")


def register():
    register_class(OctaneLayerShadowsAOVEnabled)
    register_class(OctaneLayerShadowsAOV)

def unregister():
    unregister_class(OctaneLayerShadowsAOV)
    unregister_class(OctaneLayerShadowsAOVEnabled)
