...
class OctaneZDepthAOVEnvironmentDepth(OctaneBaseSocket):
    ...
    octane_pin_index=2
    octane_socket_type=consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=1000.000000, update=OctaneBaseSocket.update_node_tree, description="The Z-depth value that will be used for the environment/background", min=0.001000, max=1000000.000000, soft_min=0.001000, soft_max=10000.000000, step=1.000000, precision=3, subtype="NONE")
    octane_hide_value=False
