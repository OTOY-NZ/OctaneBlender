...
class OctaneGeometricNormalAOV(bpy.types.Node, OctaneBaseNode):
    ...
    def init(self, context):
        self.inputs.new("OctaneGeometricNormalAOVEnabled", OctaneGeometricNormalAOVEnabled.bl_label)
        self.outputs.new("OctaneRenderAOVsOutSocket", "Render AOVs out")


def register():
    register_class(OctaneGeometricNormalAOVEnabled)
    register_class(OctaneGeometricNormalAOV)

def unregister():
    unregister_class(OctaneGeometricNormalAOV)
    unregister_class(OctaneGeometricNormalAOVEnabled)
