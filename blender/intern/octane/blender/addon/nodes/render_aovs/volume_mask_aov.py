...
class OctaneVolumeMaskAOV(bpy.types.Node, OctaneBaseNode):
    ...
    def init(self, context):
        self.inputs.new("OctaneVolumeMaskAOVEnabled", OctaneVolumeMaskAOVEnabled.bl_label)
        self.outputs.new("OctaneRenderAOVsOutSocket", "Render AOVs out")


def register():
    register_class(OctaneVolumeMaskAOVEnabled)
    register_class(OctaneVolumeMaskAOV)

def unregister():
    unregister_class(OctaneVolumeMaskAOV)
    unregister_class(OctaneVolumeMaskAOVEnabled)
