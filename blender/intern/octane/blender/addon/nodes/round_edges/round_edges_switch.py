...
class OctaneRoundEdgesSwitchIndex(OctaneBaseSocket):
    bl_idname="OctaneRoundEdgesSwitchIndex"
    bl_label="Input"
...
class OctaneRoundEdgesSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname="OctaneRoundEdgesSwitch"
    bl_label="Round edges switch"
    ...
    octane_socket_class_list=[OctaneRoundEdgesSwitchIndex,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_SWITCH_ROUND_EDGES
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctaneRoundEdgesSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctaneRoundEdgesSwitchIndex", OctaneRoundEdgesSwitchIndex.bl_label).init()
...
_CLASSES=[
    OctaneRoundEdgesSwitchIndex,
    OctaneRoundEdgesSwitch,
]
