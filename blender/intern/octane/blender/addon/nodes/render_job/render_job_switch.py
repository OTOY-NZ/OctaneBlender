...
class OctaneRenderJobSwitchIndex(OctaneBaseSocket):
    bl_idname="OctaneRenderJobSwitchIndex"
    bl_label="Input"
...
class OctaneRenderJobSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname="OctaneRenderJobSwitch"
    bl_label="Render job switch"
    ...
    octane_socket_class_list=[OctaneRenderJobSwitchIndex,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_SWITCH_RENDER_JOB
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctaneRenderJobSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctaneRenderJobSwitchIndex", OctaneRenderJobSwitchIndex.bl_label).init()
        self.outputs.new("OctaneRenderJobOutSocket", "Render job out").init()
...
_CLASSES=[
    OctaneRenderJobSwitchIndex,
    OctaneRenderJobSwitch,
]
