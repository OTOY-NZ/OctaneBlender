...
class OctaneProjectionSwitchIndex(OctaneBaseSocket):
    bl_idname="OctaneProjectionSwitchIndex"
    bl_label="Input"
...
class OctaneProjectionSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname="OctaneProjectionSwitch"
    bl_label="Projection switch"
    ...
    octane_socket_class_list=[OctaneProjectionSwitchIndex,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_SWITCH_PROJECTION
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctaneProjectionSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctaneProjectionSwitchIndex", OctaneProjectionSwitchIndex.bl_label).init()
...
_CLASSES=[
    OctaneProjectionSwitchIndex,
    OctaneProjectionSwitch,
]
