...
class OctaneSpherical(bpy.types.Node, OctaneBaseNode):
    ...
    octane_socket_class_list=[OctaneSphericalTransform,OctaneSphericalPositionType,]
    octane_min_version=0
    octane_node_type=consts.NodeType.NT_PROJ_SPHERICAL
    octane_socket_list=["Sphere transformation", "Coordinate space", ]
    octane_attribute_list=[]
    octane_attribute_config={}
    octane_static_pin_count=2

    def init(self, context):
        self.inputs.new("OctaneSphericalTransform", OctaneSphericalTransform.bl_label).init()
        self.inputs.new("OctaneSphericalPositionType", OctaneSphericalPositionType.bl_label).init()
...
_CLASSES=[
    OctaneSphericalTransform,
    OctaneSphericalPositionType,
    OctaneSpherical,
]
