...
class OctaneSDFIntersectSize(OctaneBaseSocket):
    bl_idname="OctaneSDFIntersectSize"
    bl_label="Bounds"
...
class OctaneSDFIntersectInput1(OctaneBaseSocket):
    bl_idname="OctaneSDFIntersectInput1"
    bl_label="Input 1"
...
class OctaneSDFIntersectInput2(OctaneBaseSocket):
    bl_idname="OctaneSDFIntersectInput2"
    bl_label="Input 2"
    color=consts.OctanePinColor.Geometry
    octane_default_node_type=consts.NodeType.NT_UNKNOWN
    octane_default_node_name=""
...
class OctaneSDFIntersectRadius(OctaneBaseSocket):
    bl_idname="OctaneSDFIntersectRadius"
    bl_label="Radius"
    color=consts.OctanePinColor.Float
...
class OctaneSDFIntersectTransferMaterial(OctaneBaseSocket):
    bl_idname="OctaneSDFIntersectTransferMaterial"
...
class OctaneSDFIntersect(bpy.types.Node, OctaneBaseNode):
    bl_idname="OctaneSDFIntersect"
    bl_label="Intersect"
    ...
    octane_socket_class_list=[OctaneSDFIntersectSize,OctaneSDFIntersectInput1,OctaneSDFIntersectInput2,OctaneSDFIntersectRadius,OctaneSDFIntersectTransferMaterial,]
    octane_min_version=12000002
    octane_node_type=consts.NodeType.NT_GEO_SDF_INTERSECT
    ...
    def init(self, context):
        self.inputs.new("OctaneSDFIntersectSize", OctaneSDFIntersectSize.bl_label).init()
        self.inputs.new("OctaneSDFIntersectInput1", OctaneSDFIntersectInput1.bl_label).init()
        self.inputs.new("OctaneSDFIntersectInput2", OctaneSDFIntersectInput2.bl_label).init()
        self.inputs.new("OctaneSDFIntersectRadius", OctaneSDFIntersectRadius.bl_label).init()
...
_CLASSES=[
    ...
    OctaneSDFIntersectInput1,
    OctaneSDFIntersectInput2,
    OctaneSDFIntersectRadius,
    OctaneSDFIntersectTransferMaterial,
    OctaneSDFIntersect,
]
