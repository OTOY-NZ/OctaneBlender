...
class OctaneSDFPrismPolygonSides(OctaneBaseSocket):
    ...
    default_value: IntProperty(default=6, update=OctaneBaseSocket.update_node_tree, description="", min=3, max=8, soft_min=3, soft_max=8, step=1, subtype=consts.factor_property_subtype())
