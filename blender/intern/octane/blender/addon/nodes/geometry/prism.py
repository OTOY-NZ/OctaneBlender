...
class OctaneSDFPrismPolygonSides(OctaneBaseSocket):
    ...
    default_value: IntProperty(default=6, update=OctaneBaseSocket.update_node_tree, description="", min=3, max=8, soft_min=3, soft_max=8, step=1, subtype="FACTOR")
...
class OctaneSDFPrismRoundBaseRadius(OctaneBaseSocket):
    ...
    octane_pin_index=6
    octane_socket_type=consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=0.000000, update=OctaneBaseSocket.update_node_tree, description="Rounds the base polygon. Rounds vertical edges without rounding the horizontal edges", min=0.000000, max=1.000000, soft_min=0.000000, soft_max=1.000000, step=1, precision=2, subtype="FACTOR")
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False
