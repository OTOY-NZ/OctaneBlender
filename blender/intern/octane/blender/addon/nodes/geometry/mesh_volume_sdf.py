...
class OctaneMeshVolumeSDF(bpy.types.Node, OctaneBaseNode):
    ...
    octane_attribute_name_list: StringProperty(name="Attribute Name List", default="filename;reload;userInstanceId;scaleUnitType;volumeIsoValue;volumeAbsorptionId;volumeAbsorptionScale;volumeScatterId;volumeScatteringScale;volumeEmissionId;volumeEmissionScale;volumeVelocityId;volumeVelocityIdX;volumeVelocityIdY;volumeVelocityIdZ;volumeVelocityScale;volumeMotionBlurEnabled;voxelSize;borderWidth;windingOrder;constantTopology;verticesPerPoly;vertices;polyVertexIndices;volumeLeaves;volumeNodes;volumeAbsorptionOffset;volumeAbsorptionMax;volumeAbsorptionDefault;volumeScatterOffset;volumeScatterMax;volumeScatterDefault;volumeEmissionOffset;volumeEmissionMax;volumeEmissionDefault;volumeVelocityOffsetX;volumeVelocityOffsetY;volumeVelocityOffsetZ;volumeVelocityDefault;volumeRegularGrid;volumeResolution;")
