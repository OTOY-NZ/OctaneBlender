...
class OctaneScatter(bpy.types.Node, OctaneBaseNode):
    ...
    def init(self, context):
        self.inputs.new("OctaneScatterGeometry", OctaneScatterGeometry.bl_label)
        self.outputs.new("OctaneGeometryOutSocket", "Geometry out")


def register():
    register_class(OctaneScatterGeometry)
    register_class(OctaneScatter)

def unregister():
    unregister_class(OctaneScatter)
    unregister_class(OctaneScatterGeometry)
