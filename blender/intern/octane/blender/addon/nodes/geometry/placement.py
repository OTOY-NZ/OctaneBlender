...
class OctanePlacement(bpy.types.Node, OctaneBaseNode):
    ...
    octane_socket_class_list=[OctanePlacementTransform,OctanePlacementGeometry,]
    octane_min_version=0
    octane_node_type=consts.NodeType.NT_GEO_PLACEMENT
    octane_socket_list=["Transformation", "Geometry", ]
