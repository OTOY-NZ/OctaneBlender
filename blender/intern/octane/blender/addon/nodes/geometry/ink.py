...
class OctaneSDFInkSize(OctaneBaseSocket):
    bl_idname = "OctaneSDFInkSize"
    bl_label = "Bounds"
...
class OctaneSDFInkInput1(OctaneBaseSocket):
    bl_idname = "OctaneSDFInkInput1"
    bl_label = "Input 1"
...
class OctaneSDFInkInput2(OctaneBaseSocket):
    bl_idname = "OctaneSDFInkInput2"
    bl_label = "Input 2"
    color = consts.OctanePinColor.Geometry
    octane_default_node_type = consts.NodeType.NT_UNKNOWN
    octane_default_node_name = ""
...
class OctaneSDFInkRadius(OctaneBaseSocket):
    bl_idname = "OctaneSDFInkRadius"
    bl_label = "Radius"
    color = consts.OctanePinColor.Float
...
class OctaneSDFInk(bpy.types.Node, OctaneBaseNode):
    bl_idname = "OctaneSDFInk"
    bl_label = "Ink"
    ...
    octane_socket_class_list = [OctaneSDFInkSize, OctaneSDFInkInput1, OctaneSDFInkInput2, OctaneSDFInkRadius, ]
    octane_min_version = 12000002
    octane_node_type = consts.NodeType.NT_GEO_SDF_INK
    ...
    def init(self, context):  # noqa
        self.inputs.new("OctaneSDFInkSize", OctaneSDFInkSize.bl_label).init()
        self.inputs.new("OctaneSDFInkInput1", OctaneSDFInkInput1.bl_label).init()
        self.inputs.new("OctaneSDFInkInput2", OctaneSDFInkInput2.bl_label).init()
