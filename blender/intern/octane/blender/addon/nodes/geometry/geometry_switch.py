...
class OctaneGeometrySwitchIndex(OctaneBaseSocket):
    bl_idname = "OctaneGeometrySwitchIndex"
    bl_label = "Input"
...
class OctaneGeometrySwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname = "OctaneGeometrySwitch"
    bl_label = "Geometry switch"
    ...
    octane_socket_class_list = [OctaneGeometrySwitchIndex, ]
    octane_min_version = 13000000
    octane_node_type = consts.NodeType.NT_SWITCH_GEOMETRY
    ...
    INPUT_SOCKET_CLASS = base_switch_input_socket.OctaneGeometrySwitchInputSocket
    ...
    def init(self, context):  # noqa
        self.inputs.new("OctaneGeometrySwitchIndex", OctaneGeometrySwitchIndex.bl_label).init()
...
_CLASSES = [
    OctaneGeometrySwitchIndex,
    OctaneGeometrySwitch,
]
