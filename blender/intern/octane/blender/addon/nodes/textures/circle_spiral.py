...
class OctaneCircleSpiralCircleCount(OctaneBaseSocket):
    ...
    default_value: IntProperty(default=100, update=OctaneBaseSocket.update_node_tree, description="The number of points in the spiral", min=1, max=1000, soft_min=1, soft_max=1000, step=1, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneCircleSpiralRadius1(OctaneBaseSocket):
    ...
    default_value: FloatProperty(default=0.500000, update=OctaneBaseSocket.update_node_tree, description="The size of the spiral", min=0.000000, max=5.000000, soft_min=0.000000, soft_max=5.000000, step=1.000000, precision=2, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneCircleSpiralRadius2(OctaneBaseSocket):
    ...
    octane_pin_index = 4
    octane_socket_type = consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=0.010000, update=OctaneBaseSocket.update_node_tree, description="The size of the circles", min=0.000000, max=0.100000, soft_min=0.000000, soft_max=0.100000, step=1.000000, precision=2, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneCircleSpiralTime(OctaneBaseSocket):
    ...
    octane_pin_index = 5
    octane_socket_type = consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=0.000000, update=OctaneBaseSocket.update_node_tree, description="Change the time to animate the effect", min=0.000000, max=1.000000, soft_min=0.000000, soft_max=1.000000, step=1.000000, precision=2, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
