...
class OctaneTextureSwitchIndex(OctaneBaseSocket):
    bl_idname="OctaneTextureSwitchIndex"
    bl_label="Input"
...
class OctaneTextureSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname="OctaneTextureSwitch"
    bl_label="Texture switch"
    ...
    octane_socket_class_list=[OctaneTextureSwitchIndex,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_SWITCH_TEXTURE
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctaneTextureSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctaneTextureSwitchIndex", OctaneTextureSwitchIndex.bl_label).init()
