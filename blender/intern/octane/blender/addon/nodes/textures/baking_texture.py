...
class OctaneBakingTextureSamplingRate(OctaneBaseSocket):
    ...
    default_value: IntProperty(default=32, update=OctaneBaseSocket.update_node_tree, description="Current samples/px used for the baked texture", min=1, max=10000, soft_min=1, soft_max=1000, step=1, subtype="NONE")
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
