...
class OctaneSnowEffectRadius(OctaneBaseSocket):
    ...
    octane_pin_index = 1
    octane_socket_type = consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=0.012000, update=OctaneBaseSocket.update_node_tree, description="The size of the snow flakes", min=0.000000, max=1.000000, soft_min=0.000000, soft_max=1.000000, step=1.000000, precision=3, subtype="NONE")
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneSnowEffectDensity(OctaneBaseSocket):
    ...
    default_value: IntProperty(default=200, update=OctaneBaseSocket.update_node_tree, description="The number of snow flakes", min=1, max=10000, soft_min=1, soft_max=2000, step=1, subtype="NONE")
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
...
class OctaneSnowEffectStrength(OctaneBaseSocket):
    ...
    octane_pin_index = 3
    octane_socket_type = consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=0.100000, update=OctaneBaseSocket.update_node_tree, description="Determines the direction and shape of the snow flakes", min=-10.000000, max=10.000000, soft_min=-10.000000, soft_max=10.000000, step=1.000000, precision=2, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
