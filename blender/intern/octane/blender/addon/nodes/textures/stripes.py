...
class OctaneStripesBlur(OctaneBaseSocket):
    ...
    default_value: FloatProperty(default=0.025000, update=None, description="Blur", min=0.000000, max=1.000000, soft_min=0.000000, soft_max=1.000000, step=1, precision=2, subtype="FACTOR")
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False
