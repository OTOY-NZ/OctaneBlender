...
class OctaneMultiplyTextureTexture2(OctaneBaseSocket):
    ...
    default_value: FloatProperty(default=1.000000, update=None, description="The second texture that will be multiplied. White by default", min=-340282346638528859811704183484516925440.000000, max=340282346638528859811704183484516925440.000000, soft_min=0.000000, soft_max=1.000000, subtype="FACTOR")
...
class OctaneMultiplyTexture(bpy.types.Node, OctaneBaseNode):
    ...
    def init(self, context):
        self.inputs.new("OctaneMultiplyTextureTexture1", OctaneMultiplyTextureTexture1.bl_label).init()
        self.inputs.new("OctaneMultiplyTextureTexture2", OctaneMultiplyTextureTexture2.bl_label).init()
        self.outputs.new("OctaneTextureOutSocket", "Texture out").init()


_CLASSES=[
    OctaneMultiplyTextureTexture1,
    OctaneMultiplyTextureTexture2,
