...
class OctaneMultiplyTextureTexture2(OctaneBaseSocket):
    ...
    default_value: FloatProperty(default=1.000000, update=None, description="The second texture that will be multiplied. White by default", min=0.000000, max=1.000000, soft_min=0.000000, soft_max=1.000000, subtype="FACTOR")
