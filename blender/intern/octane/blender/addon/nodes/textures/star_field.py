...
class OctaneStarFieldDensity(OctaneBaseSocket):
    ...
    default_value: FloatProperty(default=0.001000, update=OctaneBaseSocket.update_node_tree, description="The density of the star field", min=0.000000, max=1.000000, soft_min=0.000000, soft_max=1.000000, step=1, precision=3, subtype="NONE")
