...
class OctaneAlphaImageBorderModeU(OctaneBaseSocket):
    bl_idname="OctaneAlphaImageBorderModeU"
...
class OctaneAlphaImageBorderModeV(OctaneBaseSocket):
    bl_idname="OctaneAlphaImageBorderModeV"
...
class OctaneAlphaImage(bpy.types.Node, OctaneBaseImageNode):
    ...
    octane_socket_class_list=[OctaneAlphaImagePower,OctaneAlphaImageColorSpace,OctaneAlphaImageGamma,OctaneAlphaImageInvert,OctaneAlphaImageLinearSpaceInvert,OctaneAlphaImageTransform,OctaneAlphaImageProjection,OctaneAlphaImageBorderModeU,OctaneAlphaImageBorderModeV,OctaneAlphaImageScale,OctaneAlphaImageBorderMode,]
    octane_min_version=0
    octane_node_type=consts.NodeType.NT_TEX_ALPHAIMAGE
    ...
    def init(self, context):
        ...
        self.inputs.new("OctaneAlphaImageBorderModeU", OctaneAlphaImageBorderModeU.bl_label).init()
        self.inputs.new("OctaneAlphaImageBorderModeV", OctaneAlphaImageBorderModeV.bl_label).init()
...
_CLASSES=[
    ...
    OctaneAlphaImageBorderModeU,
    OctaneAlphaImageBorderModeV,
...
class OctaneAlphaImage_Override(OctaneAlphaImage):
...
OctaneAlphaImage_Override.update_node_definition()
utility.override_class(_CLASSES, OctaneAlphaImage, OctaneAlphaImage_Override)