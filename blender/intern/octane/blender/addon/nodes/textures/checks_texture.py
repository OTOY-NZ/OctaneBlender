...
class OctaneChecksTexture(bpy.types.Node, OctaneBaseNode):
    ...
    octane_socket_class_list = [OctaneChecksTextureTransform, OctaneChecksTextureProjection, ]
    octane_min_version = 0
    octane_node_type = consts.NodeType.NT_TEX_CHECKS
    octane_socket_list = ["UVW transform", "Projection", ]
