...
class OctaneAngularFieldAngle2(OctaneBaseSocket):
    ...
    default_value: FloatProperty(default=45.000000, update=OctaneBaseSocket.update_node_tree, description="Angular range of the core sector in which the value is one", min=0.000000, max=360.000000, soft_min=0.000000, soft_max=360.000000, step=1.000000, precision=2, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
