...
class OctaneObjectLayerColor(bpy.types.Node, OctaneBaseNode):
    bl_idname="OctaneObjectLayerColor"
    ...
    octane_node_type=consts.NodeType.NT_TEX_OBJECT_LAYER_COLOR
    octane_socket_list=[]
