...
class OctaneRandomColorTextureRandomSeed(OctaneBaseSocket):
    ...
    default_value: IntProperty(default=0, update=OctaneBaseSocket.update_node_tree, description="Random seed", min=0, max=65535, soft_min=0, soft_max=65535, step=1, subtype=consts.factor_property_subtype())
