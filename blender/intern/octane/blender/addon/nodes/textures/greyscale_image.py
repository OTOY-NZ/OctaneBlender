...
class OctaneGreyscaleImageBorderModeU(OctaneBaseSocket):
    bl_idname="OctaneGreyscaleImageBorderModeU"
...
class OctaneGreyscaleImageBorderModeV(OctaneBaseSocket):
    bl_idname="OctaneGreyscaleImageBorderModeV"
...
class OctaneGreyscaleImage(bpy.types.Node, OctaneBaseImageNode):
    ...
    def init(self, context):
        ...
        self.inputs.new("OctaneGreyscaleImageBorderModeU", OctaneGreyscaleImageBorderModeU.bl_label).init()
        self.inputs.new("OctaneGreyscaleImageBorderModeV", OctaneGreyscaleImageBorderModeV.bl_label).init()
...
_CLASSES=[
    ...
    OctaneGreyscaleImageBorderModeU,
    OctaneGreyscaleImageBorderModeV,
...
class OctaneGreyscaleImage_Override(OctaneGreyscaleImage):
...
OctaneGreyscaleImage_Override.update_node_definition()
utility.override_class(_CLASSES, OctaneGreyscaleImage, OctaneGreyscaleImage_Override)