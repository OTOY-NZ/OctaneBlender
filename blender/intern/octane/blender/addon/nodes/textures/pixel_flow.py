...
class OctanePixelFlowFrequency(OctaneBaseSocket):
    ...
    default_value: FloatVectorProperty(default=(50.000000, 100.000000), update=OctaneBaseSocket.update_node_tree, description="The horizontal and vertical frequency of the effect", min=10.000000, max=1000.000000, soft_min=10.000000, soft_max=1000.000000, step=1, subtype="NONE", precision=2, size=2)
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False
