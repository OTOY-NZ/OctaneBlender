...
class OctaneFractal(bpy.types.Node, OctaneBaseNode):
    ...
    def init(self, context):
        self.inputs.new("OctaneFractalTransform", OctaneFractalTransform.bl_label).init()
        self.inputs.new("OctaneFractalProjection", OctaneFractalProjection.bl_label).init()
        self.outputs.new("OctaneTextureOutSocket", "Texture out").init()


_CLASSES=[
    OctaneFractalTransform,
    OctaneFractalProjection,
    OctaneFractal,
]
