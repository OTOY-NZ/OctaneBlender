...
class OctaneHagelslagDensity(OctaneBaseSocket):
    ...
    default_value: IntProperty(default=4, update=OctaneBaseSocket.update_node_tree, description="Density", min=1, max=7, soft_min=1, soft_max=7, step=1, subtype=consts.factor_property_subtype())
