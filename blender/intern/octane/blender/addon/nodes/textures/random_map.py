...
class OctaneRandomMapInputScale(OctaneBaseSocket):
    ...
    default_value: IntProperty(default=1, update=OctaneBaseSocket.update_node_tree, description="Scale factor for the input texture values", min=1, max=65536, soft_min=1, soft_max=65536, step=1, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
