...
class OctaneSmoothVoronoiContoursFrequency(OctaneBaseSocket):
    ...
    default_value: FloatProperty(default=12.000000, update=OctaneBaseSocket.update_node_tree, description="Frequency", min=1.000000, max=100.000000, soft_min=1.000000, soft_max=100.000000, step=1, precision=2, subtype=consts.factor_property_subtype())
