...
class OctaneChainmailRadius(OctaneBaseSocket):
    ...
    default_value: FloatProperty(default=0.470000, update=OctaneBaseSocket.update_node_tree, description="Ring radius", min=0.000000, max=2.000000, soft_min=0.000000, soft_max=2.000000, step=1.000000, precision=2, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
...
class OctaneChainmailLineWidth(OctaneBaseSocket):
    ...
    octane_pin_index = 1
    octane_socket_type = consts.SocketType.ST_FLOAT
    default_value: FloatProperty(default=0.080000, update=OctaneBaseSocket.update_node_tree, description="Ring width", min=0.000000, max=0.200000, soft_min=0.000000, soft_max=0.200000, step=1.000000, precision=2, subtype=runtime_globals.FACTOR_PROPERTY_SUBTYPE)
    octane_hide_value = False
    octane_min_version = 0
    octane_end_version = 4294967295
    octane_deprecated = False
