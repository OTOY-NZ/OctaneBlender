...
class OctaneSineWaveTextureOffset(OctaneBaseSocket):
    ...
    default_value: FloatProperty(default=0.000000, update=OctaneBaseSocket.update_node_tree, description="Coordinate offset", min=-340282346638528859811704183484516925440.000000, max=340282346638528859811704183484516925440.000000, soft_min=0.000000, soft_max=1.000000, subtype=consts.factor_property_subtype())
...
class OctaneSineWaveTexture(bpy.types.Node, OctaneBaseNode):
    ...
    def init(self, context):
        self.inputs.new("OctaneSineWaveTextureOffset", OctaneSineWaveTextureOffset.bl_label).init()
        self.inputs.new("OctaneSineWaveTextureTransform", OctaneSineWaveTextureTransform.bl_label).init()
        self.inputs.new("OctaneSineWaveTextureProjection", OctaneSineWaveTextureProjection.bl_label).init()
        self.inputs.new("OctaneSineWaveTextureCircular", OctaneSineWaveTextureCircular.bl_label).init()
...
_CLASSES=[
    OctaneSineWaveTextureOffset,
    OctaneSineWaveTextureTransform,
    OctaneSineWaveTextureProjection,
    OctaneSineWaveTextureCircular,
