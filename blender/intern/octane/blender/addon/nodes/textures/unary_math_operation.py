...
class OctaneUnaryMathOperationOperationType(OctaneBaseSocket):
    ...
    default_value: EnumProperty(default="Absolute value", description="The operation to perform on the input", items=items)
...
class OctaneUnaryMathOperation(bpy.types.Node, OctaneBaseNode):
    ...
    def init(self, context):
        self.inputs.new("OctaneUnaryMathOperationTexture", OctaneUnaryMathOperationTexture.bl_label)
        self.inputs.new("OctaneUnaryMathOperationOperationType", OctaneUnaryMathOperationOperationType.bl_label)
        self.outputs.new("OctaneTextureOutSocket", "Texture out")


def register():
    register_class(OctaneUnaryMathOperationTexture)
    register_class(OctaneUnaryMathOperationOperationType)
    register_class(OctaneUnaryMathOperation)

def unregister():
    unregister_class(OctaneUnaryMathOperation)
    unregister_class(OctaneUnaryMathOperationOperationType)
    unregister_class(OctaneUnaryMathOperationTexture)
