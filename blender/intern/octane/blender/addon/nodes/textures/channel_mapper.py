...
class OctaneChannelMapperIndex(OctaneBaseSocket):
    ...
    default_value: IntProperty(default=0, update=OctaneBaseSocket.update_node_tree, description="The input channel index to map to the red output channel", min=0, max=2, soft_min=0, soft_max=2, step=1, subtype=consts.factor_property_subtype())
...
class OctaneChannelMapperIndex2(OctaneBaseSocket):
    ...
    octane_pin_index=2
    octane_socket_type=consts.SocketType.ST_INT
    default_value: IntProperty(default=1, update=OctaneBaseSocket.update_node_tree, description="The input channel index to map to the green output channel", min=0, max=2, soft_min=0, soft_max=2, step=1, subtype=consts.factor_property_subtype())
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False
...
class OctaneChannelMapperIndex3(OctaneBaseSocket):
    ...
    octane_pin_index=3
    octane_socket_type=consts.SocketType.ST_INT
    default_value: IntProperty(default=2, update=OctaneBaseSocket.update_node_tree, description="The input channel index to map to the blue output channel", min=0, max=2, soft_min=0, soft_max=2, step=1, subtype=consts.factor_property_subtype())
    octane_hide_value=False
    octane_min_version=0
    octane_end_version=4294967295
    octane_deprecated=False
