...
class OctaneDisplacementSwitchIndex(OctaneBaseSocket):
    bl_idname="OctaneDisplacementSwitchIndex"
    bl_label="Input"
...
class OctaneDisplacementSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname="OctaneDisplacementSwitch"
    bl_label="Displacement switch"
    ...
    octane_socket_class_list=[OctaneDisplacementSwitchIndex,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_SWITCH_DISPLACEMENT
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctaneDisplacementSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctaneDisplacementSwitchIndex", OctaneDisplacementSwitchIndex.bl_label).init()
...
_CLASSES=[
    OctaneDisplacementSwitchIndex,
    OctaneDisplacementSwitch,
]
