...
class OctaneObjectLayerSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctaneObjectLayerSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctaneObjectLayerSwitchIndex", OctaneObjectLayerSwitchIndex.bl_label).init()
...
_CLASSES=[
    OctaneObjectLayerSwitchIndex,
    OctaneObjectLayerSwitch,
]
