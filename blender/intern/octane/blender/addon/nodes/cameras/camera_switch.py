...
class OctaneCameraSwitchIndex(OctaneBaseSocket):
    bl_idname="OctaneCameraSwitchIndex"
    bl_label="Input"
...
class OctaneCameraSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname="OctaneCameraSwitch"
    bl_label="Camera switch"
    ...
    octane_socket_class_list=[OctaneCameraSwitchIndex,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_SWITCH_CAMERA
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctaneCameraSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctaneCameraSwitchIndex", OctaneCameraSwitchIndex.bl_label).init()
