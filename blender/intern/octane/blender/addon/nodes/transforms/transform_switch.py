...
class OctaneTransformSwitchIndex(OctaneBaseSocket):
    bl_idname="OctaneTransformSwitchIndex"
    bl_label="Input"
...
class OctaneTransformSwitch(bpy.types.Node, OctaneBaseSwitchNode):
    bl_idname="OctaneTransformSwitch"
    bl_label="Transform switch"
    ...
    octane_socket_class_list=[OctaneTransformSwitchIndex,]
    octane_min_version=13000000
    octane_node_type=consts.NodeType.NT_SWITCH_TRANSFORM
    ...
    INPUT_SOCKET_CLASS=base_switch_input_socket.OctaneTransformSwitchInputSocket
    ...
    def init(self, context):
        self.inputs.new("OctaneTransformSwitchIndex", OctaneTransformSwitchIndex.bl_label).init()
...
_CLASSES=[
    OctaneTransformSwitchIndex,
    OctaneTransformSwitch,
]
