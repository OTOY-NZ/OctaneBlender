...
otc_device bool ray_sphere_intersect(float3 ray_P,
                                     float3 ray_D,
                                     float ray_t,
                                     float3 sphere_P,
                                     float sphere_radius,
...
otc_device bool ray_aligned_disk_intersect(float3 ray_P,
                                           float3 ray_D,
                                           float ray_t,
                                           float3 disk_P,
                                           float disk_radius,
...
otc_device_forceinline bool ray_triangle_intersect(float3 ray_P,
                                                   float3 ray_dir,
                                                   float ray_t,
 ...
 * quad are rejected.
 */
otc_device bool ray_quad_intersect(float3 ray_P,
                                   float3 ray_D,
                                   float ray_mint,
                                   float ray_maxt,
                                   float3 quad_P,
