...
oct_device_inline float4 zero_float4()
{
...
oct_device_inline float4 one_float4()
{
  return make_float4(1.0f, 1.0f, 1.0f, 1.0f);
}

oct_device_inline int4 cast(const float4 a)
{
#ifdef __KERNEL_SSE__
...
oct_device_inline float4 operator-(const float4 &a)
{
#  ifdef __KERNEL_SSE__
...
oct_device_inline float4 operator*(const float4 a, const float4 b)
{
#  ifdef __KERNEL_SSE__
...
oct_device_inline float4 operator*(const float4 a, float f)
{
...
oct_device_inline float4 operator*(float f, const float4 a)
{
  return a * f;
}
...
oct_device_inline float4 operator+(const float4 a, const float f)
{
  return a + make_float4(f);
}
...
oct_device_inline float4 operator+=(float4 &a, const float4 b)
{
  return a = a + b;
}
...
oct_device_inline float4 operator*=(float4 &a, float f)
{
  return a = a * f;
}
...
oct_device_inline int4 operator<(const float4 a, const float4 b)
{
#  ifdef __KERNEL_SSE__
...
oct_device_inline bool operator==(const float4 a, const float4 b)
{
#  ifdef __KERNEL_SSE__
...
oct_device_inline const float4 operator^(const float4 a, const float4 b)
{
#  ifdef __KERNEL_SSE__
...
oct_device_inline float4 min(const float4 a, const float4 b)
{
#  ifdef __KERNEL_SSE__
...
oct_device_inline float4 max(const float4 a, const float4 b)
{
#  ifdef __KERNEL_SSE__
...
oct_device_inline float4 clamp(const float4 a, const float4 mn, const float4 mx)
{
  return min(max(a, mn), mx);
}
#endif /* !__KERNEL_METAL__*/

oct_device_inline const float4 madd(const float4 a, const float4 b, const float4 c)
{
#ifdef __KERNEL_SSE__
...
oct_device_inline float4 msub(const float4 a, const float4 b, const float4 c)
{
#ifdef __KERNEL_SSE__
#  ifdef __KERNEL_NEON__
...
oct_device_inline float reduce_add(const float4 a)
{
#if defined(__KERNEL_SSE__)
...
oct_device_inline float reduce_min(const float4 a)
{
#if defined(__KERNEL_SSE__)
#  if defined(__KERNEL_NEON__)
  return vminvq_f32(a);
...
oct_device_inline float reduce_max(const float4 a)
{
#if defined(__KERNEL_SSE__)
#  if defined(__KERNEL_NEON__)
  return vmaxvq_f32(a);
...
#if !defined(__KERNEL_METAL__)
oct_device_inline float dot(const float4 a, const float4 b)
{
...
oct_device_inline float len(const float4 a)
{
  return sqrtf(dot(a, a));
}

oct_device_inline float len_squared(const float4 a)
{
  return dot(a, a);
}

#if !defined(__KERNEL_METAL__)
oct_device_inline float distance(const float4 a, const float4 b)
{
  return len(a - b);
}

oct_device_inline float4 rcp(const float4 a)
{
#  ifdef __KERNEL_SSE__
...
oct_device_inline float4 sqrt(const float4 a)
{
#  ifdef __KERNEL_SSE__
...
oct_device_inline float4 sqr(const float4 a)
{
  return a * a;
}

oct_device_inline float4 cross(const float4 a, const float4 b)
{
#  ifdef __KERNEL_SSE__
...
oct_device_inline bool is_zero(const float4 a)
{
#  ifdef __KERNEL_SSE__
...
oct_device_inline float average(const float4 a)
{
  return reduce_add(a) * 0.25f;
}

oct_device_inline float4 normalize(const float4 a)
{
  return a / len(a);
}

oct_device_inline float4 safe_normalize(const float4 a)
{
  float t = len(a);
  return (t != 0.0f) ? a / t : a;
}

oct_device_inline float4 fabs(const float4 a)
{
#  if defined(__KERNEL_SSE__)
#    if defined(__KERNEL_NEON__)
...
oct_device_inline float4 floor(const float4 a)
{
#  ifdef __KERNEL_SSE__
#    if defined(__KERNEL_NEON__)
...
oct_device_inline float4 floorfrac(const float4 x, oct_private int4 *i)
{
#  ifdef __KERNEL_SSE__
...
oct_device_inline float4 mix(const float4 a, const float4 b, float t)
{
  return a + t * (b - a);
}

oct_device_inline float4 mix(const float4 a, const float4 b, const float4 t)
{
  return a + t * (b - a);
}

oct_device_inline float4 saturate(const float4 a)
{
  return make_float4(saturatef(a.x), saturatef(a.y), saturatef(a.z), saturatef(a.w));
}

oct_device_inline float4 exp(float4 v)
{
  return make_float4(expf(v.x), expf(v.y), expf(v.z), expf(v.z));
}

oct_device_inline float4 log(float4 v)
{
...
oct_device_inline bool isequal(const float4 a, const float4 b)
{
#if defined(__KERNEL_METAL__)
  return all(a == b);
#else
...
oct_device_inline float4 select(const int4 mask, const float4 a, const float4 b)
{
#  ifdef __KERNEL_SSE__
...
oct_device_inline float4 mask(const int4 mask, const float4 a)
{
  /* Replace elements of x with zero where mask isn't set. */
  return select(mask, a, zero_float4());
}

oct_device_inline float4 load_float4(oct_private const float *v)
{
#  ifdef __KERNEL_SSE__
...
oct_device_inline float4 safe_divide(const float4 a, const float b)
{
  return (b != 0.0f) ? a / b : zero_float4();
}

oct_device_inline float4 safe_divide(const float4 a, const float4 b)
{
...
oct_device_inline bool isfinite_safe(float4 v)
{
  return isfinite_safe(v.x) && isfinite_safe(v.y) && isfinite_safe(v.z) && isfinite_safe(v.w);
}

oct_device_inline float4 ensure_finite(float4 v)
{
...
oct_device_inline float4 pow(float4 v, float e)
{
