...
oct_device_inline int3 make_int3(int x, int y, int z);
#endif /* __KERNEL_NATIVE_VECTOR_TYPES__ */

oct_device_inline int3 make_int3(int i);
oct_device_inline void print_int3(oct_private const char *label, const int3 a);
...
struct packed_int3 {
  ...
  oct_device_inline_method packed_int3(){};

  oct_device_inline_method packed_int3(const int px, const int py, const int pz)
      : x(px), y(py), z(pz){};

  oct_device_inline_method packed_int3(const int3 &a) : x(a.x), y(a.y), z(a.z) {}

  oct_device_inline_method operator int3() const
  {
    return make_int3(x, y, z);
  }

  oct_device_inline_method packed_int3 &operator=(const int3 &a)
  {
    x = a.x;
    y = a.y;
    z = a.z;
