...
otc_device_inline int4 operator+(const int4 &a, const int4 &b);
otc_device_inline int4 operator+=(int4 &a, const int4 &b);
otc_device_inline int4 operator>>(const int4 &a, int i);
otc_device_inline int4 operator<<(const int4 &a, int i);
otc_device_inline int4 operator<(const int4 &a, const int4 &b);
otc_device_inline int4 operator>=(const int4 &a, const int4 &b);
otc_device_inline int4 operator&(const int4 &a, const int4 &b);
otc_device_inline int4 min(int4 a, int4 b);
otc_device_inline int4 max(int4 a, int4 b);
otc_device_inline int4 clamp(const int4 &a, const int4 &mn, const int4 &mx);
otc_device_inline int4 select(const int4 &mask, const int4 &a, const int4 &b);
...
otc_device_inline int4 load_int4(const int *v)
{
#  ifdef __KERNEL_SSE__
