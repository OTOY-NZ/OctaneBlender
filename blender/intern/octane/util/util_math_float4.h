...
otc_device_inline float4 operator-(const float4 &a);
otc_device_inline float4 operator*(const float4 &a, const float4 &b);
otc_device_inline float4 operator*(const float4 &a, float f);
otc_device_inline float4 operator*(float f, const float4 &a);
otc_device_inline float4 operator/(const float4 &a, float f);
otc_device_inline float4 operator/(const float4 &a, const float4 &b);
otc_device_inline float4 operator+(const float4 &a, const float4 &b);
otc_device_inline float4 operator-(const float4 &a, const float4 &b);
otc_device_inline float4 operator+=(float4 &a, const float4 &b);
otc_device_inline float4 operator*=(float4 &a, const float4 &b);
otc_device_inline float4 operator*=(float4 &a, float f);
otc_device_inline float4 operator/=(float4 &a, float f);

otc_device_inline int4 operator<(const float4 &a, const float4 &b);
otc_device_inline int4 operator>=(const float4 &a, const float4 &b);
otc_device_inline int4 operator<=(const float4 &a, const float4 &b);
otc_device_inline bool operator==(const float4 &a, const float4 &b);

otc_device_inline float dot(const float4 &a, const float4 &b);
otc_device_inline float len_squared(const float4 &a);
otc_device_inline float4 rcp(const float4 &a);
otc_device_inline float4 sqrt(const float4 &a);
otc_device_inline float4 sqr(const float4 &a);
otc_device_inline float4 cross(const float4 &a, const float4 &b);
otc_device_inline bool is_zero(const float4 &a);
otc_device_inline float average(const float4 &a);
otc_device_inline float len(const float4 &a);
otc_device_inline float4 normalize(const float4 &a);
otc_device_inline float4 safe_normalize(const float4 &a);
otc_device_inline float4 min(const float4 &a, const float4 &b);
otc_device_inline float4 max(const float4 &a, const float4 &b);
otc_device_inline float4 clamp(const float4 &a, const float4 &mn, const float4 &mx);
otc_device_inline float4 fabs(const float4 &a);
...
otc_device_inline float4 select(const int4 &mask, const float4 &a, const float4 &b);
otc_device_inline float4 reduce_min(const float4 &a);
otc_device_inline float4 reduce_max(const float4 &a);
otc_device_inline float4 reduce_add(const float4 &a);
...
otc_device_inline float4 mask(const int4 &mask, const float4 &a)
{
...
otc_device_inline float4 load_float4(const float *v)
{
#  ifdef __KERNEL_SSE__
