...
otc_device_inline size_t divide_up(size_t x, size_t y)
{
  return (x + y - 1) / y;
}

otc_device_inline size_t round_up(size_t x, size_t multiple)
{
  return ((x + multiple - 1) / multiple) * multiple;
}

otc_device_inline size_t round_down(size_t x, size_t multiple)
{
