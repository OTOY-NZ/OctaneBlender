...
otc_device_inline int3 make_int3(int i);
otc_device_inline int3 make_int3(int x, int y, int z);
otc_device_inline void print_int3(const char *label, const int3 &a);
