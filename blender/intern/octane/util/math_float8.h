...
oct_device_inline vfloat8 zero_vfloat8()
{
...
oct_device_inline vfloat8 one_vfloat8()
{
  return make_vfloat8(1.0f);
}

oct_device_inline vfloat8 operator+(const vfloat8 a, const vfloat8 b)
{
#ifdef __KERNEL_AVX__
...
oct_device_inline vfloat8 operator+(const vfloat8 a, const float f)
{
  return a + make_vfloat8(f);
}

oct_device_inline vfloat8 operator+(const float f, const vfloat8 a)
{
  return make_vfloat8(f) + a;
}

oct_device_inline vfloat8 operator-(const vfloat8 a)
{
#ifdef __KERNEL_AVX__
...
oct_device_inline vfloat8 operator+=(vfloat8 a, const vfloat8 b)
{
  return a = a + b;
}
...
oct_device_inline vfloat8 operator*=(vfloat8 a, float f)
{
  return a = a * f;
}
...
oct_device_inline bool operator==(const vfloat8 a, const vfloat8 b)
{
#ifdef __KERNEL_AVX__
...
oct_device_inline const vfloat8 operator^(const vfloat8 a, const vfloat8 b)
{
#ifdef __KERNEL_AVX__
...
oct_device_inline vfloat8 rcp(const vfloat8 a)
{
#ifdef __KERNEL_AVX__
...
oct_device_inline vfloat8 sqrt(const vfloat8 a)
{
#ifdef __KERNEL_AVX__
...
oct_device_inline vfloat8 sqr(const vfloat8 a)
{
  return a * a;
}

oct_device_inline bool is_zero(const vfloat8 a)
{
  return a == make_vfloat8(0.0f);
}

oct_device_inline float reduce_add(const vfloat8 a)
{
#ifdef __KERNEL_AVX__
...
oct_device_inline float average(const vfloat8 a)
{
  return reduce_add(a) / 8.0f;
}

oct_device_inline vfloat8 min(const vfloat8 a, const vfloat8 b)
{
#ifdef __KERNEL_AVX__
...
oct_device_inline vfloat8 max(const vfloat8 a, const vfloat8 b)
{
#ifdef __KERNEL_AVX__
...
oct_device_inline vfloat8 clamp(const vfloat8 a, const vfloat8 mn, const vfloat8 mx)
{
  return min(max(a, mn), mx);
}

oct_device_inline vfloat8 select(const vint8 mask, const vfloat8 a, const vfloat8 b)
{
#ifdef __KERNEL_AVX__
...
oct_device_inline vfloat8 fabs(const vfloat8 a)
{
#ifdef __KERNEL_AVX__
...
oct_device_inline vfloat8 mix(const vfloat8 a, const vfloat8 b, float t)
{
  return a + t * (b - a);
}

oct_device_inline vfloat8 mix(const vfloat8 a, const vfloat8 b, vfloat8 t)
{
  return a + t * (b - a);
}

oct_device_inline vfloat8 saturate(const vfloat8 a)
{
  return clamp(a, make_vfloat8(0.0f), make_vfloat8(1.0f));
}

oct_device_inline vfloat8 exp(vfloat8 v)
{
  return make_vfloat8(
      expf(v.a), expf(v.b), expf(v.c), expf(v.d), expf(v.e), expf(v.f), expf(v.g), expf(v.h));
}

oct_device_inline vfloat8 log(vfloat8 v)
{
  return make_vfloat8(
      logf(v.a), logf(v.b), logf(v.c), logf(v.d), logf(v.e), logf(v.f), logf(v.g), logf(v.h));
}

oct_device_inline float dot(const vfloat8 a, const vfloat8 b)
{
#ifdef __KERNEL_AVX__
...
oct_device_inline vfloat8 pow(vfloat8 v, float e)
{
...
oct_device_inline float reduce_min(const vfloat8 a)
{
  return min(min(min(a.a, a.b), min(a.c, a.d)), min(min(a.e, a.f), min(a.g, a.h)));
}

oct_device_inline float reduce_max(const vfloat8 a)
{
  return max(max(max(a.a, a.b), max(a.c, a.d)), max(max(a.e, a.f), max(a.g, a.h)));
}

oct_device_inline bool isequal(const vfloat8 a, const vfloat8 b)
{
  return a == b;
}

oct_device_inline vfloat8 safe_divide(const vfloat8 a, const float b)
{
  return (b != 0.0f) ? a / b : make_vfloat8(0.0f);
}

oct_device_inline vfloat8 safe_divide(const vfloat8 a, const vfloat8 b)
{
...
oct_device_inline vfloat8 ensure_finite(vfloat8 v)
{
...
oct_device_inline bool isfinite_safe(vfloat8 v)
{
...
oct_device_inline vint8 cast(const vfloat8 a)
{
#ifdef __KERNEL_AVX__
...
oct_device_forceinline float4 low(const vfloat8 a)
{
#  ifdef __KERNEL_AVX__
...
oct_device_forceinline float4 high(const vfloat8 a)
{
#  ifdef __KERNEL_AVX__
...
oct_device_forceinline const vfloat8 shuffle(const vfloat8 a)
{
#  ifdef __KERNEL_AVX__
...
oct_device_forceinline const vfloat8 shuffle(const vfloat8 a, const vfloat8 b)
{
#  ifdef __KERNEL_AVX__
...
template<size_t i0> oct_device_forceinline const vfloat8 shuffle(const vfloat8 a, const vfloat8 b)
{
  return shuffle<i0, i0, i0, i0>(a, b);
}
template<size_t i0> oct_device_forceinline const vfloat8 shuffle(const vfloat8 a)
{
  return shuffle<i0>(a, a);
}

template<size_t i> oct_device_forceinline float extract(const vfloat8 a)
{
#  ifdef __KERNEL_AVX__
