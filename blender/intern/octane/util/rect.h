...
oct_device_inline bool local_index_to_coord(int4 rect,
                                            int idx,
                                            oct_private int *x,
                                            oct_private int *y)
{
...
oct_device_inline int rect_size(int4 rect)
{
  return (rect.z - rect.x) * (rect.w - rect.y);
}
