...
oct_device_inline int3 min(int3 a, int3 b)
{
...
oct_device_inline int3 max(int3 a, int3 b)
{
#  if defined(__KERNEL_SSE__) && defined(__KERNEL_SSE41__)
...
oct_device_inline int3 clamp(const int3 a, int mn, int mx)
{
...
oct_device_inline int3 clamp(const int3 a, int3 &mn, int mx)
{
#  ifdef __KERNEL_SSE__
...
oct_device_inline bool operator==(const int3 a, const int3 b)
{
...
oct_device_inline int3 operator+(const int3 a, const int3 b)
{
#  ifdef __KERNEL_SSE__
