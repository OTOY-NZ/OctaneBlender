...
otc_device_inline float3 transform_perspective(const ProjectionTransform *t, const float3 a)
{
...
otc_device_inline float3 transform_perspective_direction(const ProjectionTransform *t,
                                                         const float3 a)
{
...
otc_device_inline Transform projection_to_transform(const ProjectionTransform &a)
{
  Transform tfm = {a.x, a.y, a.z};
  return tfm;
}

otc_device_inline ProjectionTransform projection_transpose(const ProjectionTransform &a)
{
...
otc_device_inline ProjectionTransform make_projection(float a,
                                                      float b,
                                                      float c,
                                                      float d,
                                                      float e,
...
otc_device_inline ProjectionTransform projection_identity()
{
...
otc_device_inline ProjectionTransform operator*(const ProjectionTransform &a,
...
otc_device_inline ProjectionTransform operator*(const ProjectionTransform &a, const Transform &b)
{
  return a * ProjectionTransform(b);
}

otc_device_inline ProjectionTransform operator*(const Transform &a, const ProjectionTransform &b)
{
  return ProjectionTransform(a) * b;
}

otc_device_inline void print_projection(const char *label, const ProjectionTransform &t)
{
...
otc_device_inline ProjectionTransform projection_perspective(float fov, float n, float f)
{
...
otc_device_inline ProjectionTransform projection_orthographic(float znear, float zfar)
{
