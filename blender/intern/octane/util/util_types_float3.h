...
struct otc_try_align(16) float3
{
...
otc_device_inline float3 make_float3(float f);
otc_device_inline float3 make_float3(float x, float y, float z);
otc_device_inline void print_float3(const char *label, const float3 &a);
