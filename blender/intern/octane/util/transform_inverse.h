...
oct_device_forceinline float3 transform_inverse_cross(const float3 a_, const float3 b_)
{
...
oct_device_forceinline float transform_inverse_dot(const float3 a_, const float3 b_)
{
...
oct_device_forceinline Transform transform_inverse_impl(const Transform tfm)
{
