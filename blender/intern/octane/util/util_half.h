...
otc_device_inline void float4_store_half(half *h, float4 f, float scale)
{
...
otc_device_inline float half_to_float(half h)
{
  float f;
...
otc_device_inline float4 half4_to_float4(half4 h)
{
  float4 f;
...
otc_device_inline half float_to_half(float f)
{
