...
/* [0, uint_max] -> [0.0, 1.0) */
oct_device_forceinline float uint_to_float_excl(uint n)
{
...
/* [0, uint_max] -> [0.0, 1.0] */
oct_device_forceinline float uint_to_float_incl(uint n)
{
...
oct_device_inline uint hash_uint(uint kx)
{
  uint a, b, c;
...
oct_device_inline uint hash_uint2(uint kx, uint ky)
{
  uint a, b, c;
...
oct_device_inline uint hash_uint3(uint kx, uint ky, uint kz)
{
  uint a, b, c;
...
oct_device_inline uint hash_uint4(uint kx, uint ky, uint kz, uint kw)
{
  uint a, b, c;
...
oct_device_inline float hash_uint_to_float(uint kx)
{
  return uint_to_float_incl(hash_uint(kx));
}

oct_device_inline float hash_uint2_to_float(uint kx, uint ky)
{
  return uint_to_float_incl(hash_uint2(kx, ky));
}

oct_device_inline float hash_uint3_to_float(uint kx, uint ky, uint kz)
{
  return uint_to_float_incl(hash_uint3(kx, ky, kz));
}

oct_device_inline float hash_uint4_to_float(uint kx, uint ky, uint kz, uint kw)
{
...
oct_device_inline float hash_float_to_float(float k)
{
  return hash_uint_to_float(__float_as_uint(k));
}

oct_device_inline float hash_float2_to_float(float2 k)
{
  return hash_uint2_to_float(__float_as_uint(k.x), __float_as_uint(k.y));
}

oct_device_inline float hash_float3_to_float(float3 k)
{
  return hash_uint3_to_float(__float_as_uint(k.x), __float_as_uint(k.y), __float_as_uint(k.z));
}

oct_device_inline float hash_float4_to_float(float4 k)
{
...
oct_device_inline float2 hash_float2_to_float2(float2 k)
{
  return make_float2(hash_float2_to_float(k), hash_float3_to_float(make_float3(k.x, k.y, 1.0)));
}

oct_device_inline float3 hash_float3_to_float3(float3 k)
{
...
oct_device_inline float4 hash_float4_to_float4(float4 k)
{
...
oct_device_inline float3 hash_float_to_float3(float k)
{
...
oct_device_inline float3 hash_float2_to_float3(float2 k)
{
...
oct_device_inline float3 hash_float4_to_float3(float4 k)
{
...
oct_device_inline int4 hash_int4(int4 kx)
{
  int4 a, b, c;
...
oct_device_inline int4 hash_int4_2(int4 kx, int4 ky)
{
  int4 a, b, c;
...
oct_device_inline int4 hash_int4_3(int4 kx, int4 ky, int4 kz)
{
  int4 a, b, c;
...
oct_device_inline int4 hash_int4_4(int4 kx, int4 ky, int4 kz, int4 kw)
{
  int4 a, b, c;
...
oct_device_inline vint8 hash_int8(vint8 kx)
{
  vint8 a, b, c;
...
oct_device_inline vint8 hash_int8_2(vint8 kx, vint8 ky)
{
  vint8 a, b, c;
...
oct_device_inline vint8 hash_int8_3(vint8 kx, vint8 ky, vint8 kz)
{
  vint8 a, b, c;
...
oct_device_inline vint8 hash_int8_4(vint8 kx, vint8 ky, vint8 kz, vint8 kw)
{
  vint8 a, b, c;
...
oct_device_inline uint hash_hp_uint(uint i)
{
...
oct_device_inline uint hash_hp_seeded_uint(uint i, uint seed)
{
...
/* Outputs [0.0, 1.0). */
oct_device_inline float hash_hp_float(uint i)
{
  return uint_to_float_excl(hash_hp_uint(i));
}

/* Outputs [0.0, 1.0). */
oct_device_inline float hash_hp_seeded_float(uint i, uint seed)
{
...
oct_device_inline uint hash_wang_seeded_uint(uint i, uint seed)
{
  i = (i ^ 61) ^ seed;
  i += i << 3;
  i ^= i >> 4;
...
/* Outputs [0.0, 1.0). */
oct_device_inline float hash_wang_seeded_float(uint i, uint seed)
{
 ...
 * works.
 */
oct_device_inline uint hash_shuffle_uint(uint i, uint length, uint seed)
{
  i = i % length;
