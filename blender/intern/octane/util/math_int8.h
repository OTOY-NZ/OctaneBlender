...
oct_device_inline vint8 operator+(const vint8 a, const vint8 b)
{
...
oct_device_inline vint8 operator+=(vint8 &a, const vint8 b)
{
  return a = a + b;
}
...
oct_device_inline vint8 operator>>(const vint8 a, int i)
{
#  ifdef __KERNEL_AVX__
...
oct_device_inline vint8 operator<(const vint8 a, const int b)
{
...
oct_device_inline vint8 operator&(const int32_t a, const vint8 b)
{
  return make_vint8(a) & b;
}

oct_device_inline vint8 operator&(const vint8 a, const int32_t b)
{
  return a & make_vint8(b);
}
...
oct_device_inline vint8 &operator&=(vint8 &a, const int32_t b)
{
  return a = a & b;
}
...
#  ifdef __KERNEL_AVX__
oct_device_forceinline const vint8 srl(const vint8 a, const int32_t b)
{
  return vint8(_mm256_srli_epi32(a.m256, b));
}
#  endif

oct_device_inline vint8 min(vint8 a, vint8 b)
{
...
oct_device_inline vint8 max(vint8 a, vint8 b)
{
#  if defined(__KERNEL_AVX__) && defined(__KERNEL_AVX41__)
...
oct_device_inline vint8 clamp(const vint8 a, const vint8 mn, const vint8 mx)
{
  return min(max(a, mn), mx);
}

oct_device_inline vint8 select(const vint8 mask, const vint8 a, const vint8 b)
{
#  ifdef __KERNEL_AVX__
...
oct_device_inline vint8 load_vint8(const int *v)
{
#  ifdef __KERNEL_AVX__
...
oct_device_inline vfloat8 cast(const vint8 a)
{
#ifdef __KERNEL_AVX__
...
#ifdef __KERNEL_AVX__
template<size_t i> oct_device_forceinline const vint8 shuffle(const vint8 a)
{
  return vint8(
      _mm256_castps_si256(_mm256_permute_ps(_mm256_castsi256_ps(a), _MM_SHUFFLE(i, i, i, i))));
}

template<size_t i0, size_t i1> oct_device_forceinline const vint8 shuffle(const vint8 a)
{
  return vint8(_mm256_permute2f128_si256(a, a, (i1 << 4) | (i0 << 0)));
}

template<size_t i0, size_t i1>
oct_device_forceinline const vint8 shuffle(const vint8 a, const vint8 b)
{
  return vint8(_mm256_permute2f128_si256(a, b, (i1 << 4) | (i0 << 0)));
}

template<size_t i0, size_t i1, size_t i2, size_t i3>
oct_device_forceinline const vint8 shuffle(const vint8 a)
{
  return vint8(
