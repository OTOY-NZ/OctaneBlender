...
oct_device_inline int4 operator+(const int4 a, const int4 b)
{
...
oct_device_inline int4 operator+=(int4 &a, const int4 b)
{
  return a = a + b;
}
...
oct_device_inline int4 operator>>(const int4 a, int i)
{
#  ifdef __KERNEL_SSE__
...
oct_device_inline int4 operator<(const int4 a, const int b)
{
...
oct_device_inline int4 operator&(const int32_t a, const int4 b)
{
  return make_int4(a) & b;
}

oct_device_inline int4 operator&(const int4 a, const int32_t b)
{
  return a & make_int4(b);
}
...
oct_device_inline int4 &operator&=(int4 &a, const int32_t b)
{
  return a = a & b;
}
...
#  ifdef __KERNEL_SSE__
oct_device_forceinline const int4 srl(const int4 a, const int32_t b)
{
  return int4(_mm_srli_epi32(a.m128, b));
}
#  endif

oct_device_inline int4 min(int4 a, int4 b)
{
...
oct_device_inline int4 max(int4 a, int4 b)
{
#  if defined(__KERNEL_SSE__) && defined(__KERNEL_SSE41__)
...
oct_device_inline int4 clamp(const int4 a, const int4 mn, const int4 mx)
{
  return min(max(a, mn), mx);
}

oct_device_inline int4 select(const int4 mask, const int4 a, const int4 b)
{
#  ifdef __KERNEL_SSE__
...
oct_device_inline int4 load_int4(const int *v)
{
#  ifdef __KERNEL_SSE__
...
oct_device_inline float4 cast(const int4 a)
{
#ifdef __KERNEL_SSE__
...
#ifdef __KERNEL_SSE__
oct_device_forceinline int4 andnot(const int4 a, const int4 b)
{
  return int4(_mm_andnot_si128(a.m128, b.m128));
}

template<size_t i0, size_t i1, size_t i2, size_t i3>
oct_device_forceinline int4 shuffle(const int4 a)
{
...
template<size_t i0, size_t i1, size_t i2, size_t i3>
oct_device_forceinline int4 shuffle(const int4 a, const int4 b)
{
#  ifdef __KERNEL_NEON__
  int32x4_t result = shuffle_neon<int32x4_t, i0, i1, i2, i3>(vreinterpretq_s32_m128i(a),
...
template<size_t i0> oct_device_forceinline int4 shuffle(const int4 b)
{
