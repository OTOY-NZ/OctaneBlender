...
oct_device_inline float madd(const float a, const float b, const float c)
{
...
oct_device_inline float4 madd4(const float4 a, const float4 b, const float4 c)
{
  return a * b + c;
}
...
oct_device_inline int fast_rint(float x)
{
...
oct_device float fast_sinf(float x)
{
...
oct_device float fast_cosf(float x)
{
...
oct_device void fast_sincosf(float x, oct_private float *sine, oct_private float *cosine)
{
 ...
 * errors.
 */
oct_device float fast_tanf(float x)
{
 ...
 */
oct_device float fast_sinpif(float x)
{
...
oct_device_inline float fast_cospif(float x)
{
  return fast_sinpif(x + 0.5f);
}

oct_device float fast_acosf(float x)
{
...
oct_device float fast_asinf(float x)
{
...
oct_device float fast_atanf(float x)
{
...
oct_device float fast_atan2f(float y, float x)
{
 ...
 */
oct_device float fast_log2f(float x)
{
...
oct_device_inline float fast_logf(float x)
{
...
oct_device_inline float fast_log10(float x)
{
...
oct_device float fast_logb(float x)
{
...
oct_device float fast_exp2f(float x)
{
...
oct_device_inline float fast_expf(float x)
{
...
oct_device float4 fast_exp2f4(float4 x)
{
...
oct_device_inline float4 fast_expf4(float4 x)
{
...
oct_device_inline float fast_exp10(float x)
{
...
oct_device_inline float fast_expm1f(float x)
{
  if (fabsf(x) < 1e-5f) {
...
oct_device float fast_sinhf(float x)
{
  float a = fabsf(x);
  if (a > 1.0f) {
...
oct_device_inline float fast_coshf(float x)
{
...
oct_device_inline float fast_tanhf(float x)
{
...
oct_device float fast_safe_powf(float x, float y)
{
  if (y == 0)
    return 1.0f; /* x^1=1 */
  if (x == 0)
...
oct_device_inline float fast_erff(float x)
{
...
oct_device_inline float fast_erfcf(float x)
{
...
oct_device_inline float fast_ierff(float x)
{
