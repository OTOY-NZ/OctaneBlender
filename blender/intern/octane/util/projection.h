...
oct_device_inline float3 transform_perspective(oct_private const ProjectionTransform *t,
                                               const float3 a)
{
...
oct_device_inline float3 transform_perspective_direction(oct_private const ProjectionTransform *t,
                                                         const float3 a)
{
...
oct_device_inline Transform projection_to_transform(const ProjectionTransform &a)
{
  Transform tfm = {a.x, a.y, a.z};
  return tfm;
}

oct_device_inline ProjectionTransform projection_transpose(const ProjectionTransform &a)
{
...
oct_device_inline ProjectionTransform make_projection(float a,
                                                      float b,
                                                      float c,
                                                      float d,
                                                      float e,
...
oct_device_inline ProjectionTransform projection_identity()
{
...
oct_device_inline ProjectionTransform operator*(const ProjectionTransform &a,
...
oct_device_inline ProjectionTransform operator*(const ProjectionTransform &a, const Transform &b)
{
  return a * ProjectionTransform(b);
}

oct_device_inline ProjectionTransform operator*(const Transform &a, const ProjectionTransform &b)
{
  return ProjectionTransform(a) * b;
}

oct_device_inline void print_projection(const char *label, const ProjectionTransform &t)
{
...
oct_device_inline ProjectionTransform projection_perspective(float fov, float n, float f)
{
...
oct_device_inline ProjectionTransform projection_orthographic(float znear, float zfar)
{
