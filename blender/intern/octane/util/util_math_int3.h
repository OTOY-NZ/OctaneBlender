...
otc_device_inline int3 min(int3 a, int3 b);
otc_device_inline int3 max(int3 a, int3 b);
otc_device_inline int3 clamp(const int3 &a, int mn, int mx);
otc_device_inline int3 clamp(const int3 &a, int3 &mn, int mx);
...
otc_device_inline bool operator==(const int3 &a, const int3 &b)
{
...
otc_device_inline int3 operator+(const int3 &a, const int3 &b)
{
#  ifdef __KERNEL_SSE__
